...
public abstract class Element {
    ...
    void assertChildrenNotExceedingMaxCount(Collection<Class<? extends Element>> elementTypes, int maxCountPerElementType) throws InvalidInputException {
        ...
        itest("Unit", 816).given(elementTypes, "49.xml").given(maxCountPerElementType, 50).checkEq(hasExceeded, false);
        itest("Unit", 816).given(elementTypes, "49.xml").given(maxCountPerElementType, 50).checkEq(hasExceeded, true);
        if (hasExceeded) {
