...
public class ParserUtils {
    ...
    static FightResult getFightResult(Element element) {
        if (element.select(".win").size() > 0) {
            ...
            if (element.select(".loss").size() > 0) {
                return FightResult.FIGHTER_2_WIN;
            } else {
                if (element.select(".draw").size() > 0) {
                    return FightResult.DRAW;
                } else {
                    if (element.select(".no_contest").size() > 0) {
    ...
    public static FightType getFightType(Sherdog parser, Fight fight) {
        org.raninline.LogHelper.logVariable("target-statement-start", "/home/user/projects/inlinegen-research/log/raninline-log.txt", "/home/user/projects/inlinegen-research/_downloads/lamarios_sherdog-parser/src/main/java/com/ftpix/sherdogparser/parsers/ParserUtils.java", 142);
        org.raninline.LogHelper.logVariable("target-statement-before", "/home/user/projects/inlinegen-research/log/raninline-log.txt", "/home/user/projects/inlinegen-research/_downloads/lamarios_sherdog-parser/src/main/java/com/ftpix/sherdogparser/parsers/ParserUtils.java", 142, parser, "parser");
        org.raninline.LogHelper.logVariable("target-statement-before", "/home/user/projects/inlinegen-research/log/raninline-log.txt", "/home/user/projects/inlinegen-research/_downloads/lamarios_sherdog-parser/src/main/java/com/ftpix/sherdogparser/parsers/ParserUtils.java", 142, fight, "fight");
        ...
        org.raninline.LogHelper.logVariable("target-statement-after", "/home/user/projects/inlinegen-research/log/raninline-log.txt", "/home/user/projects/inlinegen-research/_downloads/lamarios_sherdog-parser/src/main/java/com/ftpix/sherdogparser/parsers/ParserUtils.java", 142, fighter, "fighter");
        org.raninline.LogHelper.logVariable("target-statement-after", "/home/user/projects/inlinegen-research/log/raninline-log.txt", "/home/user/projects/inlinegen-research/_downloads/lamarios_sherdog-parser/src/main/java/com/ftpix/sherdogparser/parsers/ParserUtils.java", 142, getType, "getType");
    ...
    static String getSherdogPageUrl(Document doc) {
        org.raninline.LogHelper.logVariable("target-statement-start", "/home/user/projects/inlinegen-research/log/raninline-log.txt", "/home/user/projects/inlinegen-research/_downloads/lamarios_sherdog-parser/src/main/java/com/ftpix/sherdogparser/parsers/ParserUtils.java", 185);
        org.raninline.LogHelper.logVariable("target-statement-before", "/home/user/projects/inlinegen-research/log/raninline-log.txt", "/home/user/projects/inlinegen-research/_downloads/lamarios_sherdog-parser/src/main/java/com/ftpix/sherdogparser/parsers/ParserUtils.java", 185, doc, "doc");
        ...
        org.raninline.LogHelper.logVariable("target-statement-after", "/home/user/projects/inlinegen-research/log/raninline-log.txt", "/home/user/projects/inlinegen-research/_downloads/lamarios_sherdog-parser/src/main/java/com/ftpix/sherdogparser/parsers/ParserUtils.java", 185, url, "url");
        if (url.startsWith("//")) {
