...
public class EmailRecipientUtils {
    ...
    private static String fixupDelimiters(String input) {
        ...
        input = input.replace(';', ',');
        new Here("Randoop").given(input, "descriptorByName/hudson.plugins.emailext.plugins.recipients.ListRecipientProvider").checkEq(input, "descriptorByName/hudson.plugins.emailext.plugins.recipients.ListRecipientProvider");
        return input;
    }
