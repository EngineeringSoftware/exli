...
public class PdfComparator<T extends CompareResultImpl> {
        ...
        try {
            ...
            try (final InputStream expectedStream = expectedStreamSupplier.get()) {
                try (final InputStream actualStream = actualStreamSupplier.get()) {
                    try (PDDocument expectedDocument = PDDocument.load(expectedStream, expectedPassword, Utilities.getMemorySettings(environment.getDocumentCacheSize()))) {
                        try (PDDocument actualDocument = PDDocument.load(actualStream, actualPassword, Utilities.getMemorySettings(environment.getDocumentCacheSize()))) {
    ...
    private void drawImage(final CountDownLatch latch, final int pageIndex, final PDDocument expectedDocument, final PDDocument actualDocument, final PDFRenderer expectedPdfRenderer, final PDFRenderer actualPdfRenderer) {
        drawExecutor.execute(() -> {
            try {
                LOG.trace("Drawing page {}", pageIndex);
                final Future<ImageWithDimension> expectedImageFuture = parrallelDrawExecutor.submit(() -> renderPageAsImage(expectedDocument, expectedPdfRenderer, pageIndex, environment));
                final Future<ImageWithDimension> actualImageFuture = parrallelDrawExecutor.submit(() -> renderPageAsImage(actualDocument, actualPdfRenderer, pageIndex, environment));
    ...
    private ImageWithDimension getImage(final Future<ImageWithDimension> imageFuture, final int pageIndex, final String type) {
        try {
            ...
            org.raninline.LogHelper.logVariable("target-statement-start", "/home/user/projects/inlinegen-research/log/raninline-log.txt", "/home/user/projects/inlinegen-research/_downloads/red6_pdfcompare/src/main/java/de/redsix/pdfcompare/PdfComparator.java", 492);
            org.raninline.LogHelper.logVariable("target-statement-before", "/home/user/projects/inlinegen-research/log/raninline-log.txt", "/home/user/projects/inlinegen-research/_downloads/red6_pdfcompare/src/main/java/de/redsix/pdfcompare/PdfComparator.java", 492, unit, "unit");
            org.raninline.LogHelper.logVariable("target-statement-before", "/home/user/projects/inlinegen-research/log/raninline-log.txt", "/home/user/projects/inlinegen-research/_downloads/red6_pdfcompare/src/main/java/de/redsix/pdfcompare/PdfComparator.java", 492, pageIndex, "pageIndex");
            org.raninline.LogHelper.logVariable("target-statement-before", "/home/user/projects/inlinegen-research/log/raninline-log.txt", "/home/user/projects/inlinegen-research/_downloads/red6_pdfcompare/src/main/java/de/redsix/pdfcompare/PdfComparator.java", 492, type, "type");
            ...
            org.raninline.LogHelper.logVariable("target-statement-after", "/home/user/projects/inlinegen-research/log/raninline-log.txt", "/home/user/projects/inlinegen-research/_downloads/red6_pdfcompare/src/main/java/de/redsix/pdfcompare/PdfComparator.java", 492, msg, "msg");
    ...
    private void addExtraPages(final PDDocument document, final PDFRenderer pdfRenderer, final int minPageCount, final int color, final boolean expected) throws IOException {
    ...
    public static ImageWithDimension renderPageAsImage(final PDDocument document, final PDFRenderer expectedPdfRenderer, final int pageIndex, Environment environment) throws IOException {
