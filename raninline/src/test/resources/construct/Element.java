...
public abstract class Element {
    ...
    void assertChildrenNotExceedingMaxCount(Collection<Class<? extends Element>> elementTypes, int maxCountPerElementType) throws InvalidInputException {
        ...
        new Here("Unit", 816).given(elementTypes, "49.xml").given(maxCountPerElementType, 50).checkEq(hasExceeded, true);
        new Here("Unit", 816).given(elementTypes, "49.xml").given(maxCountPerElementType, 50).checkEq(hasExceeded, false);
        if (hasExceeded) {
