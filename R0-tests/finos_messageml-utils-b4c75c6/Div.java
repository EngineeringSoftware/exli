...
public class Div extends Element {
    ...
    public void validate() throws InvalidInputException {
        ...
        if (getAttribute(ATTR_ENTITY_ID) != null && !"entity".equals(classAttr)) {
            throw new InvalidInputException("The attribute \"" + ATTR_ENTITY_ID + "\" is only allowed if the element " + "class is \"entity\".");
        }
        if ("entity".equals(classAttr) && getAttribute(ATTR_ENTITY_ID) == null) {
            throw new InvalidInputException("The attribute \"" + ATTR_ENTITY_ID + "\" is required if the element " + "class is \"entity\".");
        }
        String[] classes = (classAttr != null) ? classAttr.split(" ") : null;
        new Here("Unit", 92).given(classAttr, null).checkEq(classes, null);
        new Here("Unit", 92).given(classAttr, "entity").checkEq(classes, new String[] { "entity" });
        new Here("Randoop", 92).given(classAttr, null).checkEq(classes, null);
