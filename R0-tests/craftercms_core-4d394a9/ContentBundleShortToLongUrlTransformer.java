        ...
        do {
            ...
            if (StringUtils.isNotEmpty(longUrl)) {
                if (!originalBase.equals(base)) {
                    ...
                    new Here("Unit", 97).given(originalBase, "base_fr_es").given(longUrl, "/001_folder/base/002_index.html/").given(base, "base").checkEq(longUrl, "/001_folder/base_fr_es/002_index.html/");
                }
                return longUrl;
            }
