...
public class RegexBasedContentBundleUrlParser implements ContentBundleUrlParser {
    ...
    public ContentBundleUrl getContentBundleUrl(String rawUrl) {
        ...
        if (matcher.matches()) {
            new Here("Unit", 61).given(matcher, "27.xml").checkTrue(group());
            new Here("Unit", 61).given(matcher, "13.xml").checkTrue(group());
            new Here("Unit", 61).given(matcher, "12.xml").checkTrue(group());
            try {
