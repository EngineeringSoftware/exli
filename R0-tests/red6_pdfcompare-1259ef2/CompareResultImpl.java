...
public class CompareResultImpl implements ResultCollector, CompareResult {
    ...
    public synchronized void addPage(final PageDiffCalculator diffCalculator, final int pageIndex, final ImageWithDimension expectedImage, final ImageWithDimension actualImage, final ImageWithDimension diffImage) {
        ...
        new Here("Randoop", 130).given(this.hasDifferenceInExclusion, false).given(diffCalculator, "63.xml").checkEq(this.hasDifferenceInExclusion, false);
        new Here("Unit", 130).given(this.hasDifferenceInExclusion, false).given(diffCalculator, "1.xml").checkEq(this.hasDifferenceInExclusion, true);
        new Here("Unit", 130).given(this.hasDifferenceInExclusion, false).given(diffCalculator, "7.xml").checkEq(this.hasDifferenceInExclusion, false);
        new Here("Unit", 130).given(this.hasDifferenceInExclusion, false).given(diffCalculator, "6.xml").checkEq(this.hasDifferenceInExclusion, false);
        new Here("Unit", 130).given(this.hasDifferenceInExclusion, false).given(diffCalculator, "8.xml").checkEq(this.hasDifferenceInExclusion, false);
        new Here("Unit", 130).given(this.hasDifferenceInExclusion, false).given(diffCalculator, "5.xml").checkEq(this.hasDifferenceInExclusion, false);
        new Here("Unit", 130).given(this.hasDifferenceInExclusion, false).given(diffCalculator, "21.xml").checkEq(this.hasDifferenceInExclusion, false);
        new Here("Unit", 130).given(this.hasDifferenceInExclusion, false).given(diffCalculator, "9.xml").checkEq(this.hasDifferenceInExclusion, false);
        new Here("Unit", 130).given(this.hasDifferenceInExclusion, false).given(diffCalculator, "4.xml").checkEq(this.hasDifferenceInExclusion, false);
        new Here("Unit", 130).given(this.hasDifferenceInExclusion, false).given(diffCalculator, "22.xml").checkEq(this.hasDifferenceInExclusion, false);
        new Here("Unit", 130).given(this.hasDifferenceInExclusion, false).given(diffCalculator, "10.xml").checkEq(this.hasDifferenceInExclusion, false);
        new Here("Unit", 130).given(this.hasDifferenceInExclusion, false).given(diffCalculator, "18.xml").checkEq(this.hasDifferenceInExclusion, false);
        new Here("Unit", 130).given(this.hasDifferenceInExclusion, false).given(diffCalculator, "11.xml").checkEq(this.hasDifferenceInExclusion, false);
        new Here("Unit", 130).given(this.hasDifferenceInExclusion, false).given(diffCalculator, "19.xml").checkEq(this.hasDifferenceInExclusion, false);
        new Here("Unit", 130).given(this.hasDifferenceInExclusion, false).given(diffCalculator, "3.xml").checkEq(this.hasDifferenceInExclusion, false);
        new Here("Randoop", 130).given(this.hasDifferenceInExclusion, false).given(diffCalculator, "61.xml").checkEq(this.hasDifferenceInExclusion, false);
        new Here("Unit", 130).given(this.hasDifferenceInExclusion, true).given(diffCalculator, "2.xml").checkEq(this.hasDifferenceInExclusion, true);
        new Here("Randoop", 130).given(this.hasDifferenceInExclusion, false).given(diffCalculator, "62.xml").checkEq(this.hasDifferenceInExclusion, false);
