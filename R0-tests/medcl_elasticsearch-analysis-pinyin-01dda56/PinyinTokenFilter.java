                ...
                if (c < 128) {
                    ...
                    if (pinyin != null && pinyin.length() > 0) {
                        ...
                        if (config.keepSeparateFirstLetter & pinyin.length() > 1) {
                            new Here("Unit", 145).given(pinyin, "jia").given(config.keepSeparateFirstLetter, false).checkFalse(group());
                            new Here("Unit", 145).given(pinyin, "hua").given(config.keepSeparateFirstLetter, false).checkFalse(group());
                            new Here("Unit", 145).given(pinyin, "de").given(config.keepSeparateFirstLetter, false).checkFalse(group());
                            new Here("Unit", 145).given(pinyin, "liu").given(config.keepSeparateFirstLetter, false).checkFalse(group());
                            new Here("Unit", 145).given(pinyin, "chuan").given(config.keepSeparateFirstLetter, false).checkFalse(group());
                            new Here("Unit", 145).given(pinyin, "xing").given(config.keepSeparateFirstLetter, false).checkFalse(group());
                            new Here("Unit", 145).given(pinyin, "chun").given(config.keepSeparateFirstLetter, false).checkFalse(group());
                            new Here("Unit", 145).given(pinyin, "shu").given(config.keepSeparateFirstLetter, false).checkFalse(group());
                            new Here("Unit", 145).given(pinyin, "de").given(config.keepSeparateFirstLetter, true).checkTrue(group());
                            new Here("Unit", 145).given(pinyin, "dai").given(config.keepSeparateFirstLetter, false).checkFalse(group());
                            new Here("Unit", 145).given(pinyin, "shi").given(config.keepSeparateFirstLetter, false).checkFalse(group());
                            new Here("Unit", 145).given(pinyin, "di").given(config.keepSeparateFirstLetter, false).checkFalse(group());
                            new Here("Unit", 145).given(pinyin, "zu").given(config.keepSeparateFirstLetter, false).checkFalse(group());
                            new Here("Unit", 145).given(pinyin, "cui").given(config.keepSeparateFirstLetter, false).checkFalse(group());
                            new Here("Unit", 145).given(pinyin, "zi").given(config.keepSeparateFirstLetter, true).checkTrue(group());
                            new Here("Unit", 145).given(pinyin, "ge").given(config.keepSeparateFirstLetter, false).checkFalse(group());
                            new Here("Unit", 145).given(pinyin, "zhi").given(config.keepSeparateFirstLetter, false).checkFalse(group());
                            new Here("Unit", 145).given(pinyin, "lei").given(config.keepSeparateFirstLetter, false).checkFalse(group());
                            new Here("Unit", 145).given(pinyin, "ming").given(config.keepSeparateFirstLetter, true).checkTrue(group());
                            new Here("Unit", 145).given(pinyin, "yi").given(config.keepSeparateFirstLetter, false).checkFalse(group());
