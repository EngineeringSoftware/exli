        ...
        for (char c : pinyinStr.toCharArray()) {
            if ((c > 96 && c < 123) || (c > 64 && c < 91)) {
                ...
                if (lastWord & sb.length() > 0) {
                    new Here("Unit", 59).given(lastWord, true).given(sb, "6.xml").checkTrue(group());
                    new Here("Unit", 59).given(lastWord, true).given(sb, "8.xml").checkTrue(group());
                    new Here("Unit", 59).given(lastWord, true).given(sb, "12.xml").checkTrue(group());
                    new Here("Unit", 59).given(lastWord, true).given(sb, "10.xml").checkTrue(group());
                    new Here("Unit", 59).given(lastWord, false).given(sb, "4.xml").checkFalse(group());
                    new Here("Unit", 59).given(lastWord, false).given(sb, "9.xml").checkFalse(group());
                    new Here("Unit", 59).given(lastWord, false).given(sb, "7.xml").checkFalse(group());
                    new Here("Unit", 59).given(lastWord, false).given(sb, "5.xml").checkFalse(group());
                    new Here("Unit", 59).given(lastWord, false).given(sb, "11.xml").checkFalse(group());
                    new Here("Unit", 59).given(lastWord, false).given(sb, "2.xml").checkFalse(group());
                    new Here("Unit", 59).given(lastWord, true).given(sb, "0.xml").checkFalse(group());
                    new Here("Unit", 59).given(lastWord, true).given(sb, "3.xml").checkTrue(group());
                    new Here("Unit", 59).given(lastWord, true).given(sb, "1.xml").checkTrue(group());
                    pinyinStrList.add(sb.toString());
                    sb.setLength(0);
                }
                sb.append(c);
