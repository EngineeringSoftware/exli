...
public class TimePeriodsBase extends Resource {
    ...
    public ItemRequest<JsonElement> getTimePeriod(String timePeriodGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 31).given(timePeriodGid, "Forbidden").checkEq(path, "/time_periods/Forbidden");
        new Here("Randoop", 31).given(timePeriodGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/time_periods/urn:ietf:wg:oauth:2.0:oob");
        new Here("Randoop", 31).given(timePeriodGid, "Not Found").checkEq(path, "/time_periods/Not Found");
        new Here("Randoop", 31).given(timePeriodGid, "POST").checkEq(path, "/time_periods/POST");
        new Here("Randoop", 31).given(timePeriodGid, "/tasks/Not Found/removeProject").checkEq(path, "/time_periods//tasks/Not Found/removeProject");
        new Here("Randoop", 31).given(timePeriodGid, "com.asana.errors.InvalidRequestError: Invalid Request").checkEq(path, "/time_periods/com.asana.errors.InvalidRequestError: Invalid Request");
        new Here("Randoop", 31).given(timePeriodGid, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/time_periods/com.asana.errors.RetryableAsanaError: Not Found");
