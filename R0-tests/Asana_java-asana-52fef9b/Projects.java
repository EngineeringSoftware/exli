...
public class Projects extends ProjectsBase {
    ...
    public ItemRequest<Project> createInWorkspace(String workspace) {
        ...
        new Here("Randoop", 45).given(workspace, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=com.asana.errors.RateLimitEnforcedError:%20Rate%20Limit%20Enforced").checkEq(path, "/workspaces/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=com.asana.errors.RateLimitEnforcedError:%20Rate%20Limit%20Enforced/projects");
        new Here("Randoop", 45).given(workspace, "hi!").checkEq(path, "/workspaces/hi!/projects");
        new Here("Randoop", 45).given(workspace, "NoAuthorizationError").checkEq(path, "/workspaces/NoAuthorizationError/projects");
        new Here("Randoop", 45).given(workspace, "Forbidden").checkEq(path, "/workspaces/Forbidden/projects");
    ...
    public ItemRequest<Project> findById(String project) {
        ...
        new Here("Randoop", 71).given(project, "hi!").checkEq(path, "/projects/hi!");
        new Here("Randoop", 71).given(project, "").checkEq(path, "/projects/");
        new Here("Unit", 71).given(project, "1").checkEq(path, "/projects/1");
        new Here("Randoop", 71).given(project, "Server Error").checkEq(path, "/projects/Server Error");
        new Here("Randoop", 71).given(project, "/tasks/Not Found/removeProject").checkEq(path, "/projects//tasks/Not Found/removeProject");
        new Here("Randoop", 71).given(project, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/projects/com.asana.errors.RetryableAsanaError: Not Found");
    ...
    public ItemRequest<Project> update(String project) {
        String path = String.format("/projects/%s", project);
        new Here("Randoop", 91).given(project, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error").checkEq(path, "/projects/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error");
        new Here("Randoop", 91).given(project, "Payment Required").checkEq(path, "/projects/Payment Required");
    ...
    public CollectionRequest<Project> findByWorkspace(String workspace) {
        String path = String.format("/workspaces/%s/projects", workspace);
        new Here("Randoop", 129).given(workspace, "404").checkEq(path, "/workspaces/404/projects");
        new Here("Randoop", 129).given(workspace, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/workspaces/com.asana.errors.RetryableAsanaError: Not Found/projects");
        new Here("Randoop", 129).given(workspace, "Rate Limit Enforced").checkEq(path, "/workspaces/Rate Limit Enforced/projects");
    ...
    public CollectionRequest<Project> findByTeam(String team) {
        ...
        new Here("Randoop", 141).given(team, "").checkEq(path, "/teams//projects");
        new Here("Randoop", 141).given(team, "200").checkEq(path, "/teams/200/projects");
        return new CollectionRequest<Project>(this, Project.class, path, "GET");
    }
    ...
    public CollectionRequest<Project> tasks(String project) {
        ...
        new Here("Randoop", 154).given(project, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/projects/urn:ietf:wg:oauth:2.0:oob/tasks");
        new Here("Randoop", 154).given(project, "200").checkEq(path, "/projects/200/tasks");
        return new CollectionRequest<Project>(this, Project.class, path, "GET");
    }
    ...
    public ItemRequest<Project> addFollowers(String project) {
        ...
        new Here("Randoop", 168).given(project, "POST").checkEq(path, "/projects/POST/addFollowers");
        new Here("Randoop", 168).given(project, "200").checkEq(path, "/projects/200/addFollowers");
        return new ItemRequest<Project>(this, Project.class, path, "POST");
    }
    ...
    public ItemRequest<Project> removeFollowers(String project) {
        ...
        new Here("Randoop", 181).given(project, "/tasks/Not Found/removeProject").checkEq(path, "/projects//tasks/Not Found/removeProject/removeFollowers");
        ...
        new Here("Randoop", 181).given(project, "hi!").checkEq(path, "/projects/hi!/removeFollowers");
        return new ItemRequest<Project>(this, Project.class, path, "POST");
    }
    ...
    public ItemRequest<Project> addMembers(String project) {
        ...
        new Here("Randoop", 193).given(project, "404").checkEq(path, "/projects/404/addMembers");
        return new ItemRequest<Project>(this, Project.class, path, "POST");
    }
    ...
    public ItemRequest<Project> removeCustomFieldSetting(String project) {
        ...
        new Here("Randoop", 229).given(project, "com.asana.errors.InvalidRequestError: Invalid Request").checkEq(path, "/projects/com.asana.errors.InvalidRequestError: Invalid Request/removeCustomFieldSetting");
