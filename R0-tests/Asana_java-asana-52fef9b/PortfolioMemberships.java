...
public class PortfolioMemberships extends PortfolioMembershipsBase {
    ...
    public ItemRequest<PortfolioMembership> findById(String portfolioMembership) {
        ...
        new Here("Unit", 45).given(portfolioMembership, "1").checkEq(path, "/portfolio_memberships/1");
        new Here("Randoop", 45).given(portfolioMembership, "Forbidden").checkEq(path, "/portfolio_memberships/Forbidden");
        new Here("Randoop", 45).given(portfolioMembership, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/portfolio_memberships/com.asana.errors.RetryableAsanaError: Not Found");
