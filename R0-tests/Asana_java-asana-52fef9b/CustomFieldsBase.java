...
public class CustomFieldsBase extends Resource {
    ...
    public ItemRequest<JsonElement> createEnumOptionForCustomField(String customFieldGid, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 58).given(customFieldGid, "Forbidden").checkEq(path, "/custom_fields/Forbidden/enum_options");
        new Here("Randoop", 58).given(customFieldGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/custom_fields/urn:ietf:wg:oauth:2.0:oob/enum_options");
        new Here("Randoop", 58).given(customFieldGid, "Not Found").checkEq(path, "/custom_fields/Not Found/enum_options");
        new Here("Randoop", 58).given(customFieldGid, "Server Error").checkEq(path, "/custom_fields/Server Error/enum_options");
        new Here("Randoop", 58).given(customFieldGid, "200").checkEq(path, "/custom_fields/200/enum_options");
    ...
    public ItemRequest<JsonElement> deleteCustomField(String customFieldGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 82).given(customFieldGid, "Invalid Request").checkEq(path, "/custom_fields/Invalid Request");
        new Here("Randoop", 82).given(customFieldGid, "Server Error").checkEq(path, "/custom_fields/Server Error");
        new Here("Randoop", 82).given(customFieldGid, "hi!").checkEq(path, "/custom_fields/hi!");
    ...
    public ItemRequest<CustomField> getCustomField(String customFieldGid, List<String> optFields, Boolean optPretty) throws IOException {
        String path = "/custom_fields/{custom_field_gid}".replace("{custom_field_gid}", customFieldGid);
        new Here("Randoop", 104).given(customFieldGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request").checkEq(path, "/custom_fields/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request");
    ...
    public CollectionRequest<CustomField> getCustomFieldsForWorkspace(String workspaceGid, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 128).given(workspaceGid, "Sync token invalid or too old").checkEq(path, "/workspaces/Sync token invalid or too old/custom_fields");
        new Here("Randoop", 128).given(workspaceGid, "com.asana.errors.InvalidRequestError: Invalid Request").checkEq(path, "/workspaces/com.asana.errors.InvalidRequestError: Invalid Request/custom_fields");
        new Here("Randoop", 128).given(workspaceGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request").checkEq(path, "/workspaces/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request/custom_fields");
        new Here("Randoop", 128).given(workspaceGid, "hi!").checkEq(path, "/workspaces/hi!/custom_fields");
        new Here("Randoop", 128).given(workspaceGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/workspaces/urn:ietf:wg:oauth:2.0:oob/custom_fields");
        new Here("Randoop", 128).given(workspaceGid, "").checkEq(path, "/workspaces//custom_fields");
    ...
    public ItemRequest<JsonElement> insertEnumOptionForCustomField(String customFieldGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 152).given(customFieldGid, "DELETE").checkEq(path, "/custom_fields/DELETE/enum_options/insert");
        new Here("Randoop", 152).given(customFieldGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request").checkEq(path, "/custom_fields/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request/enum_options/insert");
        new Here("Randoop", 152).given(customFieldGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/custom_fields/urn:ietf:wg:oauth:2.0:oob/enum_options/insert");
        new Here("Randoop", 152).given(customFieldGid, "Sync token invalid or too old").checkEq(path, "/custom_fields/Sync token invalid or too old/enum_options/insert");
        new Here("Randoop", 152).given(customFieldGid, "com.asana.errors.InvalidRequestError: Invalid Request").checkEq(path, "/custom_fields/com.asana.errors.InvalidRequestError: Invalid Request/enum_options/insert");
        new Here("Randoop", 152).given(customFieldGid, "POST").checkEq(path, "/custom_fields/POST/enum_options/insert");
    ...
    public ItemRequest<CustomField> updateCustomField(String customFieldGid, List<String> optFields, Boolean optPretty) throws IOException {
        String path = "/custom_fields/{custom_field_gid}".replace("{custom_field_gid}", customFieldGid);
        new Here("Randoop", 174).given(customFieldGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/custom_fields/urn:ietf:wg:oauth:2.0:oob");
        new Here("Randoop", 174).given(customFieldGid, "Sync token invalid or too old").checkEq(path, "/custom_fields/Sync token invalid or too old");
        new Here("Randoop", 174).given(customFieldGid, "com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced").checkEq(path, "/custom_fields/com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced");
    ...
    public ItemRequest<JsonElement> updateEnumOption(String enumOptionGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 196).given(enumOptionGid, "Payment Required").checkEq(path, "/enum_options/Payment Required");
        new Here("Randoop", 196).given(enumOptionGid, "POST").checkEq(path, "/enum_options/POST");
        new Here("Randoop", 196).given(enumOptionGid, "404").checkEq(path, "/enum_options/404");
        new Here("Randoop", 196).given(enumOptionGid, "hi!").checkEq(path, "/enum_options/hi!");
