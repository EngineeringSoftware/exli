...
public class TagsBase extends Resource {
    ...
    public ItemRequest<Tag> createTagForWorkspace(String workspaceGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 52).given(workspaceGid, "Invalid Request").checkEq(path, "/workspaces/Invalid Request/tags");
        new Here("Randoop", 52).given(workspaceGid, "Forbidden").checkEq(path, "/workspaces/Forbidden/tags");
        new Here("Randoop", 52).given(workspaceGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/workspaces/urn:ietf:wg:oauth:2.0:oob/tags");
        new Here("Randoop", 52).given(workspaceGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error").checkEq(path, "/workspaces/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error/tags");
        new Here("Randoop", 52).given(workspaceGid, "Sync token invalid or too old").checkEq(path, "/workspaces/Sync token invalid or too old/tags");
        new Here("Randoop", 52).given(workspaceGid, "/tasks/Not Found/removeProject").checkEq(path, "/workspaces//tasks/Not Found/removeProject/tags");
        new Here("Randoop", 52).given(workspaceGid, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/workspaces/com.asana.errors.RetryableAsanaError: Not Found/tags");
        ItemRequest<Tag> req = new ItemRequest<Tag>(this, Tag.class, path, "POST").query("opt_pretty", optPretty).query("opt_fields", optFields);
        return req;
    }
    ...
    public ItemRequest<JsonElement> deleteTag(String tagGid, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 76).given(tagGid, "").checkEq(path, "/tags/");
        new Here("Randoop", 76).given(tagGid, "Not Found").checkEq(path, "/tags/Not Found");
        new Here("Randoop", 76).given(tagGid, "NoAuthorizationError").checkEq(path, "/tags/NoAuthorizationError");
        new Here("Randoop", 76).given(tagGid, "Forbidden").checkEq(path, "/tags/Forbidden");
        new Here("Randoop", 76).given(tagGid, "Sync token invalid or too old").checkEq(path, "/tags/Sync token invalid or too old");
    ...
    public ItemRequest<Tag> getTag(String tagGid, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
        String path = "/tags/{tag_gid}".replace("{tag_gid}", tagGid);
        new Here("Randoop", 102).given(tagGid, "/tasks/Not Found/removeProject").checkEq(path, "/tags//tasks/Not Found/removeProject");
        new Here("Randoop", 102).given(tagGid, "").checkEq(path, "/tags/");
        new Here("Randoop", 102).given(tagGid, "Not Found").checkEq(path, "/tags/Not Found");
        new Here("Randoop", 102).given(tagGid, "404").checkEq(path, "/tags/404");
        new Here("Randoop", 102).given(tagGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=POST").checkEq(path, "/tags/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=POST");
    ...
    public CollectionRequest<Tag> getTagsForTask(String taskGid, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 155).given(taskGid, "Not Found").checkEq(path, "/tasks/Not Found/tags");
        new Here("Randoop", 155).given(taskGid, "").checkEq(path, "/tasks//tags");
        new Here("Randoop", 155).given(taskGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error").checkEq(path, "/tasks/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error/tags");
        new Here("Randoop", 155).given(taskGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/tasks/urn:ietf:wg:oauth:2.0:oob/tags");
        new Here("Randoop", 155).given(taskGid, "Forbidden").checkEq(path, "/tasks/Forbidden/tags");
        new Here("Randoop", 155).given(taskGid, "hi!").checkEq(path, "/tasks/hi!/tags");
    ...
    public CollectionRequest<Tag> getTagsForWorkspace(String workspaceGid, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
        String path = "/workspaces/{workspace_gid}/tags".replace("{workspace_gid}", workspaceGid);
        new Here("Randoop", 181).given(workspaceGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request").checkEq(path, "/workspaces/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request/tags");
        new Here("Randoop", 181).given(workspaceGid, "/tasks/Not Found/removeProject").checkEq(path, "/workspaces//tasks/Not Found/removeProject/tags");
        new Here("Randoop", 181).given(workspaceGid, "").checkEq(path, "/workspaces//tags");
        new Here("Randoop", 181).given(workspaceGid, "POST").checkEq(path, "/workspaces/POST/tags");
        new Here("Randoop", 181).given(workspaceGid, "com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced").checkEq(path, "/workspaces/com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced/tags");
        new Here("Randoop", 181).given(workspaceGid, "hi!").checkEq(path, "/workspaces/hi!/tags");
        CollectionRequest<Tag> req = new CollectionRequest<Tag>(this, Tag.class, path, "GET").query("opt_pretty", optPretty).query("opt_fields", optFields).query("limit", limit).query("offset", offset);
        return req;
    }
    ...
    public ItemRequest<Tag> updateTag(String tagGid, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
        String path = "/tags/{tag_gid}".replace("{tag_gid}", tagGid);
        new Here("Randoop", 207).given(tagGid, "hi!").checkEq(path, "/tags/hi!");
