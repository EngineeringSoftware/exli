...
public class StoriesBase extends Resource {
    ...
    public ItemRequest<Story> createStoryForTask(String taskGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 31).given(taskGid, "404").checkEq(path, "/tasks/404/stories");
        new Here("Randoop", 31).given(taskGid, "Payment Required").checkEq(path, "/tasks/Payment Required/stories");
        new Here("Randoop", 31).given(taskGid, "hi!").checkEq(path, "/tasks/hi!/stories");
    ...
    public ItemRequest<JsonElement> deleteStory(String storyGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 53).given(storyGid, "hi!").checkEq(path, "/stories/hi!");
        new Here("Randoop", 53).given(storyGid, "POST").checkEq(path, "/stories/POST");
        new Here("Randoop", 53).given(storyGid, "com.asana.errors.InvalidRequestError: Invalid Request").checkEq(path, "/stories/com.asana.errors.InvalidRequestError: Invalid Request");
    ...
    public CollectionRequest<Story> getStoriesForTask(String taskGid, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
        String path = "/tasks/{task_gid}/stories".replace("{task_gid}", taskGid);
        new Here("Randoop", 77).given(taskGid, "").checkEq(path, "/tasks//stories");
        new Here("Randoop", 77).given(taskGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/tasks/urn:ietf:wg:oauth:2.0:oob/stories");
        new Here("Randoop", 77).given(taskGid, "Sync token invalid or too old").checkEq(path, "/tasks/Sync token invalid or too old/stories");
        new Here("Randoop", 77).given(taskGid, "com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced").checkEq(path, "/tasks/com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced/stories");
        new Here("Randoop", 77).given(taskGid, "Not Found").checkEq(path, "/tasks/Not Found/stories");
    ...
    public ItemRequest<Story> getStory(String storyGid, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
        String path = "/stories/{story_gid}".replace("{story_gid}", storyGid);
        new Here("Randoop", 103).given(storyGid, "").checkEq(path, "/stories/");
        new Here("Randoop", 103).given(storyGid, "com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced").checkEq(path, "/stories/com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced");
        new Here("Randoop", 103).given(storyGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/stories/urn:ietf:wg:oauth:2.0:oob");
        new Here("Randoop", 103).given(storyGid, "Forbidden").checkEq(path, "/stories/Forbidden");
        new Here("Randoop", 103).given(storyGid, "Not Found").checkEq(path, "/stories/Not Found");
    ...
    public ItemRequest<Story> updateStory(String storyGid, List<String> optFields, Boolean optPretty) throws IOException {
        String path = "/stories/{story_gid}".replace("{story_gid}", storyGid);
        new Here("Randoop", 127).given(storyGid, "Not Found").checkEq(path, "/stories/Not Found");
        new Here("Randoop", 127).given(storyGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error").checkEq(path, "/stories/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error");
        new Here("Randoop", 127).given(storyGid, "").checkEq(path, "/stories/");
        new Here("Randoop", 127).given(storyGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/stories/urn:ietf:wg:oauth:2.0:oob");
        new Here("Randoop", 127).given(storyGid, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/stories/com.asana.errors.RetryableAsanaError: Not Found");
