...
public class ProjectStatusesBase extends Resource {
    ...
    public ItemRequest<ProjectStatus> createProjectStatusForProject(String projectGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 31).given(projectGid, "Invalid Request").checkEq(path, "/projects/Invalid Request/project_statuses");
        new Here("Randoop", 31).given(projectGid, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/projects/com.asana.errors.RetryableAsanaError: Not Found/project_statuses");
        new Here("Randoop", 31).given(projectGid, "hi!").checkEq(path, "/projects/hi!/project_statuses");
    ...
    public ItemRequest<JsonElement> deleteProjectStatus(String projectStatusGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 53).given(projectStatusGid, "Sync token invalid or too old").checkEq(path, "/project_statuses/Sync token invalid or too old");
    ...
    public ItemRequest<ProjectStatus> getProjectStatus(String projectStatusGid, List<String> optFields, Boolean optPretty) throws IOException {
        String path = "/project_statuses/{project_status_gid}".replace("{project_status_gid}", projectStatusGid);
        new Here("Randoop", 75).given(projectStatusGid, "Not Found").checkEq(path, "/project_statuses/Not Found");
        new Here("Randoop", 75).given(projectStatusGid, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/project_statuses/com.asana.errors.RetryableAsanaError: Not Found");
        new Here("Randoop", 75).given(projectStatusGid, "com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced").checkEq(path, "/project_statuses/com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced");
    ...
    public CollectionRequest<ProjectStatus> getProjectStatusesForProject(String projectGid, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
        String path = "/projects/{project_gid}/project_statuses".replace("{project_gid}", projectGid);
        new Here("Randoop", 99).given(projectGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error").checkEq(path, "/projects/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error/project_statuses");
        new Here("Randoop", 99).given(projectGid, "").checkEq(path, "/projects//project_statuses");
        new Here("Randoop", 99).given(projectGid, "Not Found").checkEq(path, "/projects/Not Found/project_statuses");
        new Here("Randoop", 99).given(projectGid, "com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced").checkEq(path, "/projects/com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced/project_statuses");
        new Here("Randoop", 99).given(projectGid, "Forbidden").checkEq(path, "/projects/Forbidden/project_statuses");
