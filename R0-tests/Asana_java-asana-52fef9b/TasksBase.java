...
public class TasksBase extends Resource {
    ...
    public ItemRequest<JsonElement> addDependenciesForTask(String taskGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 31).given(taskGid, "Sync token invalid or too old").checkEq(path, "/tasks/Sync token invalid or too old/addDependencies");
        new Here("Randoop", 31).given(taskGid, "200").checkEq(path, "/tasks/200/addDependencies");
        new Here("Randoop", 31).given(taskGid, "com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced").checkEq(path, "/tasks/com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced/addDependencies");
        new Here("Randoop", 31).given(taskGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error").checkEq(path, "/tasks/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error/addDependencies");
        new Here("Randoop", 31).given(taskGid, "NoAuthorizationError").checkEq(path, "/tasks/NoAuthorizationError/addDependencies");
        new Here("Randoop", 31).given(taskGid, "").checkEq(path, "/tasks//addDependencies");
    ...
    public CollectionRequest<Task> addDependentsForTask(String taskGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 53).given(taskGid, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/tasks/com.asana.errors.RetryableAsanaError: Not Found/addDependents");
        new Here("Randoop", 53).given(taskGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request").checkEq(path, "/tasks/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request/addDependents");
        new Here("Randoop", 53).given(taskGid, "").checkEq(path, "/tasks//addDependents");
        new Here("Randoop", 53).given(taskGid, "hi!").checkEq(path, "/tasks/hi!/addDependents");
        new Here("Randoop", 53).given(taskGid, "/tasks/Not Found/removeProject").checkEq(path, "/tasks//tasks/Not Found/removeProject/addDependents");
    ...
    public ItemRequest<JsonElement> addFollowersForTask(String taskGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 75).given(taskGid, "com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced").checkEq(path, "/tasks/com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced/addFollowers");
        new Here("Randoop", 75).given(taskGid, "Invalid Request").checkEq(path, "/tasks/Invalid Request/addFollowers");
        new Here("Randoop", 75).given(taskGid, "200").checkEq(path, "/tasks/200/addFollowers");
        ItemRequest<JsonElement> req = new ItemRequest<JsonElement>(this, JsonElement.class, path, "POST").query("opt_pretty", optPretty).query("opt_fields", optFields);
        return req;
    }
    ...
    public ItemRequest<JsonElement> addProjectForTask(String taskGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 97).given(taskGid, "POST").checkEq(path, "/tasks/POST/addProject");
        ItemRequest<JsonElement> req = new ItemRequest<JsonElement>(this, JsonElement.class, path, "POST").query("opt_pretty", optPretty).query("opt_fields", optFields);
        return req;
    }
    ...
    public ItemRequest<JsonElement> addTagForTask(String taskGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 119).given(taskGid, "/tasks/Not Found/removeProject").checkEq(path, "/tasks//tasks/Not Found/removeProject/addTag");
        new Here("Randoop", 119).given(taskGid, "Not Found").checkEq(path, "/tasks/Not Found/addTag");
        new Here("Randoop", 119).given(taskGid, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/tasks/com.asana.errors.RetryableAsanaError: Not Found/addTag");
        new Here("Randoop", 119).given(taskGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request").checkEq(path, "/tasks/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request/addTag");
        new Here("Randoop", 119).given(taskGid, "NoAuthorizationError").checkEq(path, "/tasks/NoAuthorizationError/addTag");
        ItemRequest<JsonElement> req = new ItemRequest<JsonElement>(this, JsonElement.class, path, "POST").query("opt_pretty", optPretty).query("opt_fields", optFields);
        return req;
    }
    ...
    public ItemRequest<Task> createSubtaskForTask(String taskGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 141).given(taskGid, "Not Found").checkEq(path, "/tasks/Not Found/subtasks");
        new Here("Randoop", 141).given(taskGid, "").checkEq(path, "/tasks//subtasks");
        new Here("Randoop", 141).given(taskGid, "hi!").checkEq(path, "/tasks/hi!/subtasks");
        new Here("Randoop", 141).given(taskGid, "/tasks/Not Found/removeProject").checkEq(path, "/tasks//tasks/Not Found/removeProject/subtasks");
        new Here("Randoop", 141).given(taskGid, "Sync token invalid or too old").checkEq(path, "/tasks/Sync token invalid or too old/subtasks");
        new Here("Randoop", 141).given(taskGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error").checkEq(path, "/tasks/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error/subtasks");
    ...
    public ItemRequest<JsonElement> deleteTask(String taskGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 184).given(taskGid, "").checkEq(path, "/tasks/");
        new Here("Randoop", 184).given(taskGid, "Rate Limit Enforced").checkEq(path, "/tasks/Rate Limit Enforced");
        new Here("Randoop", 184).given(taskGid, "DELETE").checkEq(path, "/tasks/DELETE");
        new Here("Randoop", 184).given(taskGid, "hi!").checkEq(path, "/tasks/hi!");
    ...
    public ItemRequest<Job> duplicateTask(String taskGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 206).given(taskGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/tasks/urn:ietf:wg:oauth:2.0:oob/duplicate");
        new Here("Randoop", 206).given(taskGid, "POST").checkEq(path, "/tasks/POST/duplicate");
        new Here("Randoop", 206).given(taskGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=404").checkEq(path, "/tasks/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=404/duplicate");
        new Here("Randoop", 206).given(taskGid, "Not Found").checkEq(path, "/tasks/Not Found/duplicate");
    ...
    public CollectionRequest<Task> getDependenciesForTask(String taskGid, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 230).given(taskGid, "hi!").checkEq(path, "/tasks/hi!/dependencies");
        new Here("Randoop", 230).given(taskGid, "Server Error").checkEq(path, "/tasks/Server Error/dependencies");
        new Here("Randoop", 230).given(taskGid, "POST").checkEq(path, "/tasks/POST/dependencies");
    ...
    public CollectionRequest<Task> getDependentsForTask(String taskGid, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 256).given(taskGid, "GET").checkEq(path, "/tasks/GET/dependents");
        new Here("Randoop", 256).given(taskGid, "POST").checkEq(path, "/tasks/POST/dependents");
        new Here("Randoop", 256).given(taskGid, "hi!").checkEq(path, "/tasks/hi!/dependents");
        new Here("Randoop", 256).given(taskGid, "Invalid Request").checkEq(path, "/tasks/Invalid Request/dependents");
        new Here("Randoop", 256).given(taskGid, "Not Found").checkEq(path, "/tasks/Not Found/dependents");
        new Here("Randoop", 256).given(taskGid, "").checkEq(path, "/tasks//dependents");
        CollectionRequest<Task> req = new CollectionRequest<Task>(this, Task.class, path, "GET").query("opt_pretty", optPretty).query("opt_fields", optFields).query("limit", limit).query("offset", offset);
        return req;
    }
    ...
    public CollectionRequest<Task> getSubtasksForTask(String taskGid, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
        String path = "/tasks/{task_gid}/subtasks".replace("{task_gid}", taskGid);
        new Here("Randoop", 282).given(taskGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/tasks/urn:ietf:wg:oauth:2.0:oob/subtasks");
        new Here("Randoop", 282).given(taskGid, "com.asana.errors.InvalidRequestError: Invalid Request").checkEq(path, "/tasks/com.asana.errors.InvalidRequestError: Invalid Request/subtasks");
        new Here("Randoop", 282).given(taskGid, "/tasks/Not Found/removeProject").checkEq(path, "/tasks//tasks/Not Found/removeProject/subtasks");
        new Here("Randoop", 282).given(taskGid, "Forbidden").checkEq(path, "/tasks/Forbidden/subtasks");
        CollectionRequest<Task> req = new CollectionRequest<Task>(this, Task.class, path, "GET").query("opt_pretty", optPretty).query("opt_fields", optFields).query("limit", limit).query("offset", offset);
        return req;
    }
    ...
    public ItemRequest<Task> getTask(String taskGid, List<String> optFields, Boolean optPretty) throws IOException {
        String path = "/tasks/{task_gid}".replace("{task_gid}", taskGid);
        new Here("Randoop", 306).given(taskGid, "Forbidden").checkEq(path, "/tasks/Forbidden");
        new Here("Randoop", 306).given(taskGid, "POST").checkEq(path, "/tasks/POST");
        new Here("Randoop", 306).given(taskGid, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/tasks/com.asana.errors.RetryableAsanaError: Not Found");
        new Here("Randoop", 306).given(taskGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/tasks/urn:ietf:wg:oauth:2.0:oob");
    ...
    public CollectionRequest<Task> getTasksForProject(String projectGid, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 367).given(projectGid, "").checkEq(path, "/projects//tasks");
        new Here("Randoop", 367).given(projectGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error").checkEq(path, "/projects/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error/tasks");
        new Here("Randoop", 367).given(projectGid, "com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced").checkEq(path, "/projects/com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced/tasks");
        new Here("Randoop", 367).given(projectGid, "DELETE").checkEq(path, "/projects/DELETE/tasks");
        new Here("Randoop", 367).given(projectGid, "NoAuthorizationError").checkEq(path, "/projects/NoAuthorizationError/tasks");
        new Here("Randoop", 367).given(projectGid, "200").checkEq(path, "/projects/200/tasks");
        new Here("Randoop", 367).given(projectGid, "POST").checkEq(path, "/projects/POST/tasks");
        CollectionRequest<Task> req = new CollectionRequest<Task>(this, Task.class, path, "GET").query("opt_pretty", optPretty).query("opt_fields", optFields).query("limit", limit).query("offset", offset);
        return req;
    }
    ...
    public CollectionRequest<Task> getTasksForSection(String sectionGid, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 393).given(sectionGid, "com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced").checkEq(path, "/sections/com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced/tasks");
        new Here("Randoop", 393).given(sectionGid, "Sync token invalid or too old").checkEq(path, "/sections/Sync token invalid or too old/tasks");
        CollectionRequest<Task> req = new CollectionRequest<Task>(this, Task.class, path, "GET").query("opt_pretty", optPretty).query("opt_fields", optFields).query("limit", limit).query("offset", offset);
        return req;
    }
    ...
    public CollectionRequest<Task> getTasksForTag(String tagGid, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 419).given(tagGid, "hi!").checkEq(path, "/tags/hi!/tasks");
        new Here("Randoop", 419).given(tagGid, "/tasks/Not Found/removeProject").checkEq(path, "/tags//tasks/Not Found/removeProject/tasks");
        new Here("Randoop", 419).given(tagGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=404").checkEq(path, "/tags/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=404/tasks");
        new Here("Randoop", 419).given(tagGid, "Invalid Request").checkEq(path, "/tags/Invalid Request/tasks");
        new Here("Randoop", 419).given(tagGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request").checkEq(path, "/tags/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request/tasks");
        new Here("Randoop", 419).given(tagGid, "Server Error").checkEq(path, "/tags/Server Error/tasks");
        new Here("Randoop", 419).given(tagGid, "POST").checkEq(path, "/tags/POST/tasks");
        CollectionRequest<Task> req = new CollectionRequest<Task>(this, Task.class, path, "GET").query("opt_pretty", optPretty).query("opt_fields", optFields).query("limit", limit).query("offset", offset);
        return req;
    }
    ...
    public CollectionRequest<Task> getTasksForUserTaskList(String userTaskListGid, String completedSince, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 446).given(userTaskListGid, "Payment Required").checkEq(path, "/user_task_lists/Payment Required/tasks");
        new Here("Randoop", 446).given(userTaskListGid, "Server Error").checkEq(path, "/user_task_lists/Server Error/tasks");
        new Here("Randoop", 446).given(userTaskListGid, "com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced").checkEq(path, "/user_task_lists/com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced/tasks");
        new Here("Randoop", 446).given(userTaskListGid, "200").checkEq(path, "/user_task_lists/200/tasks");
        new Here("Randoop", 446).given(userTaskListGid, "DELETE").checkEq(path, "/user_task_lists/DELETE/tasks");
        new Here("Randoop", 446).given(userTaskListGid, "NoAuthorizationError").checkEq(path, "/user_task_lists/NoAuthorizationError/tasks");
        new Here("Randoop", 446).given(userTaskListGid, "/tasks/Not Found/removeProject").checkEq(path, "/user_task_lists//tasks/Not Found/removeProject/tasks");
    ...
    public CollectionRequest<JsonElement> removeDependenciesForTask(String taskGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 471).given(taskGid, "Sync token invalid or too old").checkEq(path, "/tasks/Sync token invalid or too old/removeDependencies");
        new Here("Randoop", 471).given(taskGid, "hi!").checkEq(path, "/tasks/hi!/removeDependencies");
        new Here("Randoop", 471).given(taskGid, "Rate Limit Enforced").checkEq(path, "/tasks/Rate Limit Enforced/removeDependencies");
        new Here("Randoop", 471).given(taskGid, "Not Found").checkEq(path, "/tasks/Not Found/removeDependencies");
    ...
    public CollectionRequest<JsonElement> removeDependentsForTask(String taskGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 493).given(taskGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/tasks/urn:ietf:wg:oauth:2.0:oob/removeDependents");
        new Here("Randoop", 493).given(taskGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=com.asana.errors.RateLimitEnforcedError:%20Rate%20Limit%20Enforced").checkEq(path, "/tasks/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=com.asana.errors.RateLimitEnforcedError:%20Rate%20Limit%20Enforced/removeDependents");
        new Here("Randoop", 493).given(taskGid, "hi!").checkEq(path, "/tasks/hi!/removeDependents");
        new Here("Randoop", 493).given(taskGid, "Not Found").checkEq(path, "/tasks/Not Found/removeDependents");
        new Here("Randoop", 493).given(taskGid, "DELETE").checkEq(path, "/tasks/DELETE/removeDependents");
        new Here("Randoop", 493).given(taskGid, "com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced").checkEq(path, "/tasks/com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced/removeDependents");
        CollectionRequest<JsonElement> req = new CollectionRequest<JsonElement>(this, JsonElement.class, path, "POST").query("opt_pretty", optPretty).query("opt_fields", optFields);
        return req;
    }
    ...
    public ItemRequest<JsonElement> removeFollowerForTask(String taskGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 515).given(taskGid, "Not Found").checkEq(path, "/tasks/Not Found/removeFollowers");
        new Here("Randoop", 515).given(taskGid, "Sync token invalid or too old").checkEq(path, "/tasks/Sync token invalid or too old/removeFollowers");
        new Here("Randoop", 515).given(taskGid, "").checkEq(path, "/tasks//removeFollowers");
        new Here("Randoop", 515).given(taskGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error").checkEq(path, "/tasks/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error/removeFollowers");
        new Here("Randoop", 515).given(taskGid, "Payment Required").checkEq(path, "/tasks/Payment Required/removeFollowers");
        new Here("Randoop", 515).given(taskGid, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/tasks/com.asana.errors.RetryableAsanaError: Not Found/removeFollowers");
        ItemRequest<JsonElement> req = new ItemRequest<JsonElement>(this, JsonElement.class, path, "POST").query("opt_pretty", optPretty).query("opt_fields", optFields);
        return req;
    }
    ...
    public ItemRequest<JsonElement> removeProjectForTask(String taskGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 537).given(taskGid, "/tasks/Not Found/removeProject").checkEq(path, "/tasks//tasks/Not Found/removeProject/removeProject");
        new Here("Randoop", 537).given(taskGid, "hi!").checkEq(path, "/tasks/hi!/removeProject");
        new Here("Randoop", 537).given(taskGid, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/tasks/com.asana.errors.RetryableAsanaError: Not Found/removeProject");
        new Here("Randoop", 537).given(taskGid, "Not Found").checkEq(path, "/tasks/Not Found/removeProject");
        new Here("Randoop", 537).given(taskGid, "").checkEq(path, "/tasks//removeProject");
        new Here("Randoop", 537).given(taskGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/tasks/urn:ietf:wg:oauth:2.0:oob/removeProject");
        ItemRequest<JsonElement> req = new ItemRequest<JsonElement>(this, JsonElement.class, path, "POST").query("opt_pretty", optPretty).query("opt_fields", optFields);
        return req;
    }
    ...
    public ItemRequest<JsonElement> removeTagForTask(String taskGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 559).given(taskGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error").checkEq(path, "/tasks/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error/removeTag");
        new Here("Randoop", 559).given(taskGid, "com.asana.errors.InvalidRequestError: Invalid Request").checkEq(path, "/tasks/com.asana.errors.InvalidRequestError: Invalid Request/removeTag");
        new Here("Randoop", 559).given(taskGid, "hi!").checkEq(path, "/tasks/hi!/removeTag");
        new Here("Randoop", 559).given(taskGid, "Not Found").checkEq(path, "/tasks/Not Found/removeTag");
        new Here("Randoop", 559).given(taskGid, "").checkEq(path, "/tasks//removeTag");
        ItemRequest<JsonElement> req = new ItemRequest<JsonElement>(this, JsonElement.class, path, "POST").query("opt_pretty", optPretty).query("opt_fields", optFields);
        return req;
    }
    ...
    public CollectionRequest<Task> searchTasksForWorkspace(String workspaceGid, Boolean sortAscending, String sortBy, Boolean isSubtask, Boolean completed, Boolean hasAttachment, Boolean isBlocked, Boolean isBlocking, OffsetDateTime modifiedAtAfter, OffsetDateTime modifiedAtBefore, LocalDate dueOn, LocalDate modifiedOn, LocalDate modifiedOnAfter, LocalDate modifiedOnBefore, OffsetDateTime completedAtAfter, OffsetDateTime completedAtBefore, LocalDate completedOn, LocalDate completedOnAfter, LocalDate completedOnBefore, OffsetDateTime createdAtAfter, LocalDate dueOnAfter, OffsetDateTime createdAtBefore, LocalDate createdOn, LocalDate createdOnAfter, LocalDate createdOnBefore, LocalDate startOn, LocalDate startOnAfter, LocalDate startOnBefore, OffsetDateTime dueAtAfter, OffsetDateTime dueAtBefore, LocalDate dueOnBefore, String commentedOnByNot, String likedByNot, String assignedByNot, String assignedByAny, String createdByNot, String createdByAny, String followersNot, String teamsAny, String tagsAll, String tagsNot, String tagsAny, String sectionsAll, String sectionsNot, String sectionsAny, String projectsAll, String projectsNot, String projectsAny, String portfoliosAny, String assigneeNot, String assigneeAny, String resourceSubtype, String text, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 633).given(workspaceGid, "POST").checkEq(path, "/workspaces/POST/tasks/search");
        new Here("Randoop", 633).given(workspaceGid, "hi!").checkEq(path, "/workspaces/hi!/tasks/search");
        new Here("Randoop", 633).given(workspaceGid, "").checkEq(path, "/workspaces//tasks/search");
    ...
    public ItemRequest<Task> setParentForTask(String taskGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 707).given(taskGid, "com.asana.errors.InvalidRequestError: Invalid Request").checkEq(path, "/tasks/com.asana.errors.InvalidRequestError: Invalid Request/setParent");
        new Here("Randoop", 707).given(taskGid, "com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced").checkEq(path, "/tasks/com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced/setParent");
        new Here("Randoop", 707).given(taskGid, "404").checkEq(path, "/tasks/404/setParent");
        new Here("Randoop", 707).given(taskGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error").checkEq(path, "/tasks/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error/setParent");
        new Here("Randoop", 707).given(taskGid, "200").checkEq(path, "/tasks/200/setParent");
        ItemRequest<Task> req = new ItemRequest<Task>(this, Task.class, path, "POST").query("opt_pretty", optPretty).query("opt_fields", optFields);
        return req;
    }
    ...
    public ItemRequest<Task> updateTask(String taskGid, List<String> optFields, Boolean optPretty) throws IOException {
        String path = "/tasks/{task_gid}".replace("{task_gid}", taskGid);
        new Here("Randoop", 729).given(taskGid, "Invalid Request").checkEq(path, "/tasks/Invalid Request");
        new Here("Randoop", 729).given(taskGid, "com.asana.errors.InvalidRequestError: Invalid Request").checkEq(path, "/tasks/com.asana.errors.InvalidRequestError: Invalid Request");
        new Here("Randoop", 729).given(taskGid, "Sync token invalid or too old").checkEq(path, "/tasks/Sync token invalid or too old");
        new Here("Randoop", 729).given(taskGid, "").checkEq(path, "/tasks/");
        new Here("Randoop", 729).given(taskGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/tasks/urn:ietf:wg:oauth:2.0:oob");
