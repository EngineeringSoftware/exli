...
public class WorkspaceMembershipsBase extends Resource {
    ...
    public ItemRequest<JsonElement> getWorkspaceMembership(String workspaceMembershipGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 31).given(workspaceMembershipGid, "").checkEq(path, "/workspace_memberships/");
    ...
    public CollectionRequest<JsonElement> getWorkspaceMembershipsForUser(String userGid, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 55).given(userGid, "DELETE").checkEq(path, "/users/DELETE/workspace_memberships");
        new Here("Randoop", 55).given(userGid, "hi!").checkEq(path, "/users/hi!/workspace_memberships");
        new Here("Randoop", 55).given(userGid, "").checkEq(path, "/users//workspace_memberships");
    ...
    public CollectionRequest<JsonElement> getWorkspaceMembershipsForWorkspace(String workspaceGid, String user, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 82).given(workspaceGid, "").checkEq(path, "/workspaces//workspace_memberships");
        new Here("Randoop", 82).given(workspaceGid, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/workspaces/com.asana.errors.RetryableAsanaError: Not Found/workspace_memberships");
        new Here("Randoop", 82).given(workspaceGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/workspaces/urn:ietf:wg:oauth:2.0:oob/workspace_memberships");
        new Here("Randoop", 82).given(workspaceGid, "200").checkEq(path, "/workspaces/200/workspace_memberships");
