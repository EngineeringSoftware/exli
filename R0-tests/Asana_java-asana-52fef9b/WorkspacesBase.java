...
public class WorkspacesBase extends Resource {
    ...
    public ItemRequest<User> addUserForWorkspace(String workspaceGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 31).given(workspaceGid, "hi!").checkEq(path, "/workspaces/hi!/addUser");
        new Here("Randoop", 31).given(workspaceGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/workspaces/urn:ietf:wg:oauth:2.0:oob/addUser");
        new Here("Randoop", 31).given(workspaceGid, "404").checkEq(path, "/workspaces/404/addUser");
        new Here("Randoop", 31).given(workspaceGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=com.asana.errors.RateLimitEnforcedError:%20Rate%20Limit%20Enforced").checkEq(path, "/workspaces/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=com.asana.errors.RateLimitEnforcedError:%20Rate%20Limit%20Enforced/addUser");
    ...
    public ItemRequest<Workspace> getWorkspace(String workspaceGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 53).given(workspaceGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/workspaces/urn:ietf:wg:oauth:2.0:oob");
        new Here("Randoop", 53).given(workspaceGid, "/tasks/Not Found/removeProject").checkEq(path, "/workspaces//tasks/Not Found/removeProject");
        new Here("Randoop", 53).given(workspaceGid, "").checkEq(path, "/workspaces/");
    ...
    public ItemRequest<JsonElement> removeUserForWorkspace(String workspaceGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 100).given(workspaceGid, "hi!").checkEq(path, "/workspaces/hi!/removeUser");
        new Here("Randoop", 100).given(workspaceGid, "Not Found").checkEq(path, "/workspaces/Not Found/removeUser");
        new Here("Randoop", 100).given(workspaceGid, "/tasks/Not Found/removeProject").checkEq(path, "/workspaces//tasks/Not Found/removeProject/removeUser");
    ...
    public ItemRequest<Workspace> updateWorkspace(String workspaceGid, List<String> optFields, Boolean optPretty) throws IOException {
        String path = "/workspaces/{workspace_gid}".replace("{workspace_gid}", workspaceGid);
        new Here("Randoop", 122).given(workspaceGid, "Server Error").checkEq(path, "/workspaces/Server Error");
        new Here("Randoop", 122).given(workspaceGid, "").checkEq(path, "/workspaces/");
        new Here("Randoop", 122).given(workspaceGid, "Forbidden").checkEq(path, "/workspaces/Forbidden");
        new Here("Randoop", 122).given(workspaceGid, "hi!").checkEq(path, "/workspaces/hi!");
