...
public class GoalsBase extends Resource {
    ...
    public ItemRequest<JsonElement> deleteGoal(String goalGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 140).given(goalGid, "404").checkEq(path, "/goals/404");
        new Here("Randoop", 140).given(goalGid, "Payment Required").checkEq(path, "/goals/Payment Required");
        new Here("Randoop", 140).given(goalGid, "Sync token invalid or too old").checkEq(path, "/goals/Sync token invalid or too old");
        new Here("Randoop", 140).given(goalGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/goals/urn:ietf:wg:oauth:2.0:oob");
        new Here("Randoop", 140).given(goalGid, "").checkEq(path, "/goals/");
    ...
    public ItemRequest<JsonElement> getGoal(String goalGid, List<String> optFields, Boolean optPretty) throws IOException {
        String path = "/goals/{goal_gid}".replace("{goal_gid}", goalGid);
        new Here("Randoop", 162).given(goalGid, "Server Error").checkEq(path, "/goals/Server Error");
    ...
    public ItemRequest<JsonElement> updateGoal(String goalGid, List<String> optFields, Boolean optPretty) throws IOException {
        String path = "/goals/{goal_gid}".replace("{goal_gid}", goalGid);
        new Here("Randoop", 347).given(goalGid, "Payment Required").checkEq(path, "/goals/Payment Required");
        new Here("Randoop", 347).given(goalGid, "GET").checkEq(path, "/goals/GET");
        new Here("Randoop", 347).given(goalGid, "200").checkEq(path, "/goals/200");
