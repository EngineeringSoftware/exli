...
public class Tasks extends TasksBase {
    ...
    public ItemRequest<Task> createInWorkspace(String workspace) {
        ...
        new Here("Randoop", 48).given(workspace, "/tasks/Not Found/removeProject").checkEq(path, "/workspaces//tasks/Not Found/removeProject/tasks");
        new Here("Randoop", 48).given(workspace, "Server Error").checkEq(path, "/workspaces/Server Error/tasks");
        new Here("Randoop", 48).given(workspace, "hi!").checkEq(path, "/workspaces/hi!/tasks");
    ...
    public ItemRequest<Task> findById(String task) {
        ...
        new Here("Randoop", 60).given(task, "com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced").checkEq(path, "/tasks/com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced");
        new Here("Randoop", 60).given(task, "").checkEq(path, "/tasks/");
        new Here("Unit", 60).given(task, "1").checkEq(path, "/tasks/1");
        new Here("Randoop", 60).given(task, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/tasks/com.asana.errors.RetryableAsanaError: Not Found");
    ...
    public ItemRequest<Task> update(String task) {
        String path = String.format("/tasks/%s", task);
        new Here("Randoop", 80).given(task, "Server Error").checkEq(path, "/tasks/Server Error");
        new Here("Randoop", 80).given(task, "POST").checkEq(path, "/tasks/POST");
        new Here("Randoop", 80).given(task, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request").checkEq(path, "/tasks/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request");
        new Here("Unit", 80).given(task, "1").checkEq(path, "/tasks/1");
        new Here("Unit", 80).given(task, "1001").checkEq(path, "/tasks/1001");
        new Here("Randoop", 80).given(task, "hi!").checkEq(path, "/tasks/hi!");
        new Here("Randoop", 80).given(task, "Sync token invalid or too old").checkEq(path, "/tasks/Sync token invalid or too old");
        new Here("Randoop", 80).given(task, "com.asana.errors.InvalidRequestError: Invalid Request").checkEq(path, "/tasks/com.asana.errors.InvalidRequestError: Invalid Request");
    ...
    public ItemRequest<Task> delete(String task) {
        ...
        new Here("Randoop", 97).given(task, "/tasks/Not Found/removeProject").checkEq(path, "/tasks//tasks/Not Found/removeProject");
        new Here("Randoop", 97).given(task, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/tasks/com.asana.errors.RetryableAsanaError: Not Found");
        new Here("Randoop", 97).given(task, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error").checkEq(path, "/tasks/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error");
        new Here("Randoop", 97).given(task, "hi!").checkEq(path, "/tasks/hi!");
        new Here("Randoop", 97).given(task, "Sync token invalid or too old").checkEq(path, "/tasks/Sync token invalid or too old");
    ...
    public CollectionRequest<Task> findByProject(String project) {
        ...
        new Here("Randoop", 110).given(project, "Not Found").checkEq(path, "/projects/Not Found/tasks");
        new Here("Randoop", 110).given(project, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/projects/com.asana.errors.RetryableAsanaError: Not Found/tasks");
    ...
    public CollectionRequest<Task> findByTag(String tag) {
        ...
        new Here("Randoop", 122).given(tag, "NoAuthorizationError").checkEq(path, "/tags/NoAuthorizationError/tasks");
        new Here("Randoop", 122).given(tag, "Not Found").checkEq(path, "/tags/Not Found/tasks");
        new Here("Randoop", 122).given(tag, "POST").checkEq(path, "/tags/POST/tasks");
        new Here("Randoop", 122).given(tag, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=404").checkEq(path, "/tags/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=404/tasks");
        new Here("Randoop", 122).given(tag, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request").checkEq(path, "/tags/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request/tasks");
        new Here("Randoop", 122).given(tag, "hi!").checkEq(path, "/tags/hi!/tasks");
        new Here("Randoop", 122).given(tag, "Rate Limit Enforced").checkEq(path, "/tags/Rate Limit Enforced/tasks");
        return new CollectionRequest<Task>(this, Task.class, path, "GET");
    }
    ...
    public CollectionRequest<Task> findBySection(String section) {
        ...
        new Here("Randoop", 134).given(section, "NoAuthorizationError").checkEq(path, "/sections/NoAuthorizationError/tasks");
        new Here("Randoop", 134).given(section, "Server Error").checkEq(path, "/sections/Server Error/tasks");
        new Here("Randoop", 134).given(section, "Invalid Request").checkEq(path, "/sections/Invalid Request/tasks");
        new Here("Randoop", 134).given(section, "hi!").checkEq(path, "/sections/hi!/tasks");
        return new CollectionRequest<Task>(this, Task.class, path, "GET");
    }
    ...
    public CollectionRequest<Task> findByUserTaskList(String userTaskList) {
        ...
        new Here("Randoop", 162).given(userTaskList, "").checkEq(path, "/user_task_lists//tasks");
        new Here("Randoop", 162).given(userTaskList, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/user_task_lists/com.asana.errors.RetryableAsanaError: Not Found/tasks");
        new Here("Randoop", 162).given(userTaskList, "Not Found").checkEq(path, "/user_task_lists/Not Found/tasks");
        return new CollectionRequest<Task>(this, Task.class, path, "GET");
    }
    ...
    public CollectionRequest<Task> getTasksWithTag(String tag) {
        String path = String.format("/tags/%s/tasks", tag);
        new Here("Randoop", 188).given(tag, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=404").checkEq(path, "/tags/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=404/tasks");
        new Here("Randoop", 188).given(tag, "200").checkEq(path, "/tags/200/tasks");
    ...
    public CollectionRequest<Task> searchInWorkspace(String workspace) {
        ...
        new Here("Randoop", 200).given(workspace, "Forbidden").checkEq(path, "/workspaces/Forbidden/tasks/search");
        new Here("Randoop", 200).given(workspace, "hi!").checkEq(path, "/workspaces/hi!/tasks/search");
        return new CollectionRequest<Task>(this, Task.class, path, "GET");
    }
    ...
    public ItemRequest<Task> dependencies(String task) {
        ...
        new Here("Randoop", 212).given(task, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error").checkEq(path, "/tasks/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error/dependencies");
    ...
    public ItemRequest<Task> dependents(String task) {
        ...
        new Here("Randoop", 224).given(task, "Payment Required").checkEq(path, "/tasks/Payment Required/dependents");
    ...
    public ItemRequest<Task> addDependents(String task) {
        ...
        new Here("Randoop", 250).given(task, "/tasks/Not Found/removeProject").checkEq(path, "/tasks//tasks/Not Found/removeProject/addDependents");
        new Here("Randoop", 250).given(task, "").checkEq(path, "/tasks//addDependents");
        new Here("Randoop", 250).given(task, "DELETE").checkEq(path, "/tasks/DELETE/addDependents");
    ...
    public ItemRequest<Task> removeDependencies(String task) {
        ...
        new Here("Randoop", 262).given(task, "com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced").checkEq(path, "/tasks/com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced/removeDependencies");
        new Here("Randoop", 262).given(task, "Not Found").checkEq(path, "/tasks/Not Found/removeDependencies");
        return new ItemRequest<Task>(this, Task.class, path, "POST");
    }
    ...
    public ItemRequest<Task> addFollowers(String task) {
        ...
        new Here("Randoop", 287).given(task, "GET").checkEq(path, "/tasks/GET/addFollowers");
        ...
        new Here("Randoop", 287).given(task, "com.asana.errors.InvalidRequestError: Invalid Request").checkEq(path, "/tasks/com.asana.errors.InvalidRequestError: Invalid Request/addFollowers");
        return new ItemRequest<Task>(this, Task.class, path, "POST");
    }
    ...
    public ItemRequest<Task> removeFollowers(String task) {
        ...
        new Here("Randoop", 300).given(task, "Not Found").checkEq(path, "/tasks/Not Found/removeFollowers");
        return new ItemRequest<Task>(this, Task.class, path, "POST");
    }
    ...
    public CollectionRequest<Task> projects(String task) {
        ...
        new Here("Randoop", 312).given(task, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/tasks/com.asana.errors.RetryableAsanaError: Not Found/projects");
        new Here("Randoop", 312).given(task, "Invalid Request").checkEq(path, "/tasks/Invalid Request/projects");
        new Here("Randoop", 312).given(task, "hi!").checkEq(path, "/tasks/hi!/projects");
        return new CollectionRequest<Task>(this, Task.class, path, "GET");
    }
    ...
    public ItemRequest<Task> addProject(String task) {
        ...
        new Here("Randoop", 337).given(task, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=404").checkEq(path, "/tasks/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=404/addProject");
        new Here("Randoop", 337).given(task, "POST").checkEq(path, "/tasks/POST/addProject");
        new Here("Randoop", 337).given(task, "NoAuthorizationError").checkEq(path, "/tasks/NoAuthorizationError/addProject");
        new Here("Randoop", 337).given(task, "").checkEq(path, "/tasks//addProject");
        return new ItemRequest<Task>(this, Task.class, path, "POST");
    }
    ...
    public ItemRequest<Task> removeProject(String task) {
        ...
        new Here("Randoop", 352).given(task, "Forbidden").checkEq(path, "/tasks/Forbidden/removeProject");
        new Here("Randoop", 352).given(task, "").checkEq(path, "/tasks//removeProject");
        new Here("Randoop", 352).given(task, "hi!").checkEq(path, "/tasks/hi!/removeProject");
        new Here("Randoop", 352).given(task, "Not Found").checkEq(path, "/tasks/Not Found/removeProject");
        return new ItemRequest<Task>(this, Task.class, path, "POST");
    }
    ...
    public CollectionRequest<Task> tags(String task) {
        ...
        new Here("Randoop", 364).given(task, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/tasks/com.asana.errors.RetryableAsanaError: Not Found/tags");
        new Here("Randoop", 364).given(task, "Rate Limit Enforced").checkEq(path, "/tasks/Rate Limit Enforced/tags");
    ...
    public ItemRequest<Task> addTag(String task) {
        ...
        new Here("Randoop", 376).given(task, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/tasks/com.asana.errors.RetryableAsanaError: Not Found/addTag");
        new Here("Randoop", 376).given(task, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=com.asana.errors.RateLimitEnforcedError:%20Rate%20Limit%20Enforced").checkEq(path, "/tasks/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=com.asana.errors.RateLimitEnforcedError:%20Rate%20Limit%20Enforced/addTag");
        new Here("Randoop", 376).given(task, "com.asana.errors.InvalidRequestError: Invalid Request").checkEq(path, "/tasks/com.asana.errors.InvalidRequestError: Invalid Request/addTag");
        return new ItemRequest<Task>(this, Task.class, path, "POST");
    }
    ...
    public ItemRequest<Task> removeTag(String task) {
        ...
        new Here("Randoop", 388).given(task, "Sync token invalid or too old").checkEq(path, "/tasks/Sync token invalid or too old/removeTag");
    ...
    public CollectionRequest<Task> subtasks(String task) {
        ...
        new Here("Randoop", 400).given(task, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/tasks/com.asana.errors.RetryableAsanaError: Not Found/subtasks");
        new Here("Randoop", 400).given(task, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/tasks/urn:ietf:wg:oauth:2.0:oob/subtasks");
        return new CollectionRequest<Task>(this, Task.class, path, "GET");
    }
    ...
    public ItemRequest<Task> addSubtask(String task) {
        String path = String.format("/tasks/%s/subtasks", task);
        new Here("Randoop", 413).given(task, "Invalid Request").checkEq(path, "/tasks/Invalid Request/subtasks");
        ...
        new Here("Randoop", 413).given(task, "").checkEq(path, "/tasks//subtasks");
        new Here("Randoop", 413).given(task, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/tasks/com.asana.errors.RetryableAsanaError: Not Found/subtasks");
        return new ItemRequest<Task>(this, Task.class, path, "POST");
    }
    ...
    public CollectionRequest<Task> stories(String task) {
        ...
        new Here("Randoop", 425).given(task, "200").checkEq(path, "/tasks/200/stories");
    ...
    public ItemRequest<Task> addComment(String task) {
        String path = String.format("/tasks/%s/stories", task);
        new Here("Randoop", 441).given(task, "Forbidden").checkEq(path, "/tasks/Forbidden/stories");
    ...
    public ItemRequest<Task> insertInUserTaskList(String userTaskList) {
        ...
        new Here("Randoop", 459).given(userTaskList, "Forbidden").checkEq(path, "/user_task_lists/Forbidden/tasks/insert");
        new Here("Randoop", 459).given(userTaskList, "hi!").checkEq(path, "/user_task_lists/hi!/tasks/insert");
        return new ItemRequest<Task>(this, Task.class, path, "POST");
    }
}
