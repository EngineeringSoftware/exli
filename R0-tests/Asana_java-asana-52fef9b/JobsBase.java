...
public class JobsBase extends Resource {
    ...
    public ItemRequest<Job> getJob(String jobGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 31).given(jobGid, "").checkEq(path, "/jobs/");
        new Here("Randoop", 31).given(jobGid, "com.asana.errors.InvalidRequestError: Invalid Request").checkEq(path, "/jobs/com.asana.errors.InvalidRequestError: Invalid Request");
        new Here("Randoop", 31).given(jobGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/jobs/urn:ietf:wg:oauth:2.0:oob");
        new Here("Randoop", 31).given(jobGid, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/jobs/com.asana.errors.RetryableAsanaError: Not Found");
