...
public class StatusUpdatesBase extends Resource {
    ...
    public ItemRequest<JsonElement> deleteStatus(String statusGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 56).given(statusGid, "com.asana.errors.InvalidRequestError: Invalid Request").checkEq(path, "/status_updates/com.asana.errors.InvalidRequestError: Invalid Request");
        new Here("Randoop", 56).given(statusGid, "hi!").checkEq(path, "/status_updates/hi!");
        new Here("Randoop", 56).given(statusGid, "DELETE").checkEq(path, "/status_updates/DELETE");
        new Here("Randoop", 56).given(statusGid, "Not Found").checkEq(path, "/status_updates/Not Found");
    ...
    public ItemRequest<JsonElement> getStatus(String statusGid, List<String> optFields, Boolean optPretty) throws IOException {
        String path = "/status_updates/{status_gid}".replace("{status_gid}", statusGid);
        new Here("Randoop", 78).given(statusGid, "com.asana.errors.InvalidRequestError: Invalid Request").checkEq(path, "/status_updates/com.asana.errors.InvalidRequestError: Invalid Request");
        new Here("Randoop", 78).given(statusGid, "").checkEq(path, "/status_updates/");
