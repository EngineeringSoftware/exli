...
public class PortfolioMembershipsBase extends Resource {
    ...
    public ItemRequest<PortfolioMembership> getPortfolioMembership(String portfolioMembershipGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 31).given(portfolioMembershipGid, "/tasks/Not Found/removeProject").checkEq(path, "/portfolio_memberships//tasks/Not Found/removeProject");
        new Here("Randoop", 31).given(portfolioMembershipGid, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/portfolio_memberships/com.asana.errors.RetryableAsanaError: Not Found");
        new Here("Randoop", 31).given(portfolioMembershipGid, "").checkEq(path, "/portfolio_memberships/");
        new Here("Randoop", 31).given(portfolioMembershipGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error").checkEq(path, "/portfolio_memberships/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error");
    ...
    public CollectionRequest<PortfolioMembership> getPortfolioMembershipsForPortfolio(String portfolioGid, String user, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 87).given(portfolioGid, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/portfolios/com.asana.errors.RetryableAsanaError: Not Found/portfolio_memberships");
        new Here("Randoop", 87).given(portfolioGid, "/tasks/Not Found/removeProject").checkEq(path, "/portfolios//tasks/Not Found/removeProject/portfolio_memberships");
        new Here("Randoop", 87).given(portfolioGid, "DELETE").checkEq(path, "/portfolios/DELETE/portfolio_memberships");
        new Here("Randoop", 87).given(portfolioGid, "com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced").checkEq(path, "/portfolios/com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced/portfolio_memberships");
