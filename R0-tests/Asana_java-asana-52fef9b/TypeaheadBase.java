...
public class TypeaheadBase extends Resource {
    ...
    public CollectionRequest<JsonElement> typeaheadForWorkspace(String workspaceGid, Integer count, String query, String type, String resourceType, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 35).given(workspaceGid, "").checkEq(path, "/workspaces//typeahead");
        new Here("Randoop", 35).given(workspaceGid, "/tasks/Not Found/removeProject").checkEq(path, "/workspaces//tasks/Not Found/removeProject/typeahead");
        new Here("Randoop", 35).given(workspaceGid, "404").checkEq(path, "/workspaces/404/typeahead");
        new Here("Randoop", 35).given(workspaceGid, "hi!").checkEq(path, "/workspaces/hi!/typeahead");
