...
public class Workspaces extends WorkspacesBase {
    ...
    public CollectionRequest<Task> taskTypeahead(String workspace) {
        ...
        new Here("Randoop", 15).given(workspace, "com.asana.errors.InvalidRequestError: Invalid Request").checkEq(path, "/workspaces/com.asana.errors.InvalidRequestError: Invalid Request/typeahead");
        new Here("Randoop", 15).given(workspace, "POST").checkEq(path, "/workspaces/POST/typeahead");
        new Here("Randoop", 15).given(workspace, "").checkEq(path, "/workspaces//typeahead");
    ...
    public CollectionRequest<User> userTypeahead(String workspace) {
        String path = String.format("/workspaces/%s/typeahead", workspace);
        new Here("Randoop", 21).given(workspace, "Rate Limit Enforced").checkEq(path, "/workspaces/Rate Limit Enforced/typeahead");
    ...
    public CollectionRequest<Project> projectTypeahead(String workspace) {
        String path = String.format("/workspaces/%s/typeahead", workspace);
        new Here("Randoop", 27).given(workspace, "POST").checkEq(path, "/workspaces/POST/typeahead");
        new Here("Randoop", 27).given(workspace, "Server Error").checkEq(path, "/workspaces/Server Error/typeahead");
        new Here("Randoop", 27).given(workspace, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request").checkEq(path, "/workspaces/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request/typeahead");
        new Here("Randoop", 27).given(workspace, "hi!").checkEq(path, "/workspaces/hi!/typeahead");
        ...
        new Here("Randoop", 27).given(workspace, "200").checkEq(path, "/workspaces/200/typeahead");
    ...
    public CollectionRequest<Tag> tagTypeahead(String workspace) {
        ...
        new Here("Randoop", 33).given(workspace, "hi!").checkEq(path, "/workspaces/hi!/typeahead");
    ...
    public ItemRequest<Workspace> findById(String workspace) {
        ...
        new Here("Randoop", 46).given(workspace, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/workspaces/com.asana.errors.RetryableAsanaError: Not Found");
        new Here("Unit", 46).given(workspace, "1").checkEq(path, "/workspaces/1");
        new Here("Randoop", 46).given(workspace, "com.asana.errors.InvalidRequestError: Invalid Request").checkEq(path, "/workspaces/com.asana.errors.InvalidRequestError: Invalid Request");
    ...
    public ItemRequest<Workspace> update(String workspace) {
        String path = String.format("/workspaces/%s", workspace);
        new Here("Randoop", 74).given(workspace, "").checkEq(path, "/workspaces/");
        new Here("Randoop", 74).given(workspace, "hi!").checkEq(path, "/workspaces/hi!");
        new Here("Randoop", 74).given(workspace, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error").checkEq(path, "/workspaces/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error");
        new Here("Randoop", 74).given(workspace, "Invalid Request").checkEq(path, "/workspaces/Invalid Request");
    ...
    public CollectionRequest<ResourceWithSubtype> typeahead(String workspace) {
        ...
        new Here("Randoop", 90).given(workspace, "404").checkEq(path, "/workspaces/404/typeahead");
        new Here("Randoop", 90).given(workspace, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/workspaces/com.asana.errors.RetryableAsanaError: Not Found/typeahead");
    ...
    public ItemRequest<Workspace> addUser(String workspace) {
        ...
        new Here("Randoop", 103).given(workspace, "NoAuthorizationError").checkEq(path, "/workspaces/NoAuthorizationError/addUser");
    ...
    public ItemRequest<Workspace> removeUser(String workspace) {
        ...
        new Here("Randoop", 116).given(workspace, "com.asana.errors.InvalidRequestError: Invalid Request").checkEq(path, "/workspaces/com.asana.errors.InvalidRequestError: Invalid Request/removeUser");
        new Here("Randoop", 116).given(workspace, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error").checkEq(path, "/workspaces/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Server%20Error/removeUser");
        new Here("Randoop", 116).given(workspace, "").checkEq(path, "/workspaces//removeUser");
        return new ItemRequest<Workspace>(this, Workspace.class, path, "POST");
    }
}
