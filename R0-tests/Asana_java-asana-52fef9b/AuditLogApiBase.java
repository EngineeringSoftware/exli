...
public class AuditLogApiBase extends Resource {
    ...
    public CollectionRequest<JsonElement> getAuditLogEvents(String workspaceGid, String resourceGid, String actorGid, String actorType, String eventType, OffsetDateTime endAt, OffsetDateTime startAt, String offset, Integer limit) throws IOException {
        ...
        new Here("Randoop", 37).given(workspaceGid, "com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced").checkEq(path, "/workspaces/com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced/audit_log_events");
        new Here("Randoop", 37).given(workspaceGid, "POST").checkEq(path, "/workspaces/POST/audit_log_events");
