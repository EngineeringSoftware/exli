...
public class WebhooksBase extends Resource {
    ...
    public ItemRequest<JsonElement> deleteWebhook(String webhookGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 52).given(webhookGid, "Sync token invalid or too old").checkEq(path, "/webhooks/Sync token invalid or too old");
        new Here("Randoop", 52).given(webhookGid, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/webhooks/com.asana.errors.RetryableAsanaError: Not Found");
        new Here("Randoop", 52).given(webhookGid, "POST").checkEq(path, "/webhooks/POST");
        new Here("Randoop", 52).given(webhookGid, "").checkEq(path, "/webhooks/");
        new Here("Randoop", 52).given(webhookGid, "/tasks/Not Found/removeProject").checkEq(path, "/webhooks//tasks/Not Found/removeProject");
    ...
    public ItemRequest<Webhook> getWebhook(String webhookGid, List<String> optFields, Boolean optPretty) throws IOException {
        String path = "/webhooks/{webhook_gid}".replace("{webhook_gid}", webhookGid);
        new Here("Randoop", 74).given(webhookGid, "").checkEq(path, "/webhooks/");
        new Here("Randoop", 74).given(webhookGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/webhooks/urn:ietf:wg:oauth:2.0:oob");
        new Here("Randoop", 74).given(webhookGid, "DELETE").checkEq(path, "/webhooks/DELETE");
    ...
    public ItemRequest<Webhook> updateWebhook(String webhookGid, List<String> optFields, Boolean optPretty) throws IOException {
        String path = "/webhooks/{webhook_gid}".replace("{webhook_gid}", webhookGid);
        new Here("Randoop", 125).given(webhookGid, "Not Found").checkEq(path, "/webhooks/Not Found");
        new Here("Randoop", 125).given(webhookGid, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/webhooks/com.asana.errors.RetryableAsanaError: Not Found");
        new Here("Randoop", 125).given(webhookGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request").checkEq(path, "/webhooks/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request");
        new Here("Randoop", 125).given(webhookGid, "").checkEq(path, "/webhooks/");
        new Here("Randoop", 125).given(webhookGid, "404").checkEq(path, "/webhooks/404");
        new Here("Randoop", 125).given(webhookGid, "NoAuthorizationError").checkEq(path, "/webhooks/NoAuthorizationError");
