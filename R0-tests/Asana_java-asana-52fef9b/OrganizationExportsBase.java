...
public class OrganizationExportsBase extends Resource {
    ...
    public ItemRequest<OrganizationExport> getOrganizationExport(String organizationExportGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 56).given(organizationExportGid, "").checkEq(path, "/organization_exports/");
        new Here("Randoop", 56).given(organizationExportGid, "200").checkEq(path, "/organization_exports/200");
        new Here("Randoop", 56).given(organizationExportGid, "NoAuthorizationError").checkEq(path, "/organization_exports/NoAuthorizationError");
        new Here("Randoop", 56).given(organizationExportGid, "com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced").checkEq(path, "/organization_exports/com.asana.errors.RateLimitEnforcedError: Rate Limit Enforced");
