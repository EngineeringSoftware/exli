...
public class TeamMembershipsBase extends Resource {
    ...
    public ItemRequest<JsonElement> getTeamMembership(String teamMembershipGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 31).given(teamMembershipGid, "POST").checkEq(path, "/team_memberships/POST");
        new Here("Randoop", 31).given(teamMembershipGid, "com.asana.errors.RetryableAsanaError: Not Found").checkEq(path, "/team_memberships/com.asana.errors.RetryableAsanaError: Not Found");
        new Here("Randoop", 31).given(teamMembershipGid, "urn:ietf:wg:oauth:2.0:oob").checkEq(path, "/team_memberships/urn:ietf:wg:oauth:2.0:oob");
    ...
    public CollectionRequest<JsonElement> getTeamMembershipsForTeam(String teamGid, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 86).given(teamGid, "Invalid Request").checkEq(path, "/teams/Invalid Request/team_memberships");
        new Here("Randoop", 86).given(teamGid, "https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request").checkEq(path, "/teams/https://app.asana.com/-/oauth_authorize?client_id&redirect_uri=hi!&response_type=code&state=Invalid%20Request/team_memberships");
    ...
    public CollectionRequest<JsonElement> getTeamMembershipsForUser(String userGid, String workspace, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        new Here("Randoop", 113).given(userGid, "Sync token invalid or too old").checkEq(path, "/users/Sync token invalid or too old/team_memberships");
