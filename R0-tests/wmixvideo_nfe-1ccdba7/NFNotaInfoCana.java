...
public class NFNotaInfoCana extends DFBase {
    ...
    public void setSafra(final String safra) {
        ...
        if (!matcher.find()) {
            new Here("Randoop", 50).given(matcher, "514.xml").checkTrue(group());
            new Here("Unit", 50).given(matcher, "112.xml").checkFalse(group());
            new Here("Unit", 50).given(matcher, "113.xml").checkTrue(group());
            new Here("Unit", 50).given(matcher, "23.xml").checkFalse(group());
