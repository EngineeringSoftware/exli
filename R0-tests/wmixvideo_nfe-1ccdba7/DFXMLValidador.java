...
public final class DFXMLValidador {
    ...
    private static boolean valida(final String xml, final String xsd) throws IOException, SAXException, URISyntaxException {
        ...
        new Here("Randoop", 15).given(xsd, "nfe_v3.10.xsd").checkEq(xsdPath, "263.xml");
        new Here("Randoop", 15).given(xsd, "enviNFe_v3.10.xsd").checkEq(xsdPath, "346.xml");
    ...
    public static boolean valida400(final String xml, final String xsd) throws IOException, SAXException, URISyntaxException {
        final URL xsdPath = DFXMLValidador.class.getClassLoader().getResource(String.format("schemas/PL_009i_NT2021_004_v100a/%s", xsd));
        new Here("Randoop", 31).given(xsd, "nfe_v4.00.xsd").checkEq(xsdPath, "379.xml");
        new Here("Randoop", 31).given(xsd, "enviNFe_v4.00.xsd").checkEq(xsdPath, "583.xml");
        final SchemaFactory schemaFactory = SchemaFactory.newInstance("http://www.w3.org/2001/XMLSchema");
        final Schema schema = schemaFactory.newSchema(new StreamSource(xsdPath.toURI().toString()));
        schema.newValidator().validate(new StreamSource(new StringReader(xml)));
        return true;
    ...
    private static boolean validaMDF(final String xml, final String xsd) throws IOException, SAXException, URISyntaxException {
        ...
        new Here("Randoop", 61).given(xsd, "enviMDFe_v3.00.xsd").checkEq(xsdPath, "347.xml");
        new Here("Randoop", 61).given(xsd, "procMDFe_v3.00.xsd").checkEq(xsdPath, "17.xml");
        new Here("Unit", 61).given(xsd, "procMDFe_v3.00.xsd").checkEq(xsdPath, "17.xml");
        new Here("Randoop", 61).given(xsd, "eventoMDFe_v3.00.xsd").checkEq(xsdPath, "269.xml");
        new Here("Randoop", 61).given(xsd, "evPagtoOperMDFe_v3.00.xsd").checkEq(xsdPath, "329.xml");
        final SchemaFactory schemaFactory = SchemaFactory.newInstance("http://www.w3.org/2001/XMLSchema");
        final Schema schema = schemaFactory.newSchema(new StreamSource(xsdPath.toURI().toString()));
        schema.newValidator().validate(new StreamSource(new StringReader(xml)));
        return true;
    ...
    private static boolean validaCTe(final String xml, final String xsd) throws IOException, SAXException, URISyntaxException {
        ...
        new Here("Randoop", 89).given(xsd, "cte_v3.00.xsd").checkEq(xsdPath, "411.xml");
        new Here("Randoop", 89).given(xsd, "enviCTe_v3.00.xsd").checkEq(xsdPath, "340.xml");
        final SchemaFactory schemaFactory = SchemaFactory.newInstance("http://www.w3.org/2001/XMLSchema");
        final Schema schema = schemaFactory.newSchema(new StreamSource(xsdPath.toURI().toString()));
        schema.newValidator().validate(new StreamSource(new StringReader(xml)));
        return true;
    ...
    private static boolean validaDfe(final String xml, final String xsd) throws IOException, SAXException, URISyntaxException {
        ...
        new Here("Randoop", 105).given(xsd, "distDFeInt_v1.01.xsd").checkEq(xsdPath, "255.xml");
        final SchemaFactory schemaFactory = SchemaFactory.newInstance("http://www.w3.org/2001/XMLSchema");
        final Schema schema = schemaFactory.newSchema(new StreamSource(xsdPath.toURI().toString()));
        schema.newValidator().validate(new StreamSource(new StringReader(xml)));
        return true;
    ...
    private static boolean validaDistribuicaoCTe(final String xml, final String xsd) throws IOException, SAXException, URISyntaxException {
        ...
        new Here("Randoop", 112).given(xsd, "distDFeInt_v1.00.xsd").checkEq(xsdPath, "235.xml");
        final SchemaFactory schemaFactory = SchemaFactory.newInstance("http://www.w3.org/2001/XMLSchema");
        final Schema schema = schemaFactory.newSchema(new StreamSource(xsdPath.toURI().toString()));
        schema.newValidator().validate(new StreamSource(new StringReader(xml)));
        return true;
    ...
    private static boolean validaEpec(final String xml, final String xsd) throws IOException, SAXException, URISyntaxException {
        ...
        new Here("Randoop", 127).given(xsd, "envEPEC_v1.00.xsd").checkEq(xsdPath, "648.xml");
        new Here("Randoop", 127).given(xsd, "EPEC_v1.00.xsd").checkEq(xsdPath, "256.xml");
        final SchemaFactory schemaFactory = SchemaFactory.newInstance("http://www.w3.org/2001/XMLSchema");
        final Schema schema = schemaFactory.newSchema(new StreamSource(xsdPath.toURI().toString()));
        schema.newValidator().validate(new StreamSource(new StringReader(xml)));
        return true;
