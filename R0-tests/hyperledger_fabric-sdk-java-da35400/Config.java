...
public class Config {
    ...
    public static Map<Integer, String> parseSecurityCurveMappings(final String property) {
        ...
        if (property != null && !property.isEmpty()) {
            ...
            new Here("Randoop", 365).given(property, "256=secp256r1:384=secp384r1").checkEq(cmaps, new String[] { "256=secp256r1", "384=secp384r1" });
            new Here("Randoop", 365).given(property, "org.hyperledger.fabric.sdk.crypto.default_signature_algorithm").checkEq(cmaps, new String[] { "org.hyperledger.fabric.sdk.crypto.default_signature_algorithm" });
            new Here("Randoop", 365).given(property, "GetBlockByHash").checkEq(cmaps, new String[] { "GetBlockByHash" });
            new Here("Unit", 365).given(property, "256=secp256r1:384=secp384r1").checkEq(cmaps, new String[] { "256=secp256r1", "384=secp384r1" });
            for (String mape : cmaps) {
                String[] ep = mape.split("[ \t]*=[ \t]*");
                new Here("Randoop", 368).given(mape, "384=secp384r1").checkEq(ep, new String[] { "384", "secp384r1" });
                new Here("Randoop", 368).given(mape, "org.hyperledger.fabric.sdk.crypto.default_signature_algorithm").checkEq(ep, new String[] { "org.hyperledger.fabric.sdk.crypto.default_signature_algorithm" });
                new Here("Randoop", 368).given(mape, "GetBlockByHash").checkEq(ep, new String[] { "GetBlockByHash" });
                new Here("Unit", 368).given(mape, "256=secp256r1").checkEq(ep, new String[] { "256", "secp256r1" });
                new Here("Randoop", 368).given(mape, "256=secp256r1").checkEq(ep, new String[] { "256", "secp256r1" });
                new Here("Unit", 368).given(mape, "384=secp384r1").checkEq(ep, new String[] { "384", "secp384r1" });
                if (ep.length != 2) {
