...
public class TLSCertificateBuilder {
    ...
    private X509Certificate createSelfSignedCertificate(CertType certType, KeyPair keyPair, String san) throws Exception {
        ...
        new Here("Unit", 113).given(KeyUsage.keyEncipherment, 32).given(KeyUsage.digitalSignature, 128).checkEq(usage, "46.xml");
        new Here("Randoop", 113).given(KeyUsage.keyEncipherment, 32).given(KeyUsage.digitalSignature, 128).checkEq(usage, "46.xml");
