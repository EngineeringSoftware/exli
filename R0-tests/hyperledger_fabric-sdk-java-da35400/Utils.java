...
public final class Utils {
    ...
    public static Properties parseGrpcUrl(String url) {
        ...
        if (m.matches()) {
            new Here("Unit", 310).given(m, "69.xml").checkTrue(group());
            new Here("Randoop", 310).given(m, "84.xml").checkFalse(group());
            new Here("Unit", 310).given(m, "79.xml").checkFalse(group());
            new Here("Unit", 310).given(m, "15.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "11.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "18.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "77.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "40.xml").checkTrue(group());
            new Here("Randoop", 310).given(m, "80.xml").checkFalse(group());
            new Here("Unit", 310).given(m, "8.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "6.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "2.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "32.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "14.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "10.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "21.xml").checkTrue(group());
            new Here("Randoop", 310).given(m, "83.xml").checkFalse(group());
            new Here("Unit", 310).given(m, "65.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "66.xml").checkFalse(group());
            new Here("Unit", 310).given(m, "76.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "9.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "5.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "1.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "42.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "7.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "31.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "78.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "20.xml").checkTrue(group());
            new Here("Randoop", 310).given(m, "82.xml").checkFalse(group());
            new Here("Unit", 310).given(m, "13.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "16.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "68.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "4.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "0.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "19.xml").checkFalse(group());
            new Here("Unit", 310).given(m, "12.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "41.xml").checkTrue(group());
            new Here("Randoop", 310).given(m, "81.xml").checkFalse(group());
            new Here("Unit", 310).given(m, "39.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "30.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "17.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "3.xml").checkTrue(group());
            new Here("Unit", 310).given(m, "64.xml").checkFalse(group());
            new Here("Unit", 310).given(m, "63.xml").checkTrue(group());
