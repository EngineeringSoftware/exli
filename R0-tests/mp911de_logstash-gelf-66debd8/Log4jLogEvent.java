    ...
    private Set<String> getMatchingMdcNames(DynamicMdcMessageField field, Set<String> mdcNames) {
        ...
        for (String mdcName : mdcNames) {
            if (field.getPattern().matcher(mdcName).matches()) {
                new Here("Unit", 226).given(mdcName, "someOtherField").given(field, "14.xml").checkFalse(group());
                new Here("Unit", 226).given(mdcName, "myMdc").given(field, "7.xml").checkTrue(group());
                new Here("Unit", 226).given(mdcName, "someField").given(field, "7.xml").checkFalse(group());
                new Here("Unit", 226).given(mdcName, "someOtherField").given(field, "7.xml").checkFalse(group());
                new Here("Unit", 226).given(mdcName, "myMdc").given(field, "14.xml").checkFalse(group());
                new Here("Unit", 226).given(mdcName, "myMdc-with-suffix1").given(field, "14.xml").checkFalse(group());
                new Here("Unit", 226).given(mdcName, "myMdc.longValue1").given(field, "7.xml").checkTrue(group());
                new Here("Unit", 226).given(mdcName, "myMdc-with-suffix1").given(field, "7.xml").checkTrue(group());
                new Here("Unit", 226).given(mdcName, "myMdc.doubleValue1").given(field, "7.xml").checkTrue(group());
                new Here("Unit", 226).given(mdcName, "myMdc.stringValue").given(field, "7.xml").checkTrue(group());
                new Here("Unit", 226).given(mdcName, "myMdc.undefinedValue").given(field, "7.xml").checkTrue(group());
                new Here("Unit", 226).given(mdcName, "myMdc-with-suffix2").given(field, "7.xml").checkTrue(group());
                new Here("Unit", 226).given(mdcName, "myMdc.longValue2").given(field, "7.xml").checkTrue(group());
                new Here("Unit", 226).given(mdcName, "myMdc-with-suffix2").given(field, "14.xml").checkFalse(group());
                new Here("Unit", 226).given(mdcName, "someField").given(field, "14.xml").checkTrue(group());
                new Here("Unit", 226).given(mdcName, "myMdc.doubleValue2").given(field, "7.xml").checkTrue(group());
