...
public class GelfMessage {
    ...
    private String getMatchingDynamicMdcFieldType(String fieldName) {
        ...
        for (Map.Entry<Pattern, String> entry : dynamicMdcFieldTypes.entrySet()) {
            if (entry.getKey().matcher(fieldName).matches()) {
                new Here("Unit", 466).given(entry, "11.xml").given(fieldName, "SourceSimpleClassName").checkFalse(group());
                new Here("Unit", 466).given(entry, "9.xml").given(fieldName, "SourceMethodName").checkFalse(group());
                new Here("Unit", 466).given(entry, "11.xml").given(fieldName, "SourceLineNumber").checkFalse(group());
                new Here("Unit", 466).given(entry, "11.xml").given(fieldName, "MySeverity").checkFalse(group());
                new Here("Unit", 466).given(entry, "21.xml").given(fieldName, "Server").checkFalse(group());
                new Here("Unit", 466).given(entry, "13.xml").given(fieldName, "fieldName1").checkFalse(group());
                new Here("Unit", 466).given(entry, "10.xml").given(fieldName, "MySeverity").checkFalse(group());
                new Here("Unit", 466).given(entry, "12.xml").given(fieldName, "Thread").checkFalse(group());
                new Here("Unit", 466).given(entry, "11.xml").given(fieldName, "SourceClassName").checkFalse(group());
                new Here("Unit", 466).given(entry, "21.xml").given(fieldName, "SourceMethodName").checkFalse(group());
                new Here("Unit", 466).given(entry, "10.xml").given(fieldName, "SourceMethodName").checkFalse(group());
                new Here("Unit", 466).given(entry, "12.xml").given(fieldName, "fieldName1").checkFalse(group());
                new Here("Unit", 466).given(entry, "10.xml").given(fieldName, "myMdc.undefinedValue").checkFalse(group());
                new Here("Unit", 466).given(entry, "20.xml").given(fieldName, "fieldName2").checkFalse(group());
                new Here("Unit", 466).given(entry, "13.xml").given(fieldName, "LoggerName").checkFalse(group());
                new Here("Unit", 466).given(entry, "8.xml").given(fieldName, "myMdc.longValue1").checkTrue(group());
                new Here("Unit", 466).given(entry, "10.xml").given(fieldName, "SourceClassName").checkFalse(group());
                new Here("Unit", 466).given(entry, "10.xml").given(fieldName, "MyTime").checkFalse(group());
                new Here("Unit", 466).given(entry, "9.xml").given(fieldName, "myMdc.doubleValue1").checkTrue(group());
                new Here("Unit", 466).given(entry, "13.xml").given(fieldName, "MyTime").checkFalse(group());
                new Here("Unit", 466).given(entry, "20.xml").given(fieldName, "LoggerName").checkFalse(group());
                new Here("Unit", 466).given(entry, "21.xml").given(fieldName, "myMdc.stringValue").checkFalse(group());
                new Here("Unit", 466).given(entry, "21.xml").given(fieldName, "MyTime").checkFalse(group());
                new Here("Unit", 466).given(entry, "10.xml").given(fieldName, "SourceSimpleClassName").checkFalse(group());
                new Here("Unit", 466).given(entry, "10.xml").given(fieldName, "fieldName1").checkFalse(group());
                new Here("Unit", 466).given(entry, "10.xml").given(fieldName, "myMdc.stringValue").checkTrue(group());
                new Here("Unit", 466).given(entry, "12.xml").given(fieldName, "MySeverity").checkFalse(group());
                new Here("Unit", 466).given(entry, "10.xml").given(fieldName, "SourceLineNumber").checkFalse(group());
                new Here("Unit", 466).given(entry, "12.xml").given(fieldName, "SourceLineNumber").checkFalse(group());
                new Here("Unit", 466).given(entry, "10.xml").given(fieldName, "LoggerName").checkFalse(group());
                new Here("Unit", 466).given(entry, "9.xml").given(fieldName, "SourceLineNumber").checkFalse(group());
                new Here("Unit", 466).given(entry, "20.xml").given(fieldName, "myMdc.undefinedValue").checkFalse(group());
                new Here("Unit", 466).given(entry, "22.xml").given(fieldName, "SourceMethodName").checkFalse(group());
                new Here("Unit", 466).given(entry, "10.xml").given(fieldName, "fieldName2").checkFalse(group());
                new Here("Unit", 466).given(entry, "12.xml").given(fieldName, "SourceSimpleClassName").checkFalse(group());
                new Here("Unit", 466).given(entry, "20.xml").given(fieldName, "Server").checkFalse(group());
                new Here("Unit", 466).given(entry, "8.xml").given(fieldName, "myMdc.doubleValue1").checkFalse(group());
                new Here("Unit", 466).given(entry, "20.xml").given(fieldName, "SourceMethodName").checkFalse(group());
                new Here("Unit", 466).given(entry, "8.xml").given(fieldName, "myMdc.undefinedValue").checkFalse(group());
                new Here("Unit", 466).given(entry, "9.xml").given(fieldName, "MyTime").checkFalse(group());
                new Here("Unit", 466).given(entry, "13.xml").given(fieldName, "MySeverity").checkFalse(group());
                new Here("Unit", 466).given(entry, "9.xml").given(fieldName, "myMdc.undefinedValue").checkFalse(group());
                new Here("Unit", 466).given(entry, "20.xml").given(fieldName, "myMdc.stringValue").checkFalse(group());
                new Here("Unit", 466).given(entry, "9.xml").given(fieldName, "myMdc.stringValue").checkFalse(group());
                new Here("Unit", 466).given(entry, "21.xml").given(fieldName, "myMdc.doubleValue1").checkTrue(group());
                new Here("Unit", 466).given(entry, "22.xml").given(fieldName, "myMdc.stringValue").checkTrue(group());
                new Here("Unit", 466).given(entry, "22.xml").given(fieldName, "MySeverity").checkFalse(group());
                new Here("Unit", 466).given(entry, "21.xml").given(fieldName, "myMdc.undefinedValue").checkFalse(group());
                new Here("Unit", 466).given(entry, "13.xml").given(fieldName, "SourceLineNumber").checkFalse(group());
                new Here("Unit", 466).given(entry, "20.xml").given(fieldName, "MyTime").checkFalse(group());
                new Here("Unit", 466).given(entry, "10.xml").given(fieldName, "Thread").checkFalse(group());
                new Here("Unit", 466).given(entry, "8.xml").given(fieldName, "Thread").checkFalse(group());
                new Here("Unit", 466).given(entry, "8.xml").given(fieldName, "SourceLineNumber").checkFalse(group());
                new Here("Unit", 466).given(entry, "9.xml").given(fieldName, "fieldName1").checkFalse(group());
                new Here("Unit", 466).given(entry, "21.xml").given(fieldName, "MySeverity").checkFalse(group());
                new Here("Unit", 466).given(entry, "12.xml").given(fieldName, "SourceMethodName").checkFalse(group());
                new Here("Unit", 466).given(entry, "20.xml").given(fieldName, "MySeverity").checkFalse(group());
                new Here("Unit", 466).given(entry, "9.xml").given(fieldName, "myMdc.doubleValue2").checkTrue(group());
                new Here("Unit", 466).given(entry, "8.xml").given(fieldName, "fieldName1").checkFalse(group());
                new Here("Unit", 466).given(entry, "11.xml").given(fieldName, "MyTime").checkFalse(group());
                new Here("Unit", 466).given(entry, "13.xml").given(fieldName, "SourceSimpleClassName").checkFalse(group());
                new Here("Unit", 466).given(entry, "9.xml").given(fieldName, "SourceClassName").checkFalse(group());
                new Here("Unit", 466).given(entry, "22.xml").given(fieldName, "fieldName1").checkFalse(group());
                new Here("Unit", 466).given(entry, "22.xml").given(fieldName, "Server").checkFalse(group());
                new Here("Unit", 466).given(entry, "9.xml").given(fieldName, "MySeverity").checkFalse(group());
                new Here("Unit", 466).given(entry, "12.xml").given(fieldName, "MyTime").checkFalse(group());
                new Here("Unit", 466).given(entry, "8.xml").given(fieldName, "myMdc.stringValue").checkFalse(group());
                new Here("Unit", 466).given(entry, "13.xml").given(fieldName, "SourceClassName").checkFalse(group());
                new Here("Unit", 466).given(entry, "8.xml").given(fieldName, "myMdc.longValue2").checkTrue(group());
                new Here("Unit", 466).given(entry, "20.xml").given(fieldName, "myMdc.doubleValue1").checkFalse(group());
                new Here("Unit", 466).given(entry, "9.xml").given(fieldName, "SourceSimpleClassName").checkFalse(group());
                new Here("Unit", 466).given(entry, "8.xml").given(fieldName, "myMdc.doubleValue2").checkFalse(group());
                new Here("Unit", 466).given(entry, "8.xml").given(fieldName, "fieldName2").checkFalse(group());
                new Here("Unit", 466).given(entry, "8.xml").given(fieldName, "SourceMethodName").checkFalse(group());
                new Here("Unit", 466).given(entry, "21.xml").given(fieldName, "LoggerName").checkFalse(group());
                new Here("Unit", 466).given(entry, "12.xml").given(fieldName, "SourceClassName").checkFalse(group());
                new Here("Unit", 466).given(entry, "22.xml").given(fieldName, "fieldName2").checkFalse(group());
                new Here("Unit", 466).given(entry, "20.xml").given(fieldName, "fieldName1").checkFalse(group());
                new Here("Unit", 466).given(entry, "22.xml").given(fieldName, "myMdc.undefinedValue").checkFalse(group());
                new Here("Unit", 466).given(entry, "11.xml").given(fieldName, "fieldName2").checkFalse(group());
                new Here("Unit", 466).given(entry, "9.xml").given(fieldName, "Thread").checkFalse(group());
                new Here("Unit", 466).given(entry, "13.xml").given(fieldName, "fieldName2").checkFalse(group());
                new Here("Unit", 466).given(entry, "8.xml").given(fieldName, "LoggerName").checkFalse(group());
                new Here("Unit", 466).given(entry, "13.xml").given(fieldName, "SourceMethodName").checkFalse(group());
                new Here("Unit", 466).given(entry, "11.xml").given(fieldName, "SourceMethodName").checkFalse(group());
                new Here("Unit", 466).given(entry, "21.xml").given(fieldName, "fieldName2").checkFalse(group());
                new Here("Unit", 466).given(entry, "11.xml").given(fieldName, "Thread").checkFalse(group());
                new Here("Unit", 466).given(entry, "22.xml").given(fieldName, "LoggerName").checkFalse(group());
                new Here("Unit", 466).given(entry, "13.xml").given(fieldName, "Thread").checkFalse(group());
                new Here("Unit", 466).given(entry, "11.xml").given(fieldName, "LoggerName").checkFalse(group());
                new Here("Unit", 466).given(entry, "9.xml").given(fieldName, "LoggerName").checkFalse(group());
                new Here("Unit", 466).given(entry, "11.xml").given(fieldName, "fieldName1").checkFalse(group());
                new Here("Unit", 466).given(entry, "8.xml").given(fieldName, "SourceSimpleClassName").checkFalse(group());
                new Here("Unit", 466).given(entry, "12.xml").given(fieldName, "LoggerName").checkFalse(group());
                new Here("Unit", 466).given(entry, "9.xml").given(fieldName, "fieldName2").checkFalse(group());
                new Here("Unit", 466).given(entry, "21.xml").given(fieldName, "fieldName1").checkFalse(group());
                new Here("Unit", 466).given(entry, "8.xml").given(fieldName, "SourceClassName").checkFalse(group());
                new Here("Unit", 466).given(entry, "8.xml").given(fieldName, "MyTime").checkFalse(group());
                new Here("Unit", 466).given(entry, "8.xml").given(fieldName, "MySeverity").checkFalse(group());
                new Here("Unit", 466).given(entry, "11.xml").given(fieldName, "myMdc.longValue1").checkTrue(group());
                new Here("Unit", 466).given(entry, "12.xml").given(fieldName, "fieldName2").checkFalse(group());
    ...
    public int hashCode() {
        ...
        new Here("Unit", 655).given(result, -636112057).given(javaTimestamp, 42L).checkEq(result, 1755362755);
        new Here("Unit", 655).given(result, 1446740333).given(javaTimestamp, 0L).checkEq(result, 1899277363);
