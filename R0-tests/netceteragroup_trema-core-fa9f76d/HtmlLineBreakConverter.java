...
public class HtmlLineBreakConverter implements IExportFilter {
    ...
    public void filter(IKeyValuePair keyValuePair) {
        ...
        if (value != null) {
            ...
            new Here("Unit", 21).given(REPLACEMENT, "<br/>").given(value, "The quick brown fox jumps over the lazy dog.").checkEq(newValue, "The quick brown fox jumps over the lazy dog.");
            new Here("Unit", 21).given(REPLACEMENT, "<br/>").given(value, "The quick brown fox jumps\\r over the lazy dog.").checkEq(newValue, "The quick brown fox jumps\\r over the lazy dog.");
            ...
            new Here("Unit", 22).given(REPLACEMENT, "<br/>").given(newValue, "The quick brown fox jumps over the lazy dog.").checkEq(newValue, "The quick brown fox jumps over the lazy dog.");
            new Here("Unit", 22).given(REPLACEMENT, "<br/>").given(newValue, "The quick brown fox jumps<br/> over the lazy dog.").checkEq(newValue, "The quick brown fox jumps<br/> over the lazy dog.");
            new Here("Unit", 22).given(REPLACEMENT, "<br/>").given(newValue, "The quick brown fox jumps\\r over the lazy dog.").checkEq(newValue, "The quick brown fox jumps\\r over the lazy dog.");
            ...
            new Here("Unit", 23).given(REPLACEMENT, "<br/>").given(newValue, "The quick brown fox jumps over the lazy dog.").checkEq(newValue, "The quick brown fox jumps over the lazy dog.");
