                ...
                try {
                    if ((buffer[bufpos] = c = ReadByte()) != '\\') {
                        ...
                        if ((c == 'u') && ((backSlashCnt & 1) == 1)) {
                            new Here("Unit", 300).given(c, '1').given(backSlashCnt, 1).checkFalse(group());
                            new Here("Unit", 300).given(c, 'n').given(backSlashCnt, 1).checkFalse(group());
                            new Here("Unit", 300).given(c, 'u').given(backSlashCnt, 1).checkTrue(group());
                            new Here("Unit", 300).given(c, 'r').given(backSlashCnt, 1).checkFalse(group());
                            new Here("Unit", 300).given(c, 't').given(backSlashCnt, 1).checkFalse(group());
                            new Here("Unit", 300).given(c, 'n').given(backSlashCnt, 3).checkFalse(group());
                            new Here("Unit", 300).given(c, '4').given(backSlashCnt, 1).checkFalse(group());
                            new Here("Unit", 300).given(c, 'f').given(backSlashCnt, 1).checkFalse(group());
                            new Here("Unit", 300).given(c, '"').given(backSlashCnt, 1).checkFalse(group());
                            new Here("Unit", 300).given(c, 'b').given(backSlashCnt, 1).checkFalse(group());
                            new Here("Unit", 300).given(c, '3').given(backSlashCnt, 1).checkFalse(group());
                            new Here("Unit", 300).given(c, 'x').given(backSlashCnt, 1).checkFalse(group());
                            if (--bufpos < 0) {
                                bufpos = bufsize - 1;
                            }
                            break;
