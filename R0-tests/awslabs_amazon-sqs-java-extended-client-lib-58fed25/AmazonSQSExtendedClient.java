...
public class AmazonSQSExtendedClient extends AmazonSQSExtendedClientBase implements SqsClient {
    ...
    static final List<String> RESERVED_ATTRIBUTE_NAMES = Arrays.asList(LEGACY_RESERVED_ATTRIBUTE_NAME, SQSExtendedClientConstants.RESERVED_ATTRIBUTE_NAME);
    ...
    public ReceiveMessageResponse receiveMessage(ReceiveMessageRequest receiveMessageRequest) {
        ...
        for (Message message : messages) {
            ...
            if (largePayloadAttributeName.isPresent()) {
                ...
                new Here("Unit", 340).given(largeMessagePointer, "[\"software.amazon.payloadoffloading.PayloadS3Pointer\",{\"s3BucketName\":\"test-bucket-name\",\"s3Key\":\"S3Key\"}]").checkEq(largeMessagePointer, "[\"software.amazon.payloadoffloading.PayloadS3Pointer\",{\"s3BucketName\":\"test-bucket-name\",\"s3Key\":\"S3Key\"}]");
    ...
    public ChangeMessageVisibilityResponse changeMessageVisibility(ChangeMessageVisibilityRequest changeMessageVisibilityRequest) throws AwsServiceException, SdkClientException {
        ...
        if (isS3ReceiptHandle(changeMessageVisibilityRequest.receiptHandle())) {
            changeMessageVisibilityRequestBuilder.receiptHandle(getOrigReceiptHandle(changeMessageVisibilityRequest.receiptHandle()));
        }
    ...
    public ChangeMessageVisibilityBatchResponse changeMessageVisibilityBatch(ChangeMessageVisibilityBatchRequest changeMessageVisibilityBatchRequest) throws AwsServiceException, SdkClientException {
        ...
        return amazonSqsToBeExtended.changeMessageVisibilityBatch(changeMessageVisibilityBatchRequest.toBuilder().entries(entries).build());
    }
    ...
    private void checkMessageAttributes(Map<String, MessageAttributeValue> messageAttributes) {
        ...
        if (msgAttributesSize > clientConfiguration.getPayloadSizeThreshold()) {
            String errorMessage = "Total size of Message attributes is " + msgAttributesSize + " bytes which is larger than the threshold of " + clientConfiguration.getPayloadSizeThreshold() + " Bytes. Consider including the payload in the message body instead of message attributes.";
            LOG.error(errorMessage);
            throw SdkClientException.create(errorMessage);
        }
        int messageAttributesNum = messageAttributes.size();
        if (messageAttributesNum > SQSExtendedClientConstants.MAX_ALLOWED_ATTRIBUTES) {
            String errorMessage = "Number of message attributes [" + messageAttributesNum + "] exceeds the maximum allowed for large-payload messages [" + SQSExtendedClientConstants.MAX_ALLOWED_ATTRIBUTES + "].";
            LOG.error(errorMessage);
            throw SdkClientException.create(errorMessage);
        }
    ...
    private String embedS3PointerInReceiptHandle(String receiptHandle, String pointer) {
        ...
        String modifiedReceiptHandle = SQSExtendedClientConstants.S3_BUCKET_NAME_MARKER + s3MsgBucketName + SQSExtendedClientConstants.S3_BUCKET_NAME_MARKER + SQSExtendedClientConstants.S3_KEY_MARKER + s3MsgKey + SQSExtendedClientConstants.S3_KEY_MARKER + receiptHandle;
    ...
    private String getOrigReceiptHandle(String receiptHandle) {
        ...
        new Here("Unit", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-b1132737-5127-4e1a-9ff9-a3cf01cdf4a7-..s3Key..-7c0ab5a0-3d2c-41b8-8110-079d6032f67f").checkEq(secondOccurence, 99);
        new Here("Unit", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..
 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-fc4d9e89-01c5-47b8-a552-3e5235236338-..s3Key..-8587fbf9-a37c-4f8c-aadf-96ba012d5fa7").checkEq(secondOccurence, 99);
    ...
    private String getFromReceiptHandleByMarker(String receiptHandle, String marker) {
        ...
        new Here("Unit", 890).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-fc4d9e89-01c5-47b8-a552-3e5235236338-..s3Key..-8587fbf9-a37c-4f8c-aadf-96ba012d5fa7").checkEq(firstOccurence, 0);
        new Here("Unit", 890).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-f02011ad-d70b-46f4-baaf-4276a5601758-..s3Key..-573b2cd4-46ea-4a7a-b401-928c532aca2a").checkEq(firstOccurence, 52);
        new Here("Unit", 890).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-5e168132-6f65-476f-bd6e-8cfb9cd7c66b-..s3Key..-00a72af1-2e0a-4159-9304-0bae28eb80a2").checkEq(firstOccurence, 0);
        new Here("Unit", 890).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-9de2dc06-b61f-4141-8c9b-f5f77459d618-..s3Key..-86fff0ec-206d-40e7-9fe7-b85cb03f1416").checkEq(firstOccurence, 52);
        new Here("Unit", 890).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-fc4d9e89-01c5-47b8-a552-3e5235236338-..s3Key..-8587fbf9-a37c-4f8c-aadf-96ba012d5fa7").checkEq(firstOccurence, 52);
        new Here("Unit", 890).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-a8640ee8-ffd4-4b6a-891f-a475052d5349-..s3Key..-ce55984f-6859-49f6-a8e2-db0739a529c4").checkEq(firstOccurence, 52);
        new Here("Unit", 890).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-b0fcaff5-4046-47f1-8b6c-a9d945f6b0af-..s3Key..-97980675-c843-4bb0-bca9-8cf493e783d2").checkEq(firstOccurence, 52);
        new Here("Unit", 890).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-5e168132-6f65-476f-bd6e-8cfb9cd7c66b-..s3Key..-00a72af1-2e0a-4159-9304-0bae28eb80a2").checkEq(firstOccurence, 52);
        new Here("Unit", 890).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-384cb400-fd6b-4005-9f5a-e1009a30c7ad-..s3Key..-6da112b4-8d62-4832-99e2-4388554ea1f4").checkEq(firstOccurence, 0);
        new Here("Unit", 890).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-f02011ad-d70b-46f4-baaf-4276a5601758-..s3Key..-573b2cd4-46ea-4a7a-b401-928c532aca2a").checkEq(firstOccurence, 0);
        new Here("Unit", 890).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-b1132737-5127-4e1a-9ff9-a3cf01cdf4a7-..s3Key..-7c0ab5a0-3d2c-41b8-8110-079d6032f67f").checkEq(firstOccurence, 0);
        new Here("Unit", 890).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-d0e1040d-092f-4e94-a0f4-081bf40033f0-..s3Key..-1e884d81-72b7-402c-8ae1-3c82025ac0f0").checkEq(firstOccurence, 52);
        new Here("Unit", 890).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-b1132737-5127-4e1a-9ff9-a3cf01cdf4a7-..s3Key..-7c0ab5a0-3d2c-41b8-8110-079d6032f67f").checkEq(firstOccurence, 52);
        new Here("Unit", 890).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-9de2dc06-b61f-4141-8c9b-f5f77459d618-..s3Key..-86fff0ec-206d-40e7-9fe7-b85cb03f1416").checkEq(firstOccurence, 0);
        new Here("Unit", 890).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-d0e1040d-092f-4e94-a0f4-081bf40033f0-..s3Key..-1e884d81-72b7-402c-8ae1-3c82025ac0f0").checkEq(firstOccurence, 0);
        new Here("Unit", 890).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-e923a528-4835-440d-8be1-b9a890cdead3-..s3Key..-da1f8274-478b-4f7d-95f7-c4f336215454").checkEq(firstOccurence, 0);
        new Here("Unit", 890).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-043b0511-1fdc-4c25-b8aa-0e9440a97848-..s3Key..-5de70f1f-8e26-4308-b983-ff8b63eb970d").checkEq(firstOccurence, 0);
        new Here("Unit", 890).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-043b0511-1fdc-4c25-b8aa-0e9440a97848-..s3Key..-5de70f1f-8e26-4308-b983-ff8b63eb970d").checkEq(firstOccurence, 52);
        new Here("Unit", 890).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-b0fcaff5-4046-47f1-8b6c-a9d945f6b0af-..s3Key..-97980675-c843-4bb0-bca9-8cf493e783d2").checkEq(firstOccurence, 0);
        new Here("Unit", 890).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-e923a528-4835-440d-8be1-b9a890cdead3-..s3Key..-da1f8274-478b-4f7d-95f7-c4f336215454").checkEq(firstOccurence, 52);
        new Here("Unit", 890).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-a8640ee8-ffd4-4b6a-891f-a475052d5349-..s3Key..-ce55984f-6859-49f6-a8e2-db0739a529c4").checkEq(firstOccurence, 0);
        new Here("Unit", 890).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-384cb400-fd6b-4005-9f5a-e1009a30c7ad-..s3Key..-6da112b4-8d62-4832-99e2-4388554ea1f4").checkEq(firstOccurence, 52);
        int secondOccurence = receiptHandle.indexOf(marker, firstOccurence + 1);
        new Here("Unit", 891).given(firstOccurence, 0).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-b0fcaff5-4046-47f1-8b6c-a9d945f6b0af-..s3Key..-97980675-c843-4bb0-bca9-8cf493e783d2").checkEq(secondOccurence, 34);
        new Here("Unit", 891).given(firstOccurence, 52).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-d0e1040d-092f-4e94-a0f4-081bf40033f0-..s3Key..-1e884d81-72b7-402c-8ae1-3c82025ac0f0").checkEq(secondOccurence, 99);
        new Here("Unit", 891).given(firstOccurence, 52).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-a8640ee8-ffd4-4b6a-891f-a475052d5349-..s3Key..-ce55984f-6859-49f6-a8e2-db0739a529c4").checkEq(secondOccurence, 99);
        new Here("Unit", 891).given(firstOccurence, 0).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-9de2dc06-b61f-4141-8c9b-f5f77459d618-..s3Key..-86fff0ec-206d-40e7-9fe7-b85cb03f1416").checkEq(secondOccurence, 34);
        new Here("Unit", 891).given(firstOccurence, 52).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-fc4d9e89-01c5-47b8-a552-3e5235236338-..s3Key..-8587fbf9-a37c-4f8c-aadf-96ba012d5fa7").checkEq(secondOccurence, 99);
        new Here("Unit", 891).given(firstOccurence, 0).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-f02011ad-d70b-46f4-baaf-4276a5601758-..s3Key..-573b2cd4-46ea-4a7a-b401-928c532aca2a").checkEq(secondOccurence, 34);
        new Here("Unit", 891).given(firstOccurence, 0).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-384cb400-fd6b-4005-9f5a-e1009a30c7ad-..s3Key..-6da112b4-8d62-4832-99e2-4388554ea1f4").checkEq(secondOccurence, 34);
        new Here("Unit", 891).given(firstOccurence, 52).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-384cb400-fd6b-4005-9f5a-e1009a30c7ad-..s3Key..-6da112b4-8d62-4832-99e2-4388554ea1f4").checkEq(secondOccurence, 99);
        new Here("Unit", 891).given(firstOccurence, 52).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-e923a528-4835-440d-8be1-b9a890cdead3-..s3Key..-da1f8274-478b-4f7d-95f7-c4f336215454").checkEq(secondOccurence, 99);
        new Here("Unit", 891).given(firstOccurence, 0).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-a8640ee8-ffd4-4b6a-891f-a475052d5349-..s3Key..-ce55984f-6859-49f6-a8e2-db0739a529c4").checkEq(secondOccurence, 34);
        new Here("Unit", 891).given(firstOccurence, 0).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-fc4d9e89-01c5-47b8-a552-3e5235236338-..s3Key..-8587fbf9-a37c-4f8c-aadf-96ba012d5fa7").checkEq(secondOccurence, 34);
        new Here("Unit", 891).given(firstOccurence, 52).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-b1132737-5127-4e1a-9ff9-a3cf01cdf4a7-..s3Key..-7c0ab5a0-3d2c-41b8-8110-079d6032f67f").checkEq(secondOccurence, 99);
        new Here("Unit", 891).given(firstOccurence, 0).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-d0e1040d-092f-4e94-a0f4-081bf40033f0-..s3Key..-1e884d81-72b7-402c-8ae1-3c82025ac0f0").checkEq(secondOccurence, 34);
        new Here("Unit", 891).given(firstOccurence, 52).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-b0fcaff5-4046-47f1-8b6c-a9d945f6b0af-..s3Key..-97980675-c843-4bb0-bca9-8cf493e783d2").checkEq(secondOccurence, 99);
        new Here("Unit", 891).given(firstOccurence, 52).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-5e168132-6f65-476f-bd6e-8cfb9cd7c66b-..s3Key..-00a72af1-2e0a-4159-9304-0bae28eb80a2").checkEq(secondOccurence, 99);
        new Here("Unit", 891).given(firstOccurence, 0).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-e923a528-4835-440d-8be1-b9a890cdead3-..s3Key..-da1f8274-478b-4f7d-95f7-c4f336215454").checkEq(secondOccurence, 34);
        new Here("Unit", 891).given(firstOccurence, 52).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-043b0511-1fdc-4c25-b8aa-0e9440a97848-..s3Key..-5de70f1f-8e26-4308-b983-ff8b63eb970d").checkEq(secondOccurence, 99);
        new Here("Unit", 891).given(firstOccurence, 52).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-f02011ad-d70b-46f4-baaf-4276a5601758-..s3Key..-573b2cd4-46ea-4a7a-b401-928c532aca2a").checkEq(secondOccurence, 99);
        new Here("Unit", 891).given(firstOccurence, 52).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-9de2dc06-b61f-4141-8c9b-f5f77459d618-..s3Key..-86fff0ec-206d-40e7-9fe7-b85cb03f1416").checkEq(secondOccurence, 99);
        new Here("Unit", 891).given(firstOccurence, 0).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-5e168132-6f65-476f-bd6e-8cfb9cd7c66b-..s3Key..-00a72af1-2e0a-4159-9304-0bae28eb80a2").checkEq(secondOccurence, 34);
        new Here("Unit", 891).given(firstOccurence, 0).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-043b0511-1fdc-4c25-b8aa-0e9440a97848-..s3Key..-5de70f1f-8e26-4308-b983-ff8b63eb970d").checkEq(secondOccurence, 34);
        new Here("Unit", 891).given(firstOccurence, 0).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-b1132737-5127-4e1a-9ff9-a3cf01cdf4a7-..s3Key..-7c0ab5a0-3d2c-41b8-8110-079d6032f67f").checkEq(secondOccurence, 34);
    ...
    private SendMessageBatchRequestEntry storeMessageInS3(SendMessageBatchRequestEntry batchEntry) {
        ...
        batchEntryBuilder.messageAttributes(updateMessageAttributePayloadSize(batchEntry.messageAttributes(), messageContentSize));
    ...
    private SendMessageRequest storeMessageInS3(SendMessageRequest sendMessageRequest) {
        ...
        Long messageContentSize = Util.getStringSizeInBytes(messageContentStr);
        SendMessageRequest.Builder sendMessageRequestBuilder = sendMessageRequest.toBuilder();
        sendMessageRequestBuilder.messageAttributes(updateMessageAttributePayloadSize(sendMessageRequest.messageAttributes(), messageContentSize));
        // Store the message content in S3.
        String largeMessagePointer = payloadStore.storeOriginalPayload(messageContentStr);
    ...
    private static <T extends AwsRequest.Builder> T appendUserAgent(final T builder) {
        return (T) builder.overrideConfiguration(AwsRequestOverrideConfiguration.builder().addApiName(ApiName.builder().name(USER_AGENT_NAME).version(USER_AGENT_VERSION).build()).build());
    }
}
