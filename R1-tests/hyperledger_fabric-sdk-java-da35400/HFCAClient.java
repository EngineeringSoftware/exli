...
public class HFCAClient {
    ...
    // DO NOT REMOVE THIS IS NEEDED TO MAKE SURE WE FIRST LOAD CONFIG!!!
    ...
    public Enrollment enroll(String user, String secret, EnrollmentRequest req) throws EnrollmentException, InvalidArgumentException {
        ...
        try {
            ...
            String responseBody = httpPost(getURL(HFCA_ENROLL), body, new UsernamePasswordCredentials(user, secret));
    ...
    public HFCAInfo info() throws InfoException, InvalidArgumentException {
        ...
        try {
            ...
            String responseBody = httpPost(infoURL, body.toString(), (UsernamePasswordCredentials) null);
            logger.debug("response:" + responseBody);
            JsonReader reader = Json.createReader(new StringReader(responseBody));
            JsonObject jsonst = (JsonObject) reader.read();
            boolean success = jsonst.getBoolean("success");
    ...
    public Enrollment idemixEnroll(Enrollment enrollment, String mspID) throws EnrollmentException, InvalidArgumentException {
        ...
        try {
            ...
            // Encoded IdemixRole from Fabric-Ca
            ...
            try {
                ...
                if (properties.containsKey("pemFile")) {
                    ...
                    if (pemFile != null) {
                        ...
                        new Here("Unit", 1605).given(pemFile, "src/test/fixture/testPems/caBundled.pems, src/test/fixture/testPems/Org1MSP_CA.pem").checkEq(pems, new String[] { "src/test/fixture/testPems/caBundled.pems", "src/test/fixture/testPems/Org1MSP_CA.pem" });
                        new Here("Unit", 1605).given(pemFile, "nofile.pem").checkEq(pems, new String[] { "nofile.pem" });
                        for (String pem : pems) {
                ...
                SSLContextBuilder sslContextBuilder = SSLContexts.custom().loadTrustMaterial(cryptoPrimitives.getTrustStore(), null);
                ...
                if (properties != null && Boolean.parseBoolean(properties.getProperty("allowAllHostNames"))) {
