    ...
    public Date getDate() {
        for (int i = 0; i < info.length() - 9; i++) {
            if (Character.isWhitespace(info.charAt(i))) {
                ...
                itest("randoop", 111).given(i, 43).given(info, "com.maxmind.geoip.InvalidDatabaseException: com.maxmind.geoip.InvalidDatabaseException: com.maxmind.geoip.InvalidDatabaseException: com.maxmind.geoip.InvalidDatabaseException: com.maxmind.geoip.InvalidDatabaseException: com.maxmind.geoip.InvalidDatabaseException: hi!").checkEq(dateString, "com.maxm");
                itest("evosuite", 111).given(i, 4).given(info, "4QnH Xfa,l.E#Ou$3&O").checkEq(dateString, "Xfa,l.E#");
                itest("evosuite", 111).given(i, 1).given(info, "F kS!A#QQG3!nnS(EU").checkEq(dateString, "kS!A#QQG");
                itest("randoop", 111).given(i, 43).given(info, "com.maxmind.geoip.InvalidDatabaseException: com.maxmind.geoip.InvalidDatabaseException: ").checkEq(dateString, "com.maxm");
                itest("evosuite", 111).given(i, 6).given(info, "7wClg< -X~wvfTP]o\"").checkEq(dateString, "-X~wvfTP");
                itest("randoop", 111).given(i, 43).given(info, "com.maxmind.geoip.InvalidDatabaseException: com.maxmind.geoip.InvalidDatabaseException: com.maxmind.geoip.InvalidDatabaseException: com.maxmind.geoip.InvalidDatabaseException: hi!").checkEq(dateString, "com.maxm");
                itest("randoop", 111).given(i, 43).given(info, "com.maxmind.geoip.InvalidDatabaseException: com.maxmind.geoip.InvalidDatabaseException: com.maxmind.geoip.InvalidDatabaseException: ").checkEq(dateString, "com.maxm");
                itest("randoop", 111).given(i, 43).given(info, "com.maxmind.geoip.InvalidDatabaseException: com.maxmind.geoip.InvalidDatabaseException: com.maxmind.geoip.InvalidDatabaseException: com.maxmind.geoip.InvalidDatabaseException: com.maxmind.geoip.InvalidDatabaseException: hi!").checkEq(dateString, "com.maxm");
                try {
