...
public class XMLDatabase implements IDatabase {
     ...
     */
    public void build(InputStream inputStream, boolean treatWarningsAsError) throws IOException, ParseException {
    ...
    private void build(InputSource inputSource, boolean treatWarningsAsError) throws IOException, ParseException {
     ...
     */
    public void writeXML(OutputStream outputStream, String encoding, String indent, String lineSeparator) throws IOException {
     ...
     * @throws IOException if any IO errors occur
     */
    public void writeXML(StringWriter stringWriter, String encoding, String indent, String lineSeparator) throws IOException {
        XMLOutputter outputter = new XMLOutputter();
        Format format = Format.getPrettyFormat();
        format.setEncoding(encoding);
        format.setIndent(indent);
    ...
    public void moveUpTextNodes(ITextNode[] textNodes) {
        for (ITextNode textNode : textNodes) {
            ...
            itest("evosuite", 455).given(textNode, "37.xml").given(textNodeList, "38.xml").checkEq(index, 1);
            itest("evosuite", 455).given(textNode, "54.xml").given(textNodeList, "52.xml").checkEq(index, 1);
            itest("evosuite", 455).given(textNode, "27.xml").given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 455).given(textNode, "63.xml").given(textNodeList, "64.xml").checkEq(index, 0);
            itest("evosuite", 455).given(textNode, "57.xml").given(textNodeList, "55.xml").checkEq(index, 1);
            itest("evosuite", 455).given(textNode, "42.xml").given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 455).given(textNode, "53.xml").given(textNodeList, "52.xml").checkEq(index, 0);
            itest("evosuite", 455).given(textNode, "56.xml").given(textNodeList, "55.xml").checkEq(index, 0);
            itest("randoop", 455).given(textNode, "71.xml").given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 455).given(textNode, "61.xml").given(textNodeList, "26.xml").checkEq(index, -1);
            itest("randoop", 455).given(textNode, "66.xml").given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 455).given(textNode, "28.xml").given(textNodeList, "26.xml").checkEq(index, -1);
            itest("dev", 455).given(textNode, "15.xml").given(textNodeList, "16.xml").checkEq(index, 0);
            itest("evosuite", 455).given(textNode, "60.xml").given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 455).given(textNode, "46.xml").given(textNodeList, "47.xml").checkEq(index, 1);
            itest("evosuite", 455).given(textNode, "25.xml").given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 455).given(textNode, null).given(textNodeList, "52.xml").checkEq(index, -1);
            itest("evosuite", 455).given(textNode, "39.xml").given(textNodeList, "40.xml").checkEq(index, 0);
            itest("evosuite", 455).given(textNode, null).given(textNodeList, "48.xml").checkEq(index, -1);
            itest("evosuite", 455).given(textNode, "29.xml").given(textNodeList, "30.xml").checkEq(index, 1);
            itest("dev", 455).given(textNode, "22.xml").given(textNodeList, "23.xml").checkEq(index, 1);
            itest("evosuite", 455).given(textNode, "59.xml").given(textNodeList, "26.xml").checkEq(index, -1);
            itest("dev", 455).given(textNode, "24.xml").given(textNodeList, "21.xml").checkEq(index, 2);
            itest("evosuite", 455).given(textNode, "49.xml").given(textNodeList, "50.xml").checkEq(index, 0);
            itest("evosuite", 455).given(textNode, null).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 455).given(textNode, null).given(textNodeList, "55.xml").checkEq(index, -1);
            itest("randoop", 455).given(textNode, "70.xml").given(textNodeList, "26.xml").checkEq(index, -1);
            if (index > 0) {
    ...
    public void moveDownTextNodes(ITextNode[] textNodes) {
        for (int i = textNodes.length - 1; i >= 0; i--) {
            ...
            itest("evosuite", 470).given(textNodes, "44.xml").given(i, 2).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("randoop", 470).given(textNodes, "65.xml").given(i, 1).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "31.xml").given(i, 0).given(textNodeList, "32.xml").checkEq(index, 0);
            itest("evosuite", 470).given(textNodes, "41.xml").given(i, 0).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "51.xml").given(i, 0).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "45.xml").given(i, 14).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "45.xml").given(i, 16).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "45.xml").given(i, 8).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "33.xml").given(i, 2).given(textNodeList, "34.xml").checkEq(index, 0);
            itest("evosuite", 470).given(textNodes, "31.xml").given(i, 1).given(textNodeList, "32.xml").checkEq(index, 0);
            itest("randoop", 470).given(textNodes, "69.xml").given(i, 0).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "44.xml").given(i, 0).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "62.xml").given(i, 2).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "45.xml").given(i, 3).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "45.xml").given(i, 12).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "35.xml").given(i, 0).given(textNodeList, "36.xml").checkEq(index, 1);
            itest("evosuite", 470).given(textNodes, "35.xml").given(i, 1).given(textNodeList, "36.xml").checkEq(index, 1);
            itest("evosuite", 470).given(textNodes, "58.xml").given(i, 6).given(textNodeList, "55.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "43.xml").given(i, 0).given(textNodeList, "30.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "45.xml").given(i, 11).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "31.xml").given(i, 2).given(textNodeList, "32.xml").checkEq(index, 0);
            itest("evosuite", 470).given(textNodes, "45.xml").given(i, 10).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "45.xml").given(i, 2).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "44.xml").given(i, 3).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "31.xml").given(i, 4).given(textNodeList, "32.xml").checkEq(index, 0);
            itest("evosuite", 470).given(textNodes, "45.xml").given(i, 1).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "31.xml").given(i, 3).given(textNodeList, "32.xml").checkEq(index, 0);
            itest("randoop", 470).given(textNodes, "43.xml").given(i, 0).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "45.xml").given(i, 0).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "44.xml").given(i, 1).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "31.xml").given(i, 5).given(textNodeList, "32.xml").checkEq(index, 0);
            itest("evosuite", 470).given(textNodes, "33.xml").given(i, 4).given(textNodeList, "34.xml").checkEq(index, 1);
            itest("evosuite", 470).given(textNodes, "45.xml").given(i, 13).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "45.xml").given(i, 9).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("randoop", 470).given(textNodes, "65.xml").given(i, 0).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "33.xml").given(i, 3).given(textNodeList, "34.xml").checkEq(index, 1);
            itest("dev", 470).given(textNodes, "20.xml").given(i, 0).given(textNodeList, "21.xml").checkEq(index, 0);
            itest("evosuite", 470).given(textNodes, "41.xml").given(i, 4).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "62.xml").given(i, 1).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "45.xml").given(i, 4).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "41.xml").given(i, 3).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "45.xml").given(i, 5).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "41.xml").given(i, 2).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("randoop", 470).given(textNodes, "68.xml").given(i, 0).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "51.xml").given(i, 1).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("dev", 470).given(textNodes, "18.xml").given(i, 1).given(textNodeList, "19.xml").checkEq(index, 1);
            itest("evosuite", 470).given(textNodes, "45.xml").given(i, 6).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "62.xml").given(i, 0).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("dev", 470).given(textNodes, "17.xml").given(i, 0).given(textNodeList, "16.xml").checkEq(index, 0);
            itest("randoop", 470).given(textNodes, "67.xml").given(i, 0).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "45.xml").given(i, 7).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "45.xml").given(i, 15).given(textNodeList, "26.xml").checkEq(index, -1);
            itest("evosuite", 470).given(textNodes, "41.xml").given(i, 1).given(textNodeList, "26.xml").checkEq(index, -1);
