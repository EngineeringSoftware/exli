...
public class AndroidExporter implements IExporter {
    ...
    protected String resolveIOSPlaceholders(String original) {
        ...
        while (matcher.find()) {
            ...
            itest("dev", 137).given(matcher, "9.xml").checkEq(placeholderIOS, "%E");
            itest("dev", 137).given(matcher, "0.xml").checkEq(placeholderIOS, "%d");
            itest("dev", 137).given(matcher, "14.xml").checkEq(placeholderIOS, "%@");
            itest("dev", 137).given(matcher, "11.xml").checkEq(placeholderIOS, "%G");
            itest("dev", 137).given(matcher, "1.xml").checkEq(placeholderIOS, "%i");
            itest("dev", 137).given(matcher, "7.xml").checkEq(placeholderIOS, "%p");
            itest("dev", 137).given(matcher, "10.xml").checkEq(placeholderIOS, "%g");
            itest("dev", 137).given(matcher, "5.xml").checkEq(placeholderIOS, "%X");
            itest("dev", 137).given(matcher, "6.xml").checkEq(placeholderIOS, "%f");
            itest("dev", 137).given(matcher, "2.xml").checkEq(placeholderIOS, "%o");
            itest("dev", 137).given(matcher, "13.xml").checkEq(placeholderIOS, "%s");
            itest("dev", 137).given(matcher, "3.xml").checkEq(placeholderIOS, "%u");
            itest("dev", 137).given(matcher, "4.xml").checkEq(placeholderIOS, "%x");
            itest("dev", 137).given(matcher, "12.xml").checkEq(placeholderIOS, "%c");
            itest("dev", 137).given(matcher, "8.xml").checkEq(placeholderIOS, "%e");
            ...
            if (placeholderAndroid != null) {
                ...
                itest("dev", 140).given(placeholderAndroid, "%%%d\\$E").given(index, 9).checkEq(placeholderAndroid, "%9\\$E");
                itest("dev", 140).given(placeholderAndroid, "%%%d\\$e").given(index, 8).checkEq(placeholderAndroid, "%8\\$e");
                itest("dev", 140).given(placeholderAndroid, "%%%d\\$d").given(index, 1).checkEq(placeholderAndroid, "%1\\$d");
                itest("dev", 140).given(placeholderAndroid, "%%%d\\$G").given(index, 11).checkEq(placeholderAndroid, "%11\\$G");
                itest("dev", 140).given(placeholderAndroid, "%%%d\\$o").given(index, 3).checkEq(placeholderAndroid, "%3\\$o");
                itest("dev", 140).given(placeholderAndroid, "%%%d\\$f").given(index, 7).checkEq(placeholderAndroid, "%7\\$f");
                itest("dev", 140).given(placeholderAndroid, "%%%d\\$x").given(index, 5).checkEq(placeholderAndroid, "%5\\$x");
                itest("dev", 140).given(placeholderAndroid, "%%%d\\$X").given(index, 6).checkEq(placeholderAndroid, "%6\\$X");
                itest("dev", 140).given(placeholderAndroid, "%%%d\\$c").given(index, 12).checkEq(placeholderAndroid, "%12\\$c");
                itest("dev", 140).given(placeholderAndroid, "%%%d\\$s").given(index, 14).checkEq(placeholderAndroid, "%14\\$s");
                itest("dev", 140).given(placeholderAndroid, "%%%d\\$g").given(index, 10).checkEq(placeholderAndroid, "%10\\$g");
                itest("dev", 140).given(placeholderAndroid, "%%%d\\$d").given(index, 2).checkEq(placeholderAndroid, "%2\\$d");
                itest("dev", 140).given(placeholderAndroid, "%%%d\\$s").given(index, 13).checkEq(placeholderAndroid, "%13\\$s");
                itest("dev", 140).given(placeholderAndroid, "%%%d\\$d").given(index, 4).checkEq(placeholderAndroid, "%4\\$d");
