...
public class ShortToLongUrlTransformer implements UrlTransformer {
    ...
    protected String getLongUrl(Context context, CachingOptions cachingOptions, String shortUrl, boolean useShortNameIfLongNameNotFound) throws UrlTransformationException {
        ...
        itest("dev", 94).given(shortUrl, "/folder/base/index.html/").checkEq(levels, new String[] { "folder", "base", "index.html" });
        itest("evosuite", 94).given(shortUrl, "nulld8Ikd8Ik").checkEq(levels, new String[] { "nulld8Ikd8Ik" });
        itest("evosuite", 94).given(shortUrl, "").checkEq(levels, new String[] { "" });
        itest("evosuite", 94).given(shortUrl, "d8Ikd8Ik").checkEq(levels, new String[] { "d8Ikd8Ik" });
        itest("evosuite", 94).given(shortUrl, "d8Ikd8Ikd8Ik").checkEq(levels, new String[] { "d8Ikd8Ikd8Ik" });
        itest("evosuite", 94).given(shortUrl, "null").checkEq(levels, new String[] { "null" });
        itest("dev", 94).given(shortUrl, "/folder/base_fr_es/index.html/").checkEq(levels, new String[] { "folder", "base_fr_es", "index.html" });
        itest("dev", 94).given(shortUrl, "/folder/subfolder/index.html/").checkEq(levels, new String[] { "folder", "subfolder", "index.html" });
        itest("dev", 94).given(shortUrl, "/folder/base_fr/index.html/").checkEq(levels, new String[] { "folder", "base_fr", "index.html" });
        itest("evosuite", 94).given(shortUrl, "ykgMP@/k?").checkEq(levels, new String[] { "ykgMP@", "k?" });
        itest("evosuite", 94).given(shortUrl, "_").checkEq(levels, new String[] { "_" });
