...
public class IncludeDescriptorsProcessor implements ItemProcessor {
    ...
    protected void doInclude(Item item, Element includeElement, Item itemToInclude) throws ItemProcessingException {
        ...
        itest("dev", 195).given(includeElement, "1.xml").given(includeElementParentChildren, "2.xml").checkEq(includeElementIdx, 1);
        itest("dev", 195).given(includeElement, "27.xml").given(includeElementParentChildren, "28.xml").checkEq(includeElementIdx, 0);
        itest("dev", 195).given(includeElement, "3.xml").given(includeElementParentChildren, "4.xml").checkEq(includeElementIdx, 0);
        itest("dev", 195).given(includeElement, "25.xml").given(includeElementParentChildren, "26.xml").checkEq(includeElementIdx, 0);
        itest("dev", 195).given(includeElement, "31.xml").given(includeElementParentChildren, "32.xml").checkEq(includeElementIdx, 4);
        itest("dev", 195).given(includeElement, "33.xml").given(includeElementParentChildren, "34.xml").checkEq(includeElementIdx, 0);
        itest("dev", 195).given(includeElement, "29.xml").given(includeElementParentChildren, "30.xml").checkEq(includeElementIdx, 0);
        itest("dev", 195).given(includeElement, "23.xml").given(includeElementParentChildren, "24.xml").checkEq(includeElementIdx, 4);
    ...
    public String toString() {
        return "IncludeDescriptorsProcessor[" + "contentStoreService=" + contentStoreService + ", includeElementXPathQuery='" + includeElementXPathQuery + '\'' + ']';
    }
}
