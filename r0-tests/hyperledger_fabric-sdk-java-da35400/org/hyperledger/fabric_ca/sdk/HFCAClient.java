            ...
            try {
                ...
                if (properties.containsKey("pemFile")) {
                    ...
                    if (pemFile != null) {
                        ...
                        itest("dev", 1605).given(pemFile, "nofile.pem").checkEq(pems, new String[] { "nofile.pem" });
                        itest("dev", 1605).given(pemFile, "src/test/fixture/testPems/caBundled.pems, src/test/fixture/testPems/Org1MSP_CA.pem").checkEq(pems, new String[] { "src/test/fixture/testPems/caBundled.pems", "src/test/fixture/testPems/Org1MSP_CA.pem" });
                        for (String pem : pems) {
