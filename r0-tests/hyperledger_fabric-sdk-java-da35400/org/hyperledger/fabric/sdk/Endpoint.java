...
class Endpoint {
            ...
            if ("grpcs".equals(protocol)) {
                ...
                try (ByteArrayOutputStream bis = new ByteArrayOutputStream(64000)) {
                    ...
                    if (properties.containsKey("pemFile")) {
                        ...
                        itest("dev", 118).given(pemFile, "src/test/fixture/testPems/caBundled.pems,src/test/fixture/testPems/IMBAD,src/test/fixture/testPems/Org1MSP_CA.pem").checkEq(pems, new String[] { "src/test/fixture/testPems/caBundled.pems", "src/test/fixture/testPems/IMBAD", "src/test/fixture/testPems/Org1MSP_CA.pem" });
                        itest("dev", 118).given(pemFile, "src/test/fixture/testPems/caBundled.pems,src/test/fixture/testPems/AnotherUniqCA.pem").checkEq(pems, new String[] { "src/test/fixture/testPems/caBundled.pems", "src/test/fixture/testPems/AnotherUniqCA.pem" });
                        itest("dev", 118).given(pemFile, "/home/itdocker/exli/_downloads/hyperledger_fabric-sdk-java/src/test/resources/keypair-signed.crt").checkEq(pems, new String[] { "/home/itdocker/exli/_downloads/hyperledger_fabric-sdk-java/src/test/resources/keypair-signed.crt" });
                        for (String pem : pems) {
    ...
    private void addNettyBuilderProps(NettyChannelBuilder channelBuilder, Properties props) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        for (Map.Entry<?, ?> es : props.entrySet()) {
            ...
            itest("dev", 339).given(methodprop, "clientCertFile").checkEq(methodprops, "clientCertFile");
            itest("dev", 339).given(methodprop, "negotiationType").checkEq(methodprops, "negotiationType");
            itest("dev", 339).given(methodprop, "grpc.NettyChannelBuilderOption.keepAliveTime").checkEq(methodprops, "grpc.NettyChannelBuilderOption.keepAliveTime");
            itest("dev", 339).given(methodprop, "pemFile").checkEq(methodprops, "pemFile");
            itest("dev", 339).given(methodprop, "grpc.NettyChannelBuilderOption.maxInboundMessageSize").checkEq(methodprops, "grpc.NettyChannelBuilderOption.maxInboundMessageSize");
            itest("dev", 339).given(methodprop, "hostnameOverride").checkEq(methodprops, "hostnameOverride");
            itest("dev", 339).given(methodprop, "grpc.NettyChannelBuilderOption.keepAliveWithoutCalls").checkEq(methodprops, "grpc.NettyChannelBuilderOption.keepAliveWithoutCalls");
            itest("dev", 339).given(methodprop, "trustServerCertificate").checkEq(methodprops, "trustServerCertificate");
            itest("dev", 339).given(methodprop, "pemBytes").checkEq(methodprops, "pemBytes");
            itest("dev", 339).given(methodprop, "grpc.http2.keepalive_time").checkEq(methodprops, "grpc.http2.keepalive_time");
            itest("dev", 339).given(methodprop, "ssl-target-name-override").checkEq(methodprops, "ssl-target-name-override");
            itest("dev", 339).given(methodprop, "clientKeyBytes").checkEq(methodprops, "clientKeyBytes");
            itest("dev", 339).given(methodprop, "org.hyperledger.fabric.sdk.peer.organization_mspid").checkEq(methodprops, "org.hyperledger.fabric.sdk.peer.organization_mspid");
            itest("dev", 339).given(methodprop, "grpc.NettyChannelBuilderOption.keepAliveTimeout").checkEq(methodprops, "grpc.NettyChannelBuilderOption.keepAliveTimeout");
            itest("dev", 339).given(methodprop, "clientKeyFile").checkEq(methodprops, "clientKeyFile");
            itest("dev", 339).given(methodprop, "clientCertBytes").checkEq(methodprops, "clientCertBytes");
            itest("dev", 339).given(methodprop, "grpc-max-send-message-length").checkEq(methodprops, "grpc-max-send-message-length");
            itest("dev", 339).given(methodprop, "sslProvider").checkEq(methodprops, "sslProvider");
            Matcher match = METHOD_PATTERN.matcher(methodprops);
            String methodName = null;
            if (match.matches() && match.groupCount() == 1) {
                itest("dev", 345).given(match, "51.xml").checkTrue(group());
                itest("dev", 345).given(match, "18.xml").checkFalse(group());
                itest("dev", 345).given(match, "12.xml").checkFalse(group());
                itest("dev", 345).given(match, "10.xml").checkFalse(group());
                itest("dev", 345).given(match, "53.xml").checkFalse(group());
                itest("dev", 345).given(match, "44.xml").checkFalse(group());
                itest("dev", 345).given(match, "50.xml").checkFalse(group());
                itest("dev", 345).given(match, "17.xml").checkFalse(group());
                itest("dev", 345).given(match, "13.xml").checkFalse(group());
                itest("dev", 345).given(match, "9.xml").checkFalse(group());
                itest("dev", 345).given(match, "15.xml").checkFalse(group());
                itest("dev", 345).given(match, "48.xml").checkTrue(group());
                itest("dev", 345).given(match, "46.xml").checkTrue(group());
                itest("dev", 345).given(match, "11.xml").checkFalse(group());
                itest("dev", 345).given(match, "45.xml").checkFalse(group());
                itest("dev", 345).given(match, "54.xml").checkTrue(group());
                itest("dev", 345).given(match, "16.xml").checkFalse(group());
                itest("dev", 345).given(match, "14.xml").checkFalse(group());
                methodName = match.group(1).trim();
                itest("dev", 346).given(match, "49.xml").checkEq(methodName, "keepAliveTimeout");
                itest("dev", 346).given(match, "55.xml").checkEq(methodName, "maxInboundMessageSize");
                itest("dev", 346).given(match, "47.xml").checkEq(methodName, "keepAliveWithoutCalls");
                itest("dev", 346).given(match, "52.xml").checkEq(methodName, "keepAliveTime");
            }
