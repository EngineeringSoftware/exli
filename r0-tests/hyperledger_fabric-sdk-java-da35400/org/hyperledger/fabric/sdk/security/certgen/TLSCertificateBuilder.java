...
public class TLSCertificateBuilder {
    ...
    private X509Certificate createSelfSignedCertificate(CertType certType, KeyPair keyPair, String san) throws Exception {
        ...
        itest("dev", 113).given(KeyUsage.keyEncipherment, 32).given(KeyUsage.digitalSignature, 128).checkEq(usage, "43.xml");
        itest("randoop", 113).given(KeyUsage.keyEncipherment, 32).given(KeyUsage.digitalSignature, 128).checkEq(usage, "43.xml");
        itest("evosuite", 113).given(KeyUsage.keyEncipherment, 32).given(KeyUsage.digitalSignature, 128).checkEq(usage, "43.xml");
