...
public class Config {
    ...
    // ORG_HYPERLEDGER_FABRIC_SDK_LOG_EXTRALOGLEVEL
    public static final String EXTRALOGLEVEL = "org.hyperledger.fabric.sdk.log.extraloglevel";

    // ORG_HYPERLEDGER_FABRIC_SDK_LOGLEVEL=TRACE,DEBUG
    ...
    private Config() {
        ...
        try {
            ...
            logger.debug(format("Loading configuration from %s and it is present: %b", loadFile.toString(), loadFile.exists()));
            configProps = new FileInputStream(loadFile);
            sdkProperties.load(configProps);
        } catch (IOException e) {
            logger.warn(format("Failed to load any configuration from: %s. Using toolkit defaults", DEFAULT_CONFIG));
        } finally {
            // Default values
            /**
             * Timeout settings
    ...
    public static Map<Integer, String> parseSecurityCurveMappings(final String property) {
        ...
        if (property != null && !property.isEmpty()) {
            ...
            itest("randoop", 365).given(property, "protos.Events").checkEq(cmaps, new String[] { "protos.Events" });
            itest("randoop", 365).given(property, "628142b91cb9d159e6f7fc5840bff2ccc29a2b52196ba1bfd5ff418cf552f5d0").checkEq(cmaps, new String[] { "628142b91cb9d159e6f7fc5840bff2ccc29a2b52196ba1bfd5ff418cf552f5d0" });
            itest("randoop", 365).given(property, "EC").checkEq(cmaps, new String[] { "EC" });
            itest("randoop", 365).given(property, "org.hyperledger.fabric.sdk.crypto.asymmetric_key_type").checkEq(cmaps, new String[] { "org.hyperledger.fabric.sdk.crypto.asymmetric_key_type" });
            itest("randoop", 365).given(property, "GetBlockByNumber").checkEq(cmaps, new String[] { "GetBlockByNumber" });
            itest("randoop", 365).given(property, "256=secp256r1:384=secp384r1").checkEq(cmaps, new String[] { "256=secp256r1", "384=secp384r1" });
            itest("randoop", 365).given(property, "org.hyperledger.fabric_ca.sdk.connection.connection_request_timeout").checkEq(cmaps, new String[] { "org.hyperledger.fabric_ca.sdk.connection.connection_request_timeout" });
            itest("randoop", 365).given(property, "org.hyperledger.fabric.sdk.log.extraloglevel").checkEq(cmaps, new String[] { "org.hyperledger.fabric.sdk.log.extraloglevel" });
            itest("randoop", 365).given(property, "org.hyperledger.fabric.sdk.orderer_retry.wait_time").checkEq(cmaps, new String[] { "org.hyperledger.fabric.sdk.orderer_retry.wait_time" });
            itest("dev", 365).given(property, "256=secp256r1:384=secp384r1").checkEq(cmaps, new String[] { "256=secp256r1", "384=secp384r1" });
            for (String mape : cmaps) {
                String[] ep = mape.split("[ \t]*=[ \t]*");
                itest("randoop", 368).given(mape, "org.hyperledger.fabric.sdk.orderer_retry.wait_time").checkEq(ep, new String[] { "org.hyperledger.fabric.sdk.orderer_retry.wait_time" });
                itest("randoop", 368).given(mape, "384=secp384r1").checkEq(ep, new String[] { "384", "secp384r1" });
                itest("randoop", 368).given(mape, "org.hyperledger.fabric.sdk.crypto.asymmetric_key_type").checkEq(ep, new String[] { "org.hyperledger.fabric.sdk.crypto.asymmetric_key_type" });
                itest("randoop", 368).given(mape, "GetBlockByNumber").checkEq(ep, new String[] { "GetBlockByNumber" });
                itest("dev", 368).given(mape, "256=secp256r1").checkEq(ep, new String[] { "256", "secp256r1" });
                itest("randoop", 368).given(mape, "256=secp256r1").checkEq(ep, new String[] { "256", "secp256r1" });
                itest("randoop", 368).given(mape, "org.hyperledger.fabric.sdk.log.extraloglevel").checkEq(ep, new String[] { "org.hyperledger.fabric.sdk.log.extraloglevel" });
                itest("dev", 368).given(mape, "384=secp384r1").checkEq(ep, new String[] { "384", "secp384r1" });
                itest("randoop", 368).given(mape, "EC").checkEq(ep, new String[] { "EC" });
                itest("randoop", 368).given(mape, "protos.Events").checkEq(ep, new String[] { "protos.Events" });
                itest("randoop", 368).given(mape, "628142b91cb9d159e6f7fc5840bff2ccc29a2b52196ba1bfd5ff418cf552f5d0").checkEq(ep, new String[] { "628142b91cb9d159e6f7fc5840bff2ccc29a2b52196ba1bfd5ff418cf552f5d0" });
                itest("randoop", 368).given(mape, "org.hyperledger.fabric_ca.sdk.connection.connection_request_timeout").checkEq(ep, new String[] { "org.hyperledger.fabric_ca.sdk.connection.connection_request_timeout" });
                if (ep.length != 2) {
