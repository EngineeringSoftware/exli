...
public final class Utils {
    ...
    public static byte[] generateTarGz(File sourceDirectory, String pathPrefix, File chaincodeMetaInf) throws IOException {
        ...
        try (TarArchiveOutputStream archiveOutputStream = new TarArchiveOutputStream(new GzipCompressorOutputStream(bos))) {
            ...
            for (File childFile : childrenFiles) {
                ...
                itest("dev", 157).given(childPath, "/tmp/junit1863541122110600325/tempDir/test1.txt").given(sourcePath, "/tmp/junit1863541122110600325/tempDir").checkEq(relativePath, "test1.txt");
                itest("dev", 157).given(childPath, "/home/itdocker/exli/_downloads/hyperledger_fabric-sdk-java/src/test/fixture/sdkintegration/gocc/sample1/src/github.com/example_cc/example_cc.go").given(sourcePath, "/home/itdocker/exli/_downloads/hyperledger_fabric-sdk-java/src/test/fixture/sdkintegration/gocc/sample1/src/github.com/example_cc").checkEq(relativePath, "example_cc.go");
                itest("dev", 157).given(childPath, "/tmp/junit1863541122110600325/tempDir/test2.txt").given(sourcePath, "/tmp/junit1863541122110600325/tempDir").checkEq(relativePath, "test2.txt");
                if (pathPrefix != null) {
    ...
    public static Properties parseGrpcUrl(String url) {
        ...
        if (m.matches()) {
            itest("dev", 310).given(m, "73.xml").checkTrue(group());
            itest("dev", 310).given(m, "29.xml").checkTrue(group());
            itest("dev", 310).given(m, "37.xml").checkTrue(group());
            itest("randoop", 310).given(m, "96.xml").checkFalse(group());
            itest("dev", 310).given(m, "66.xml").checkTrue(group());
            itest("randoop", 310).given(m, "103.xml").checkFalse(group());
            itest("randoop", 310).given(m, "91.xml").checkFalse(group());
            itest("randoop", 310).given(m, "85.xml").checkFalse(group());
            itest("dev", 310).given(m, "5.xml").checkTrue(group());
            itest("dev", 310).given(m, "0.xml").checkTrue(group());
            itest("dev", 310).given(m, "67.xml").checkTrue(group());
            itest("dev", 310).given(m, "38.xml").checkTrue(group());
            itest("dev", 310).given(m, "78.xml").checkFalse(group());
            itest("dev", 310).given(m, "8.xml").checkTrue(group());
            itest("dev", 310).given(m, "71.xml").checkTrue(group());
            itest("randoop", 310).given(m, "104.xml").checkFalse(group());
            itest("dev", 310).given(m, "57.xml").checkTrue(group());
            itest("randoop", 310).given(m, "93.xml").checkFalse(group());
            itest("dev", 310).given(m, "68.xml").checkTrue(group());
            itest("randoop", 310).given(m, "87.xml").checkFalse(group());
            itest("dev", 310).given(m, "72.xml").checkTrue(group());
            itest("dev", 310).given(m, "79.xml").checkTrue(group());
            itest("randoop", 310).given(m, "105.xml").checkFalse(group());
            itest("randoop", 310).given(m, "94.xml").checkFalse(group());
            itest("dev", 310).given(m, "7.xml").checkTrue(group());
            itest("dev", 310).given(m, "69.xml").checkTrue(group());
            itest("randoop", 310).given(m, "88.xml").checkFalse(group());
            itest("randoop", 310).given(m, "95.xml").checkFalse(group());
            itest("randoop", 310).given(m, "84.xml").checkFalse(group());
            itest("dev", 310).given(m, "3.xml").checkTrue(group());
            itest("dev", 310).given(m, "77.xml").checkTrue(group());
            itest("dev", 310).given(m, "22.xml").checkFalse(group());
            itest("randoop", 310).given(m, "89.xml").checkFalse(group());
            itest("dev", 310).given(m, "40.xml").checkTrue(group());
            itest("dev", 310).given(m, "63.xml").checkTrue(group());
            itest("dev", 310).given(m, "4.xml").checkTrue(group());
            itest("dev", 310).given(m, "27.xml").checkTrue(group());
            itest("randoop", 310).given(m, "97.xml").checkFalse(group());
            itest("randoop", 310).given(m, "92.xml").checkFalse(group());
            itest("dev", 310).given(m, "70.xml").checkTrue(group());
            itest("randoop", 310).given(m, "86.xml").checkFalse(group());
            itest("randoop", 310).given(m, "102.xml").checkFalse(group());
            itest("randoop", 310).given(m, "81.xml").checkFalse(group());
            itest("dev", 310).given(m, "56.xml").checkTrue(group());
            itest("dev", 310).given(m, "64.xml").checkTrue(group());
            itest("dev", 310).given(m, "75.xml").checkTrue(group());
            itest("dev", 310).given(m, "1.xml").checkTrue(group());
            itest("dev", 310).given(m, "28.xml").checkTrue(group());
            itest("dev", 310).given(m, "20.xml").checkTrue(group());
            itest("randoop", 310).given(m, "82.xml").checkFalse(group());
            itest("dev", 310).given(m, "39.xml").checkTrue(group());
            itest("randoop", 310).given(m, "98.xml").checkFalse(group());
            itest("randoop", 310).given(m, "101.xml").checkFalse(group());
            itest("dev", 310).given(m, "21.xml").checkTrue(group());
            itest("dev", 310).given(m, "19.xml").checkTrue(group());
            itest("randoop", 310).given(m, "83.xml").checkFalse(group());
            itest("dev", 310).given(m, "2.xml").checkTrue(group());
            itest("dev", 310).given(m, "58.xml").checkFalse(group());
            itest("dev", 310).given(m, "6.xml").checkFalse(group());
            itest("dev", 310).given(m, "76.xml").checkTrue(group());
            itest("dev", 310).given(m, "65.xml").checkTrue(group());
            itest("randoop", 310).given(m, "100.xml").checkFalse(group());
            itest("randoop", 310).given(m, "99.xml").checkFalse(group());
            itest("randoop", 310).given(m, "90.xml").checkFalse(group());
    ...
    public static String logString(final String string) {
        ...
        itest("randoop", 367).given(ret, "5").given(MAX_LOG_STRING_LENGTH, 64).checkEq(ret, "5");
        itest("randoop", 367).given(ret, "org.hyperledger.fabric.sdk.orderer_retry.wait_time").given(MAX_LOG_STRING_LENGTH, 64).checkEq(ret, "org.hyperledger.fabric.sdk.orderer_retry.wait_time");
        itest("dev", 367).given(ret, "ab?c").given(MAX_LOG_STRING_LENGTH, 64).checkEq(ret, "ab?c");
        itest("dev", 367).given(ret, "ab??c").given(MAX_LOG_STRING_LENGTH, 64).checkEq(ret, "ab??c");
        return ret;
    }
