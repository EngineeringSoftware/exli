...
public class NetworkConfig {
    ...
    Channel loadChannel(HFClient client, String channelName) throws NetworkConfigurationException {
        ...
        if (null == jsonChannel) {
            ...
            throw new NetworkConfigurationException(format("Channel %s not found in configuration file. Found channel names: %s ", channelName, String.join(", ", channelNames)));
        }
    ...
    private void getTLSCerts(String nodeName, JsonObject jsonOrderer, Properties props) {
        ...
        if (jsonTlsCaCerts != null) {
            ...
            byte[] pemBytes = getJsonValueAsList(jsonTlsCaCerts.get("pem"), NetworkConfig::getJsonValueAsString).stream().collect(Collectors.joining("\n")).getBytes();
            itest("dev", 798).given(jsonTlsCaCerts, "35.xml").checkEq(pemBytes, new byte[] { 45, 45, 45, 45, 45, 66, 69, 71, 73, 78, 32, 67, 69, 82, 84, 73, 70, 73, 67, 65, 84, 69, 45, 45, 45, 45, 45, 32, 60, 101, 116, 99, 62 });
            itest("dev", 798).given(jsonTlsCaCerts, "30.xml").checkEq(pemBytes, new byte[] {});
            itest("dev", 798).given(jsonTlsCaCerts, "42.xml").checkEq(pemBytes, new byte[] { 45, 45, 45, 45, 45, 66, 69, 71, 73, 78, 32, 67, 69, 82, 84, 73, 70, 73, 67, 65, 84, 69, 45, 45, 45, 45, 45, 32, 60, 101, 116, 99, 62 });
            itest("dev", 798).given(jsonTlsCaCerts, "31.xml").checkEq(pemBytes, new byte[] {});
            itest("dev", 798).given(jsonTlsCaCerts, "36.xml").checkEq(pemBytes, new byte[] { 45, 45, 45, 45, 45, 66, 69, 71, 73, 78, 32, 67, 69, 82, 84, 73, 70, 73, 67, 65, 84, 69, 45, 45, 45, 45, 45, 32, 60, 49, 62, 10, 45, 45, 45, 45, 45, 66, 69, 71, 73, 78, 32, 67, 69, 82, 84, 73, 70, 73, 67, 65, 84, 69, 45, 45, 45, 45, 45, 32, 60, 50, 62 });
            itest("dev", 798).given(jsonTlsCaCerts, "24.xml").checkEq(pemBytes, new byte[] {});
            itest("dev", 798).given(jsonTlsCaCerts, "32.xml").checkEq(pemBytes, new byte[] {});
            itest("dev", 798).given(jsonTlsCaCerts, "26.xml").checkEq(pemBytes, new byte[] {});
            itest("dev", 798).given(jsonTlsCaCerts, "25.xml").checkEq(pemBytes, new byte[] {});
            itest("dev", 798).given(jsonTlsCaCerts, "34.xml").checkEq(pemBytes, new byte[] { 45, 45, 45, 45, 45, 66, 69, 71, 73, 78, 32, 67, 69, 82, 84, 73, 70, 73, 67, 65, 84, 69, 45, 45, 45, 45, 45, 32, 60, 101, 116, 99, 62 });
            itest("dev", 798).given(jsonTlsCaCerts, "33.xml").checkEq(pemBytes, new byte[] {});
            itest("dev", 798).given(jsonTlsCaCerts, "23.xml").checkEq(pemBytes, new byte[] {});
            itest("dev", 798).given(jsonTlsCaCerts, "41.xml").checkEq(pemBytes, new byte[] { 45, 45, 45, 45, 45, 66, 69, 71, 73, 78, 32, 67, 69, 82, 84, 73, 70, 73, 67, 65, 84, 69, 45, 45, 45, 45, 45, 32, 60, 101, 116, 99, 62 });
    ...
    private static <T> List<T> getJsonValueAsList(final JsonValue value, Function<JsonValue, T> map) {
        return getJsonValueAsList(value).stream().map(map).filter(Objects::nonNull).collect(Collectors.toList());
    }
    ...
    public static class CAInfo {
        ...
        // The "optional" caName specified in the config, as opposed to its "config" name
