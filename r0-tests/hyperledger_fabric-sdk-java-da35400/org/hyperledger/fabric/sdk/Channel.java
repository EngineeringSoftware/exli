...
public class Channel implements Serializable {
    ...
    static Object findClientProp(Properties config, final String prop, final String mspid, final String endpoint, String def) {
        ...
        itest("dev", 1788).given(endpoint, "2.1.3.4:99").checkEq(split, new String[] { "2.1.3.4", "99" });
        itest("dev", 1788).given(endpoint, "1.1.1.3:33").checkEq(split, new String[] { "1.1.1.3", "33" });
        itest("dev", 1788).given(endpoint, "1.1.1.1:10").checkEq(split, new String[] { "1.1.1.1", "10" });
        itest("dev", 1788).given(endpoint, "2.1.3.4:88").checkEq(split, new String[] { "2.1.3.4", "88" });
