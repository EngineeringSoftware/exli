    ...
    private Set<String> getMatchingMdcNames(DynamicMdcMessageField field, Set<String> mdcNames) {
        ...
        for (String mdcName : mdcNames) {
            if (field.getPattern().matcher(mdcName).matches()) {
                itest("dev", 226).given(mdcName, "someField").given(field, "5.xml").checkFalse(group());
                itest("dev", 226).given(mdcName, "someOtherField").given(field, "5.xml").checkFalse(group());
                itest("dev", 226).given(mdcName, "myMdc-with-suffix1").given(field, "5.xml").checkTrue(group());
                itest("dev", 226).given(mdcName, "myMdc.doubleValue1").given(field, "5.xml").checkTrue(group());
                itest("dev", 226).given(mdcName, "someField").given(field, "6.xml").checkTrue(group());
                itest("dev", 226).given(mdcName, "myMdc-with-suffix2").given(field, "6.xml").checkFalse(group());
                itest("dev", 226).given(mdcName, "myMdc-with-suffix1").given(field, "6.xml").checkFalse(group());
                itest("dev", 226).given(mdcName, "myMdc.stringValue").given(field, "5.xml").checkTrue(group());
                itest("dev", 226).given(mdcName, "myMdc.longValue2").given(field, "5.xml").checkTrue(group());
                itest("dev", 226).given(mdcName, "myMdc.undefinedValue").given(field, "5.xml").checkTrue(group());
                itest("dev", 226).given(mdcName, "myMdc").given(field, "5.xml").checkTrue(group());
                itest("dev", 226).given(mdcName, "myMdc.longValue1").given(field, "5.xml").checkTrue(group());
                itest("dev", 226).given(mdcName, "myMdc.doubleValue2").given(field, "5.xml").checkTrue(group());
                itest("dev", 226).given(mdcName, "someOtherField").given(field, "6.xml").checkFalse(group());
                itest("dev", 226).given(mdcName, "myMdc").given(field, "6.xml").checkFalse(group());
                itest("dev", 226).given(mdcName, "myMdc-with-suffix2").given(field, "5.xml").checkTrue(group());
