...
public class GelfMessage {
    ...
    private String getMatchingDynamicMdcFieldType(String fieldName) {
        ...
        for (Map.Entry<Pattern, String> entry : dynamicMdcFieldTypes.entrySet()) {
            if (entry.getKey().matcher(fieldName).matches()) {
                itest("dev", 466).given(entry, "17.xml").given(fieldName, "level").checkFalse(group());
                itest("dev", 466).given(entry, "13.xml").given(fieldName, "simpleClassName").checkFalse(group());
                itest("dev", 466).given(entry, "27.xml").given(fieldName, "Server").checkFalse(group());
                itest("dev", 466).given(entry, "13.xml").given(fieldName, "myMdc.longValue1").checkTrue(group());
                itest("dev", 466).given(entry, "15.xml").given(fieldName, "server.addr").checkFalse(group());
                itest("dev", 466).given(entry, "27.xml").given(fieldName, "myMdc.stringValue").checkFalse(group());
                itest("dev", 466).given(entry, "18.xml").given(fieldName, "fieldName1").checkFalse(group());
                itest("dev", 466).given(entry, "13.xml").given(fieldName, "level").checkFalse(group());
                itest("dev", 466).given(entry, "26.xml").given(fieldName, "myMdc.doubleValue1").checkFalse(group());
                itest("dev", 466).given(entry, "15.xml").given(fieldName, "myMdc.undefinedValue").checkFalse(group());
                itest("dev", 466).given(entry, "15.xml").given(fieldName, "myMdc.stringValue").checkTrue(group());
                itest("dev", 466).given(entry, "14.xml").given(fieldName, "timestamp").checkFalse(group());
                itest("dev", 466).given(entry, "16.xml").given(fieldName, "server").checkFalse(group());
                itest("dev", 466).given(entry, "14.xml").given(fieldName, "server.simple").checkFalse(group());
                itest("dev", 466).given(entry, "14.xml").given(fieldName, "server.fqdn").checkFalse(group());
                itest("dev", 466).given(entry, "17.xml").given(fieldName, "server.addr").checkFalse(group());
                itest("dev", 466).given(entry, "14.xml").given(fieldName, "className").checkFalse(group());
                itest("dev", 466).given(entry, "13.xml").given(fieldName, "server.simple").checkFalse(group());
                itest("dev", 466).given(entry, "15.xml").given(fieldName, "server").checkFalse(group());
                itest("dev", 466).given(entry, "14.xml").given(fieldName, "myMdc.doubleValue1").checkTrue(group());
                itest("dev", 466).given(entry, "16.xml").given(fieldName, "myMdc.longValue2").checkTrue(group());
                itest("dev", 466).given(entry, "16.xml").given(fieldName, "fieldName1").checkFalse(group());
                itest("dev", 466).given(entry, "14.xml").given(fieldName, "simpleClassName").checkFalse(group());
                itest("dev", 466).given(entry, "26.xml").given(fieldName, "LoggerName").checkFalse(group());
                itest("dev", 466).given(entry, "18.xml").given(fieldName, "server.simple").checkFalse(group());
                itest("dev", 466).given(entry, "16.xml").given(fieldName, "level").checkFalse(group());
                itest("dev", 466).given(entry, "17.xml").given(fieldName, "simpleClassName").checkFalse(group());
                itest("dev", 466).given(entry, "17.xml").given(fieldName, "fieldName2").checkFalse(group());
                itest("dev", 466).given(entry, "28.xml").given(fieldName, "fieldName2").checkFalse(group());
                itest("dev", 466).given(entry, "13.xml").given(fieldName, "fieldName1").checkFalse(group());
                itest("dev", 466).given(entry, "16.xml").given(fieldName, "className").checkFalse(group());
                itest("dev", 466).given(entry, "18.xml").given(fieldName, "server").checkFalse(group());
                itest("dev", 466).given(entry, "15.xml").given(fieldName, "timestamp").checkFalse(group());
                itest("dev", 466).given(entry, "28.xml").given(fieldName, "LoggerName").checkFalse(group());
                itest("dev", 466).given(entry, "15.xml").given(fieldName, "server.simple").checkFalse(group());
                itest("dev", 466).given(entry, "18.xml").given(fieldName, "myMdc.stringValue").checkTrue(group());
                itest("dev", 466).given(entry, "27.xml").given(fieldName, "fieldName2").checkFalse(group());
                itest("dev", 466).given(entry, "17.xml").given(fieldName, "timestamp").checkFalse(group());
                itest("dev", 466).given(entry, "14.xml").given(fieldName, "myMdc.stringValue").checkFalse(group());
                itest("dev", 466).given(entry, "17.xml").given(fieldName, "fieldName1").checkFalse(group());
                itest("dev", 466).given(entry, "13.xml").given(fieldName, "myMdc.doubleValue1").checkFalse(group());
                itest("dev", 466).given(entry, "13.xml").given(fieldName, "fieldName2").checkFalse(group());
                itest("dev", 466).given(entry, "16.xml").given(fieldName, "server.simple").checkFalse(group());
                itest("dev", 466).given(entry, "27.xml").given(fieldName, "LoggerName").checkFalse(group());
                itest("dev", 466).given(entry, "14.xml").given(fieldName, "server.addr").checkFalse(group());
                itest("dev", 466).given(entry, "18.xml").given(fieldName, "fieldName2").checkFalse(group());
                itest("dev", 466).given(entry, "17.xml").given(fieldName, "server.simple").checkFalse(group());
                itest("dev", 466).given(entry, "27.xml").given(fieldName, "fieldName1").checkFalse(group());
                itest("dev", 466).given(entry, "18.xml").given(fieldName, "className").checkFalse(group());
                itest("dev", 466).given(entry, "13.xml").given(fieldName, "server.addr").checkFalse(group());
                itest("dev", 466).given(entry, "16.xml").given(fieldName, "myMdc.longValue1").checkTrue(group());
                itest("dev", 466).given(entry, "13.xml").given(fieldName, "myMdc.longValue2").checkTrue(group());
                itest("dev", 466).given(entry, "14.xml").given(fieldName, "myMdc.doubleValue2").checkTrue(group());
                itest("dev", 466).given(entry, "13.xml").given(fieldName, "myMdc.doubleValue2").checkFalse(group());
                itest("dev", 466).given(entry, "13.xml").given(fieldName, "className").checkFalse(group());
                itest("dev", 466).given(entry, "15.xml").given(fieldName, "level").checkFalse(group());
                itest("dev", 466).given(entry, "17.xml").given(fieldName, "server").checkFalse(group());
                itest("dev", 466).given(entry, "16.xml").given(fieldName, "simpleClassName").checkFalse(group());
                itest("dev", 466).given(entry, "28.xml").given(fieldName, "myMdc.stringValue").checkTrue(group());
                itest("dev", 466).given(entry, "16.xml").given(fieldName, "myMdc.doubleValue1").checkFalse(group());
                itest("dev", 466).given(entry, "16.xml").given(fieldName, "server.addr").checkFalse(group());
                itest("dev", 466).given(entry, "18.xml").given(fieldName, "timestamp").checkFalse(group());
                itest("dev", 466).given(entry, "17.xml").given(fieldName, "myMdc.stringValue").checkFalse(group());
                itest("dev", 466).given(entry, "15.xml").given(fieldName, "server.fqdn").checkFalse(group());
                itest("dev", 466).given(entry, "13.xml").given(fieldName, "myMdc.stringValue").checkFalse(group());
                itest("dev", 466).given(entry, "14.xml").given(fieldName, "server").checkFalse(group());
                itest("dev", 466).given(entry, "28.xml").given(fieldName, "fieldName1").checkFalse(group());
                itest("dev", 466).given(entry, "18.xml").given(fieldName, "myMdc.undefinedValue").checkFalse(group());
                itest("dev", 466).given(entry, "26.xml").given(fieldName, "fieldName1").checkFalse(group());
                itest("dev", 466).given(entry, "13.xml").given(fieldName, "server.fqdn").checkFalse(group());
                itest("dev", 466).given(entry, "13.xml").given(fieldName, "server").checkFalse(group());
                itest("dev", 466).given(entry, "18.xml").given(fieldName, "server.addr").checkFalse(group());
                itest("dev", 466).given(entry, "14.xml").given(fieldName, "fieldName2").checkFalse(group());
                itest("dev", 466).given(entry, "16.xml").given(fieldName, "myMdc.doubleValue2").checkFalse(group());
                itest("dev", 466).given(entry, "13.xml").given(fieldName, "timestamp").checkFalse(group());
                itest("dev", 466).given(entry, "17.xml").given(fieldName, "myMdc.undefinedValue").checkFalse(group());
                itest("dev", 466).given(entry, "18.xml").given(fieldName, "server.fqdn").checkFalse(group());
                itest("dev", 466).given(entry, "15.xml").given(fieldName, "className").checkFalse(group());
                itest("dev", 466).given(entry, "18.xml").given(fieldName, "level").checkFalse(group());
                itest("dev", 466).given(entry, "17.xml").given(fieldName, "myMdc.doubleValue2").checkTrue(group());
                itest("dev", 466).given(entry, "16.xml").given(fieldName, "myMdc.undefinedValue").checkFalse(group());
                itest("dev", 466).given(entry, "17.xml").given(fieldName, "server.fqdn").checkFalse(group());
                itest("dev", 466).given(entry, "14.xml").given(fieldName, "myMdc.undefinedValue").checkFalse(group());
                itest("dev", 466).given(entry, "14.xml").given(fieldName, "level").checkFalse(group());
                itest("dev", 466).given(entry, "26.xml").given(fieldName, "fieldName2").checkFalse(group());
                itest("dev", 466).given(entry, "15.xml").given(fieldName, "fieldName1").checkFalse(group());
                itest("dev", 466).given(entry, "26.xml").given(fieldName, "myMdc.stringValue").checkFalse(group());
                itest("dev", 466).given(entry, "28.xml").given(fieldName, "Server").checkFalse(group());
                itest("dev", 466).given(entry, "16.xml").given(fieldName, "server.fqdn").checkFalse(group());
                itest("dev", 466).given(entry, "26.xml").given(fieldName, "Server").checkFalse(group());
                itest("dev", 466).given(entry, "16.xml").given(fieldName, "fieldName2").checkFalse(group());
                itest("dev", 466).given(entry, "14.xml").given(fieldName, "fieldName1").checkFalse(group());
                itest("dev", 466).given(entry, "13.xml").given(fieldName, "myMdc.undefinedValue").checkFalse(group());
                itest("dev", 466).given(entry, "16.xml").given(fieldName, "myMdc.stringValue").checkFalse(group());
                itest("dev", 466).given(entry, "27.xml").given(fieldName, "myMdc.doubleValue1").checkTrue(group());
                itest("dev", 466).given(entry, "17.xml").given(fieldName, "className").checkFalse(group());
                itest("dev", 466).given(entry, "15.xml").given(fieldName, "simpleClassName").checkFalse(group());
                itest("dev", 466).given(entry, "15.xml").given(fieldName, "fieldName2").checkFalse(group());
                itest("dev", 466).given(entry, "18.xml").given(fieldName, "simpleClassName").checkFalse(group());
                itest("dev", 466).given(entry, "16.xml").given(fieldName, "timestamp").checkFalse(group());
                itest("dev", 466).given(entry, "17.xml").given(fieldName, "myMdc.doubleValue1").checkTrue(group());
    ...
    public int hashCode() {
        ...
        itest("dev", 655).given(result, -636112057).given(javaTimestamp, 42L).checkEq(result, 1755362755);
        itest("dev", 655).given(result, 1446740333).given(javaTimestamp, 0L).checkEq(result, 1899277363);
