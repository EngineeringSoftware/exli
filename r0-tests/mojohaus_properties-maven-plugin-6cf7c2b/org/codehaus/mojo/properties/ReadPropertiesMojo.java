    ...
    private static class UrlResource extends Resource {
        ...
        public UrlResource(String url) throws MojoExecutionException {
            if (url.startsWith(CLASSPATH_PREFIX)) {
                ...
                itest("evosuite", 379).given(CLASSPATH_PREFIX, "classpath:").given(url, "classpath:#Jv{<cV\"").checkEq(resource, "#Jv{<cV\"");
                itest("evosuite", 379).given(CLASSPATH_PREFIX, "classpath:").given(url, "classpath:${env.").checkEq(resource, "${env.");
                itest("evosuite", 379).given(CLASSPATH_PREFIX, "classpath:").given(url, "classpath:/7]6h<rQYG_,;r").checkEq(resource, "/7]6h<rQYG_,;r");
                itest("evosuite", 379).given(CLASSPATH_PREFIX, "classpath:").given(url, "classpath:").checkEq(resource, "");
                if (resource.startsWith(SLASH_PREFIX)) {
                    resource = resource.substring(1);
                    itest("evosuite", 382).given(resource, "/7]6h<rQYG_,;r").checkEq(resource, "7]6h<rQYG_,;r");
                }
