...
public class AmazonSQSExtendedClient extends AmazonSQSExtendedClientBase implements SqsClient {
    ...
    public ReceiveMessageResponse receiveMessage(ReceiveMessageRequest receiveMessageRequest) {
        ...
        for (Message message : messages) {
            ...
            if (largePayloadAttributeName.isPresent()) {
                ...
                itest("dev", 340).given(largeMessagePointer, "[\"software.amazon.payloadoffloading.PayloadS3Pointer\",{\"s3BucketName\":\"test-bucket-name\",\"s3Key\":\"S3Key\"}]").checkEq(largeMessagePointer, "[\"software.amazon.payloadoffloading.PayloadS3Pointer\",{\"s3BucketName\":\"test-bucket-name\",\"s3Key\":\"S3Key\"}]");
    ...
    private String getOrigReceiptHandle(String receiptHandle) {
        ...
        itest("dev", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-0bb1971d-59a3-49c4-8680-2d03f42e460b-..s3Key..-54fa8ce5-2fc8-4fd6-962c-4243b6594bfd").checkEq(secondOccurence, 99);
        itest("dev", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-b3b479c1-73e6-43a3-9ad6-c4011fe9814c-..s3Key..-05c372b7-db47-4420-8141-3ddc4886629b").checkEq(secondOccurence, 99);
        itest("dev", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-7f567b91-0b67-4683-a0ec-b738320d0048-..s3Key..-9eff192f-fcdd-4148-861c-088a60ae8990").checkEq(secondOccurence, 99);
        itest("dev", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-5ac04b0c-f95d-46cc-9419-2ed79b444827-..s3Key..-e63c04e1-acfa-4d07-8461-e9bc448ad95d").checkEq(secondOccurence, 99);
        itest("dev", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-eb6d88fa-c113-4bc4-8e40-fa544dc0ae35-..s3Key..-71e4d63a-0bd9-4648-b79c-95c74befab58").checkEq(secondOccurence, 99);
        itest("dev", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-9ac8bdac-8995-4cf8-941f-42a228365b39-..s3Key..-67835283-5aff-4b2d-94b2-1fa876eaf3cc").checkEq(secondOccurence, 99);
        itest("dev", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-179c99b1-011e-41f4-a07e-793fb2fac7c2-..s3Key..-0d6c7e62-e061-4ae9-a357-3e01f3bee890").checkEq(secondOccurence, 99);
        itest("dev", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-a57923e8-cc76-4774-bbc3-ed65ddea1523-..s3Key..-ee858893-e339-4b17-84b9-341159c6b3d4").checkEq(secondOccurence, 99);
        itest("dev", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-11d89de6-e519-4aeb-a960-7e72f7b480cf-..s3Key..-1f2bc9ed-4863-48bf-bd70-252adef10844").checkEq(secondOccurence, 99);
        itest("dev", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-2832f153-5654-4341-998a-99a39e631054-..s3Key..-60c3ae69-0bba-495d-948a-810319276bce").checkEq(secondOccurence, 99);
        itest("dev", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-5eb3753f-3083-486c-9863-8e340be4956c-..s3Key..-54d11d36-7507-4b1d-a070-78b5a7f20859").checkEq(secondOccurence, 99);
        itest("dev", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-e517b4ba-486f-4fb0-a232-517a51b997ea-..s3Key..-61653e11-e5c6-4c5d-b1ac-406bbe3948f2").checkEq(secondOccurence, 99);
        itest("dev", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-108be979-67e7-4dc8-a206-653fffe2b3b0-..s3Key..-4d08409c-dc6c-42b0-905b-fffbc5d3821c").checkEq(secondOccurence, 99);
        itest("dev", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-62baf881-27ee-4688-ba76-9edc5b34e3cb-..s3Key..-f1e2831b-a641-409e-8e77-677a91949d65").checkEq(secondOccurence, 99);
        itest("dev", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-a74248c1-fa8e-43f7-a382-8e694f615305-..s3Key..-773971e4-eb1a-4297-9618-5e15220aafd5").checkEq(secondOccurence, 99);
        itest("dev", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-21460a15-40f3-4390-9c93-a016d5c3bd91-..s3Key..-87ca7364-60d5-4d63-b44f-3cf714913c32").checkEq(secondOccurence, 99);
        itest("dev", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-56f6ed82-3b3d-4ca6-a0f0-6fffcae45889-..s3Key..-7d4f1846-bcfc-4574-9193-feca956838b3").checkEq(secondOccurence, 99);
        itest("dev", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-0a188df9-f55d-4a2b-91ad-d8ee74fb488e-..s3Key..-c59731a3-56ff-468a-8c28-a403175a6cc9").checkEq(secondOccurence, 99);
        itest("dev", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-e805dfa3-5589-4268-974d-8d00f252c2d6-..s3Key..-692b59b0-cce7-4edb-bd2d-9a8ef17949ec").checkEq(secondOccurence, 99);
        itest("dev", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-ede09e44-5471-4795-8f24-55f46998662c-..s3Key..-f3e99a7f-4c1c-4f1b-90ce-2a06de5d634c").checkEq(secondOccurence, 99);
        itest("dev", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-b413da84-512a-45a0-afca-45eb51c981b3-..s3Key..-a8782f8d-75a0-497f-87d5-1764a09ed883").checkEq(secondOccurence, 99);
        itest("dev", 884).given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-4805c485-b9f6-4a7f-b054-995be639397a-..s3Key..-78524085-d2b3-45a1-b5c2-4b36b093c60b").checkEq(secondOccurence, 99);
    ...
    private String getFromReceiptHandleByMarker(String receiptHandle, String marker) {
        ...
        itest("dev", 890).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-b3b479c1-73e6-43a3-9ad6-c4011fe9814c-..s3Key..-05c372b7-db47-4420-8141-3ddc4886629b").checkEq(firstOccurence, 0);
        itest("dev", 890).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-e517b4ba-486f-4fb0-a232-517a51b997ea-..s3Key..-61653e11-e5c6-4c5d-b1ac-406bbe3948f2").checkEq(firstOccurence, 52);
        itest("dev", 890).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-62baf881-27ee-4688-ba76-9edc5b34e3cb-..s3Key..-f1e2831b-a641-409e-8e77-677a91949d65").checkEq(firstOccurence, 0);
        itest("dev", 890).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-a57923e8-cc76-4774-bbc3-ed65ddea1523-..s3Key..-ee858893-e339-4b17-84b9-341159c6b3d4").checkEq(firstOccurence, 52);
        itest("dev", 890).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-9ac8bdac-8995-4cf8-941f-42a228365b39-..s3Key..-67835283-5aff-4b2d-94b2-1fa876eaf3cc").checkEq(firstOccurence, 52);
        itest("dev", 890).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-21460a15-40f3-4390-9c93-a016d5c3bd91-..s3Key..-87ca7364-60d5-4d63-b44f-3cf714913c32").checkEq(firstOccurence, 0);
        itest("dev", 890).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-9ac8bdac-8995-4cf8-941f-42a228365b39-..s3Key..-67835283-5aff-4b2d-94b2-1fa876eaf3cc").checkEq(firstOccurence, 0);
        itest("dev", 890).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-a57923e8-cc76-4774-bbc3-ed65ddea1523-..s3Key..-ee858893-e339-4b17-84b9-341159c6b3d4").checkEq(firstOccurence, 0);
        itest("dev", 890).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-eb6d88fa-c113-4bc4-8e40-fa544dc0ae35-..s3Key..-71e4d63a-0bd9-4648-b79c-95c74befab58").checkEq(firstOccurence, 0);
        itest("dev", 890).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-ede09e44-5471-4795-8f24-55f46998662c-..s3Key..-f3e99a7f-4c1c-4f1b-90ce-2a06de5d634c").checkEq(firstOccurence, 52);
        itest("dev", 890).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-ede09e44-5471-4795-8f24-55f46998662c-..s3Key..-f3e99a7f-4c1c-4f1b-90ce-2a06de5d634c").checkEq(firstOccurence, 0);
        itest("dev", 890).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-21460a15-40f3-4390-9c93-a016d5c3bd91-..s3Key..-87ca7364-60d5-4d63-b44f-3cf714913c32").checkEq(firstOccurence, 52);
        itest("dev", 890).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-11d89de6-e519-4aeb-a960-7e72f7b480cf-..s3Key..-1f2bc9ed-4863-48bf-bd70-252adef10844").checkEq(firstOccurence, 52);
        itest("dev", 890).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-62baf881-27ee-4688-ba76-9edc5b34e3cb-..s3Key..-f1e2831b-a641-409e-8e77-677a91949d65").checkEq(firstOccurence, 52);
        itest("dev", 890).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-11d89de6-e519-4aeb-a960-7e72f7b480cf-..s3Key..-1f2bc9ed-4863-48bf-bd70-252adef10844").checkEq(firstOccurence, 0);
        itest("dev", 890).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-4805c485-b9f6-4a7f-b054-995be639397a-..s3Key..-78524085-d2b3-45a1-b5c2-4b36b093c60b").checkEq(firstOccurence, 52);
        itest("dev", 890).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-eb6d88fa-c113-4bc4-8e40-fa544dc0ae35-..s3Key..-71e4d63a-0bd9-4648-b79c-95c74befab58").checkEq(firstOccurence, 52);
        itest("dev", 890).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-e517b4ba-486f-4fb0-a232-517a51b997ea-..s3Key..-61653e11-e5c6-4c5d-b1ac-406bbe3948f2").checkEq(firstOccurence, 0);
        itest("dev", 890).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-4805c485-b9f6-4a7f-b054-995be639397a-..s3Key..-78524085-d2b3-45a1-b5c2-4b36b093c60b").checkEq(firstOccurence, 0);
        itest("dev", 890).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-2832f153-5654-4341-998a-99a39e631054-..s3Key..-60c3ae69-0bba-495d-948a-810319276bce").checkEq(firstOccurence, 0);
        itest("dev", 890).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-b3b479c1-73e6-43a3-9ad6-c4011fe9814c-..s3Key..-05c372b7-db47-4420-8141-3ddc4886629b").checkEq(firstOccurence, 52);
        itest("dev", 890).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-2832f153-5654-4341-998a-99a39e631054-..s3Key..-60c3ae69-0bba-495d-948a-810319276bce").checkEq(firstOccurence, 52);
        int secondOccurence = receiptHandle.indexOf(marker, firstOccurence + 1);
        itest("dev", 891).given(firstOccurence, 52).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-9ac8bdac-8995-4cf8-941f-42a228365b39-..s3Key..-67835283-5aff-4b2d-94b2-1fa876eaf3cc").checkEq(secondOccurence, 99);
        itest("dev", 891).given(firstOccurence, 52).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-b3b479c1-73e6-43a3-9ad6-c4011fe9814c-..s3Key..-05c372b7-db47-4420-8141-3ddc4886629b").checkEq(secondOccurence, 99);
        itest("dev", 891).given(firstOccurence, 52).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-eb6d88fa-c113-4bc4-8e40-fa544dc0ae35-..s3Key..-71e4d63a-0bd9-4648-b79c-95c74befab58").checkEq(secondOccurence, 99);
        itest("dev", 891).given(firstOccurence, 0).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-4805c485-b9f6-4a7f-b054-995be639397a-..s3Key..-78524085-d2b3-45a1-b5c2-4b36b093c60b").checkEq(secondOccurence, 34);
        itest("dev", 891).given(firstOccurence, 0).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-eb6d88fa-c113-4bc4-8e40-fa544dc0ae35-..s3Key..-71e4d63a-0bd9-4648-b79c-95c74befab58").checkEq(secondOccurence, 34);
        itest("dev", 891).given(firstOccurence, 52).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-11d89de6-e519-4aeb-a960-7e72f7b480cf-..s3Key..-1f2bc9ed-4863-48bf-bd70-252adef10844").checkEq(secondOccurence, 99);
        itest("dev", 891).given(firstOccurence, 0).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-62baf881-27ee-4688-ba76-9edc5b34e3cb-..s3Key..-f1e2831b-a641-409e-8e77-677a91949d65").checkEq(secondOccurence, 34);
        itest("dev", 891).given(firstOccurence, 52).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-e517b4ba-486f-4fb0-a232-517a51b997ea-..s3Key..-61653e11-e5c6-4c5d-b1ac-406bbe3948f2").checkEq(secondOccurence, 99);
        itest("dev", 891).given(firstOccurence, 0).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-b3b479c1-73e6-43a3-9ad6-c4011fe9814c-..s3Key..-05c372b7-db47-4420-8141-3ddc4886629b").checkEq(secondOccurence, 34);
        itest("dev", 891).given(firstOccurence, 52).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-a57923e8-cc76-4774-bbc3-ed65ddea1523-..s3Key..-ee858893-e339-4b17-84b9-341159c6b3d4").checkEq(secondOccurence, 99);
        itest("dev", 891).given(firstOccurence, 0).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-11d89de6-e519-4aeb-a960-7e72f7b480cf-..s3Key..-1f2bc9ed-4863-48bf-bd70-252adef10844").checkEq(secondOccurence, 34);
        itest("dev", 891).given(firstOccurence, 0).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-21460a15-40f3-4390-9c93-a016d5c3bd91-..s3Key..-87ca7364-60d5-4d63-b44f-3cf714913c32").checkEq(secondOccurence, 34);
        itest("dev", 891).given(firstOccurence, 0).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-2832f153-5654-4341-998a-99a39e631054-..s3Key..-60c3ae69-0bba-495d-948a-810319276bce").checkEq(secondOccurence, 34);
        itest("dev", 891).given(firstOccurence, 0).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-e517b4ba-486f-4fb0-a232-517a51b997ea-..s3Key..-61653e11-e5c6-4c5d-b1ac-406bbe3948f2").checkEq(secondOccurence, 34);
        itest("dev", 891).given(firstOccurence, 0).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-a57923e8-cc76-4774-bbc3-ed65ddea1523-..s3Key..-ee858893-e339-4b17-84b9-341159c6b3d4").checkEq(secondOccurence, 34);
        itest("dev", 891).given(firstOccurence, 52).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-4805c485-b9f6-4a7f-b054-995be639397a-..s3Key..-78524085-d2b3-45a1-b5c2-4b36b093c60b").checkEq(secondOccurence, 99);
        itest("dev", 891).given(firstOccurence, 52).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-ede09e44-5471-4795-8f24-55f46998662c-..s3Key..-f3e99a7f-4c1c-4f1b-90ce-2a06de5d634c").checkEq(secondOccurence, 99);
        itest("dev", 891).given(firstOccurence, 52).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-21460a15-40f3-4390-9c93-a016d5c3bd91-..s3Key..-87ca7364-60d5-4d63-b44f-3cf714913c32").checkEq(secondOccurence, 99);
        itest("dev", 891).given(firstOccurence, 0).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-9ac8bdac-8995-4cf8-941f-42a228365b39-..s3Key..-67835283-5aff-4b2d-94b2-1fa876eaf3cc").checkEq(secondOccurence, 34);
        itest("dev", 891).given(firstOccurence, 52).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-2832f153-5654-4341-998a-99a39e631054-..s3Key..-60c3ae69-0bba-495d-948a-810319276bce").checkEq(secondOccurence, 99);
        itest("dev", 891).given(firstOccurence, 0).given(marker, "-..s3BucketName..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-ede09e44-5471-4795-8f24-55f46998662c-..s3Key..-f3e99a7f-4c1c-4f1b-90ce-2a06de5d634c").checkEq(secondOccurence, 34);
        itest("dev", 891).given(firstOccurence, 52).given(marker, "-..s3Key..-").given(receiptHandle, "-..s3BucketName..-test-bucket-name-..s3BucketName..--..s3Key..-62baf881-27ee-4688-ba76-9edc5b34e3cb-..s3Key..-f1e2831b-a641-409e-8e77-677a91949d65").checkEq(secondOccurence, 99);
